...
},{"../common/Lib":6,"../common/analytics/clientMixin":7,"../common/utils/entities":64,"./ClientMessages":2,"./DeathQueue":3,"./clientTranslate":5}],2:[function(require,module,exports){
'use strict';
...
},{"../lib/ignore":47,"./Chain":8,"./appendText":12,"./clearValue":13,"./correctZIndex":14,"./createElement":15,"./emptyElement":16,"./getElementText":17,"./getOffset":18,"./hasAttribute":19,"./hasClass":20,"./isBodyReady":21,"./isChild":22,"./parseMarkdown":24,"./pixelValue":25,"./qualifyURL":26,"./removeElement":27,"./setContent":28,"./setText":29,"dom-element":102}],24:[function(require,module,exports){
'use strict';
...
},{"./createElement":15,"html-entities":105}],31:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"../utils/eventsMixin":65,"extend":104}],33:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"extend":104}],35:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"../utils/eventsMixin":65,"extend":104}],38:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"../utils/eventsMixin":65,"extend":104}],39:[function(require,module,exports){
'use strict';
...
},{"../dom/main":23,"../lib/isString":53,"../utils/eventsMixin":65,"extend":104}],40:[function(require,module,exports){
'use strict';
...
},{"../lib/isEmpty":50,"../lib/isFunction":51,"../lib/isString":53,"../lib/parseArgs":54,"../lib/parseUri":55,"./XHRProxyResult":63,"extend":104}],63:[function(require,module,exports){
'use strict';
...
},{"extend":104}],64:[function(require,module,exports){
'use strict';
...
},{"html-entities":105}],65:[function(require,module,exports){
'use strict';
...
},{"../../../common/dom/main":23,"../../../common/effects/HintBox":34,"../../../common/effects/InlineMenu":35,"../../../common/effects/TabsSwitch":38,"../../../common/effects/ToggleButton":39,"../../../common/lib/ignore":47,"../../../common/lib/isEmpty":50,"../../../common/utils/messengerMixin":67,"../../../common/utils/messengerTranslateMixin":68,"./ModuleLinks":74,"./PanelMenu":76,"./PanelMessage":77,"./ParametersPanel":80,"./backlinks/BacklinksReport":82,"./changelog/Panel":83,"./feedback/Panel":86,"./feedback/SurveyPanel":89,"./ta/TrafficAnalyticsReport":90,"./tips/NoticePanel":91,"./tips/TipsPanel":92,"./ui/PanelLog":93,"extend":104}],76:[function(require,module,exports){
'use strict';
...
},{"../../../common/Lib":6,"../../../common/dom/main":23,"../../../common/lib/ignore":47,"../../../common/utils/eventsMixin":65,"../../../common/utils/messengerMixin":67,"../../../common/utils/messengerTranslateMixin":68,"./ParametersList":79,"./ParametersTop":81,"extend":104}],81:[function(require,module,exports){
'use strict';
...
},{"../../../common/Lib":6,"../../../common/dom/main":23,"../../../common/dom/textUtils":30,"../../../common/effects/HintBox":34,"../../../common/lib/ignore":47,"../../../common/lib/isEmpty":50,"../../../common/utils/messengerMixin":67,"../../../common/utils/messengerTranslateMixin":68,"./ParameterItem":78,"./ui/ParameterSelectMenu":97}],82:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/effects/PillsSwitch":37,"../../../../common/lib/ignore":47,"../../../../common/utils/normalizeNumber":69,"../ui/PanelReport":94}],83:[function(require,module,exports){
'use strict';
...
var Panel = function (_Container) {
  ...
  _createClass(Panel, [{
    ...
    value: function closeHandler() {
      ...
      this.sendMessage('sq.setConfigurationItem', { name: 'core.changelog_shown', value: '3.9.9' }).then(function () {
        _this2.hide();
    ...
    value: function addChangelog() {
      ...
      Promise.all(texts).then(function (lines) {
        lines[0] = lines[0].replace('{version}', '3.9.9').replace('{date}', '12/22/2022');
        _this3.addChangeHeader(lines[0]);

        _this3.addChangeNew('Support ‘Continuous Scrolling’ on Google SERP');
        _this3.addChangeFix('Fixed sort on Google SERP');
    ...
    get: function get() {
      ...
      return new Promise(function (resolve, reject) {
        _this5.sendMessage('sq.getConfigurationItem', 'core.changelog_shown').then(function (result) {
          if (versionCompare(result, '3.9.9') !== 1) {
...
ErrorPanel.DEFAULT_CONFIG = {
  storeIcon: 'firefox-icon',
  storeLink: 'addons.mozilla.org'
};

module.exports = ErrorPanel;

},{"../../../../common/dom/Container":9,"../../../../common/dom/main":23,"../../../../common/lib/ignore":47,"extend":104}],85:[function(require,module,exports){
'use strict';
...
Form.DEFAULT_CONFIG = {
  ...
  storeLink: 'addons.mozilla.org',
  storeUrl: 'https://addons.mozilla.org/en-US/firefox/addon/seoquake-seo-extension/',
  storeIcon: 'firefox-icon'
};

module.exports = Form;

},{"../../../../common/dom/Container":9,"../../../../common/dom/main":23,"../../../../common/lib/ignore":47,"../../../../common/utils/eventsMixin":65,"./Error":84,"./Sending":87,"./Success":88,"extend":104}],86:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/effects/ToggleButton":39,"../../../../common/lib/ignore":47,"../../../../common/lib/isEmpty":50,"../../../../common/utils/XHRProxy":62,"./Form":85,"extend":104}],87:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/Container":9,"../../../../common/dom/main":23,"../../../../common/lib/ignore":47}],88:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/lib/ignore":47,"../../../../common/utils/messengerTranslateMixin":68}],90:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/lib/ignore":47,"../../../../common/lib/isEmpty":50,"../../../../common/utils/normalizeNumber":69,"../../../../common/utils/padLeft":70,"../ui/PanelReport":94}],91:[function(require,module,exports){
'use strict';
...
var NoticePanel = function (_TipsPanel) {
  ...
  function NoticePanel(lastItem) {
    ...
    var _this = _possibleConstructorReturn(this, (NoticePanel.__proto__ || Object.getPrototypeOf(NoticePanel)).call(this, lastItem));
...
},{"../../../../common/utils/eventsMixin":65,"../../../../common/utils/translateMixin":71,"./TipsPanel":92}],92:[function(require,module,exports){
'use strict';
...
var TipsPanel = function () {
  ...
  _createClass(TipsPanel, [{
    ...
    value: function renderNextItem() {
      ...
      var itemText = dom.parse(this._items[currentItem], { lineBreak: 'br' });
      ...
      var itemBlock = dom('div', { className: 'tips-content_item', style: 'width:' + width + 'px' }, itemText);
...
},{"../../../../common/dom/main":23,"../../../../common/effects/FxLeft":33,"../../../../common/lib/ignore":47,"../../../../common/utils/eventsMixin":65,"../../../../common/utils/translateMixin":71}],93:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23}],94:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/lib/ignore":47,"../../../../common/lib/isEmpty":50,"../../../../common/lib/parseUri":55,"../../../../common/semrush/SemrushApi":60,"../../../../common/utils/messengerMixin":67,"../../../../common/utils/messengerTranslateMixin":68}],95:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/dom/textUtils":30,"../../../../common/effects/HintBox":34,"../ParameterItem":78}],96:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/utils/eventsMixin":65}],97:[function(require,module,exports){
'use strict';
...
},{"../../../../common/dom/main":23,"../../../../common/effects/ColumnDisplay":31,"../../../../common/effects/noramlizeColumnsMixin":40,"../../../../common/lib/ignore":47,"../../../../common/utils/eventsMixin":65,"../../../../common/utils/messengerMixin":67,"../../../../common/utils/messengerTranslateMixin":68,"./ParameterSelectItem":96}],98:[function(require,module,exports){
'use strict';
...
},{"browser/PanelClient":4,"modules/panel/src/PanelMain":75}],99:[function(require,module,exports){
var toCamelCase = require('to-camel-case');
...
},{"to-space-case":113}],101:[function(require,module,exports){
/**
...
},{"dup":100,"to-space-case":113}],104:[function(require,module,exports){
'use strict';
