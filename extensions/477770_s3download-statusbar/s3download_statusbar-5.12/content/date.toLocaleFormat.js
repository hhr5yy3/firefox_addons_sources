if (! Date.prototype.toLocaleFormat) {
	Date.prototype.toLocaleFormat = function(formatString) {
		...
		formatString = formatString.replace(/\%H/g, String('00' + date.getHours()).slice(-2));
		formatString = formatString.replace(/\%M/g, String('00' + date.getMinutes()).slice(-2));
		formatString = formatString.replace(/\%S/g, String('00' + date.getSeconds()).slice(-2));
