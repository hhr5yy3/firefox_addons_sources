...
// src/features/mainUI/utils/index.ts
var getCurrentChatWebSite = () => {
  if (location.host === "claude.ai") {
    return "Claude";
  }
  if (location.host === "bard.google.com") {
    return "Bard";
  }
...
// node_modules/.pnpm/notistack@2.0.8_@emotion+react@11.10.5_@babel+core@7.26.0_@types+react@18.0.27_react@18.2.0___oe5zmzkxd276ofdq2hijgmpqke/node_modules/notistack/dist/notistack.esm.js
var import_react = __toESM(require_react());
var import_react_dom = __toESM(require_react_dom());
var import_clsx = __toESM(require_clsx());
var import_SvgIcon = __toESM(require_SvgIcon());
...
var SnackbarContext = /* @__PURE__ */ import_react.default.createContext();
var allClasses = {
  mui: {
    root: {},
...
var Root = /* @__PURE__ */ styled_default("div")(function(_ref) {
  var _ref2, _ref3;
...
var SnackbarContent = /* @__PURE__ */ (0, import_react.forwardRef)(function(_ref4, ref) {
...
var CheckIcon = function CheckIcon2(props) {
  return import_react.default.createElement(import_SvgIcon.default, Object.assign({}, props), import_react.default.createElement("path", {
...
var defaultIconVariants = {
  "default": void 0,
  success: /* @__PURE__ */ import_react.default.createElement(CheckIcon, {
    style: iconStyles
  }),
  warning: /* @__PURE__ */ import_react.default.createElement(WarningIcon, {
    style: iconStyles
  }),
  error: /* @__PURE__ */ import_react.default.createElement(ErrorIcon, {
    style: iconStyles
  }),
  info: /* @__PURE__ */ import_react.default.createElement(InfoIcon, {
    style: iconStyles
  })
};
...
var Snackbar = /* @__PURE__ */ (0, import_react.forwardRef)(function(props, ref) {
  ...
  return (0, import_react.createElement)(import_ClickAwayListener.default, _extends({
...
var StyledSnackbar = /* @__PURE__ */ styled_default(Snackbar)(function(_ref) {
  var _ref2;
  var theme = _ref.theme;
  var mode = theme.palette.mode || theme.palette.type;
  var backgroundColor = (0, import_system.emphasize)(theme.palette.background["default"], mode === "light" ? 0.8 : 0.98);
...
var SnackbarItem = function SnackbarItem2(_ref3) {
  ...
  return import_react.default.createElement(Collapse_default, {
    ...
    open,
    className: (0, import_clsx.default)(propClasses.root, classes$1.wrappedRoot, propClasses[transformer.toAnchorOrigin(anchorOrigin)]),
    onClose: handleClose
    ...
    role: "alert",
    style,
    className: (0, import_clsx.default)(classes$1.contentRoot, classes$1[transformer.toVariant(variant)], propClasses[transformer.toVariant(variant)], otherClassName, singleClassName, !hideIconVariant && icon && classes$1.lessPadding)
...
var Root$1 = /* @__PURE__ */ styled_default("div")(function(_ref) {
...
var SnackbarContainer = function SnackbarContainer2(props) {
  ...
  var combinedClassname = (0, import_clsx.default)(
...
var SnackbarContainer$1 = /* @__PURE__ */ import_react.default.memo(SnackbarContainer);
  ...
  function SnackbarProvider2(props) {
    ...
    _this.handleDismissOldest = function(state) {
      ...
      if (persistentCount === _this.maxSnack) {
        false ? warning(MESSAGES.NO_PERSIST_ALL) : void 0;
        ignore = true;
      }
  ...
  _proto.render = function render() {
    ...
    var snackbars = Object.keys(categ).map(function(origin) {
      ...
      return import_react.default.createElement(SnackbarContainer$1, {
        ...
        className: (0, import_clsx.default)(classes2.containerRoot, classes2[transformer.toContainerAnchorOrigin(origin)])
