    ...
    pl.extend(ke.app.render, {
        organize: {
            showCarouselTab: function (tab) {
                ...
                $('.c-block-meta').hide();
                $('.cbm-' + tab).fadeIn(275).css('display', 'flex');
            ...
            showProLayout: function() {
                $('.pro-upgrade-pitch').hide();
                $('.cbm-4 .buttons-layout').hide();
                $('.pro-upgrade-message').removeClass('no-display');
                $('.pro-upgrade-message .pro-layout').show();
                $('.cbm-4').css('justify-content', 'center');
            }
        },
