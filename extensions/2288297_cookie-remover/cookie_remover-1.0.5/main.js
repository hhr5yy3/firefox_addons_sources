...
function showMessage(msg, duration)
{
  ...
  el.setAttribute("style","border-radius:12px;position:fixed;top:40%;left:40%;z-index:99;padding:8px;font-family: Arial, sans-serif;font-size:18px;color:white;background-color:blue; opacity:0.7;");
  el.innerHTML = msg;
  setTimeout(function() {
