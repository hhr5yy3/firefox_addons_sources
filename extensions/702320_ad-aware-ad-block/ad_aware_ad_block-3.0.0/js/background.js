...
const µBlock = {  // jshint ignore:line
    ...
    netWhitelistBackup: [ // use when abwhitelist server is down
        'account.live.com',
        'app.uservoice.com',
        'aspnet.uservoice.com',
        'bing.com',
        'blog.onedrive.com',
        'blogs.iis.net',
        'blogs.msdn.com',
        ...
        'findmysoft.com',
        'http://yahooadvertisingca.tumblr.com/',
        'http://classifieds.canoe.com/',
        'http://www.monster.ca/?WT.mc_n=Ycanada_monsterlink',
        'http://yahoo.yellowpages.ca/',
        'https://mail.yahoo.ca/',
        'https://yahoo.tumblr.com/',
        'windowsazure.com',
        'microsoft.com',
        'www.yahoogroups.com',
        'https://jtracking.lulusoft.com/',
        'https://www.adaware.com/',
        'https://www.surveymonkey.com/',
        'https://store.adaware.com/'
    ],
