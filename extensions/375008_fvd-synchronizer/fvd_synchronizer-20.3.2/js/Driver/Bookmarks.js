(function(){
    ...
    var Bookmarks = function(){
      ...
      function getBookmarksList( params, callback ){
        ...
        makeRequest( message, function( error, response ){
          if( error != 0 ){
            ...
            var logN = 0, logAll = response.bookmarks.length;
      ...
      function overwriteServerData( callback ){
          fvdSynchronizer.Server.Sync.updateSyncAccount();// Task #1601, #1833
          
          
        fvdSynchronizer.Utils.Async.chain( [

          function( chainCallback ){// ff added
              initialActions(function(){
                 chainCallback();
              });
          },
        ...
        fvdSynchronizer.Utils.Async.chain( [
          ...
          function( chainCallback ){
            ...
            processItems(["toolbar"]);
              ...
              processItems(["unsorted"]);// Task #1668
    ...
    function getToSyncData(){
      ...
      this.setMainSyncState = function( state ){
        ...
        chrome.runtime.sendMessage( { // ff changed method
      ...
      this.displayQuotaExceedMessage = function( countItemsToSave ){
        ...
        //   ", <a target='blank' href='http://everhelper.pro/client/?l=/components/MainOptions/quota'>"+_("dlg_alert_sync_quota_exceed_fix_it")+"</a>" );
      ...
      this.totalItemsCount = function( callback ){
        ...
        bookmarksManager.getAllBookmarks(function(clientBookmarks){
          ...
          //console.log("Bookmarks: Total Items counted: ", clientBookmarks, clientBookmarks.length);
      ...
      this.Backup = new function(){
        ...
        this.make = function( callback, forceData) {
            var callbackFired = false;
            
          var callbackTimeout = setTimeout(()=>{
              console.info('callbackTimeout');
              mainCallback(true);
          }, 45e3);
            
          var mainCallback = function(result){
          ...
          try{
              if(typeof forceData != "object") forceData = {folder:false, data:false};
              ...
              var backupDir = forceData.folder ? forceData.folder : nowDate.getFullYear()+""+nowDate.getMonth()+""+nowDate.getDay()+""+nowDate.getHours()+nowDate.getMinutes()+""+nowDate.getSeconds();
              ...
              fvdSynchronizer.Utils.Async.chain([
                ...
                function( chainCallback ){
                    if(forceData.data && forceData.data){
                        bookmarks = forceData.data;
                        chainCallback();
                    }else{
                ...
                function( chainCallback ){
                  ...
                  var info = {
                    time: forceData.time ? forceData.time : nowDate.getTime(),
