...
function handleGoogleAds(data) {
	if (data.has && data.user.id) {
		...
		$('.inj-cont').remove();
		$('#ires').find(".iUh30").eq(0).parent().before('<div class="inj-cont"><img src="' + googleAdsLogo + '" alt=""> <a href="' + linkUrl + '" class="kopikot-extension-get" target="_blank"> ' + compiledBannerStr + ' </a></div>');
...
/**
 * code commented out as not used, uncomment when there will be a need
 */
