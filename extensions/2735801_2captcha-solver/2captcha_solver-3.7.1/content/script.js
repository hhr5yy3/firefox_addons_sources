...
Config.getAll().then(function (config) {
    ...
    if (config.isPluginEnabled) {
        scripts = [
            ...
            ["content/captcha/hcaptcha/hunter.js", !isBlocked],
            ["content/captcha/keycaptcha/hunter.js", !isBlocked],
            ["content/captcha/recaptcha/hunter.js", config.enabledForRecaptchaV2 && config.recaptchaV2Type === 'token' && !isBlocked],
            ["content/captcha/recaptcha/interceptor.js", (config.enabledForRecaptchaV2 || config.enabledForInvisibleRecaptchaV2 || config.enabledForRecaptchaV3) && !isBlocked],
            ["content/captcha/recaptcha_audio/hunter.js", config.isPluginEnabled && config.enabledForRecaptchaAudio && !isBlocked],
            ["content/captcha/arkoselabs/interceptor.js", config.enabledForArkoselabs && !isBlocked],
            ["content/captcha/arkoselabs/hunter.js", !isBlocked],
            ...
            ["content/captcha/amazon_waf/interceptor.js", config.enabledForAmazonWaf && !isBlocked],
            ["content/captcha/turnstile/hunter.js", !isBlocked],
            ["content/captcha/turnstile/interceptor.js", config.enabledForTurnstile && !isBlocked],
            ["content/captcha/mt_captcha/interceptor.js", config.isPluginEnabled && config.enabledForMTCaptcha && !isBlocked]
        ]
    }
    ...
    Config.getAll().then(config => {
        ...
        $("head").find("captcha-widget").each(function () {
            ...
            if (processor.canBeProcessed(widgetInfo, config)) {
                ...
                if (typeof processor.clickButton === 'function')  {
...
function doActionsOnSuccess(msg) {
    ...
    Config.getAll().then(config => {
        processor.onSolved(widget, msg.response.code, config);
