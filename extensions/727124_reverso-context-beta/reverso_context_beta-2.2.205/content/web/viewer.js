        ...
        let PDFViewerApplication = {
            ...
            open(file, args) {
                ...
                return loadingTask.promise.then(pdfDocument => {
                    // TODO FIX By Aleksey Romanov;
                    localStorage.setItem("numberOfAttemptsToDownloadTheDocument", 0);
                    // END FIX By Aleksey Romanov;
                    ...
                    return loadingErrorMessage.then(msg => {
                        ...
                        // TODO FIX By Aleksey Romanov;
                        let numberOfAttemptsToDownloadTheDocument = 0,
                            limitDowm = 5;
                        if(localStorage.getItem("numberOfAttemptsToDownloadTheDocument")){
                            numberOfAttemptsToDownloadTheDocument = parseInt(localStorage.getItem("numberOfAttemptsToDownloadTheDocument"));
                            if(isNaN(numberOfAttemptsToDownloadTheDocument))
                                numberOfAttemptsToDownloadTheDocument = 0;
                        }
                        numberOfAttemptsToDownloadTheDocument++;
                        localStorage.setItem("numberOfAttemptsToDownloadTheDocument", numberOfAttemptsToDownloadTheDocument);

                        // is iframe
                        if(top.location !== self.location && numberOfAttemptsToDownloadTheDocument <= limitDowm) {
                            console.log("numberOfAttemptsToDownloadTheDocument: ", numberOfAttemptsToDownloadTheDocument, location);

                            setTimeout(function () {
                                location.href = self.requestedURL_ReversoExtension;
                            }, 1024);
                        } else {
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        DownloadManager.prototype = {
            downloadUrl: function DownloadManager_downloadUrl(url, filename) {
                if (!(0, _pdfjsLib.createValidAbsoluteUrl)(url, 'http://www.reverso.net')) {
                    return;
                }
