...
function ViewRenderer(newTabData, unittest) { //jshint ignore: line
    ...
    async function renderTrendingNow() {
        ...
        if (typeof newTabData.trendingNowData === "undefined" || !newTabData.trendingNowData ||
            ...
            (newTabData.breakingNews && breakingNewsBar !== "hidden")) {
            return;
        }
    ...
    async function renderNewTopSites(parent, newFav) {
        ...
        if (extGlobal.constants.distributionChannels[extGlobal.distributionChannel].partnerSite) {
            partners.push(extGlobal.constants.distributionChannels[extGlobal.distributionChannel].partnerSite);
        }
        ...
        if (extGlobal.browserGap.localStorage.getItem("trackUserRetention")) {
            ...
            var acceptBeaconInterval = setInterval(function() {
                ...
                if (acceptBeaconIdx <= 30) {
                    extGlobal.tracker.triggerAcceptBeacon(extGlobal.constants.distributionChannels[extGlobal.distributionChannel].chrome_space_id || extGlobal.constants.chrome_space_id, extGlobal.constants.tracker_browser_chr, extGlobal.constants.tracker_type_interval.replace("{N}", ""+acceptBeaconIdx));
