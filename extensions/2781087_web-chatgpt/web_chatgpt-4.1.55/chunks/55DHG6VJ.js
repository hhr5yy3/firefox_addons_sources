...
// src/hooks/useThemeModeWithChatWeb.ts
var import_react = __toESM(require_react());
var currentChatWebSite = getCurrentChatWebSite();
var getCurrentChatWebColorSchema = () => {
...
var chatWebSiteColorSchemaListener = (cb) => {
  if (currentChatWebSite === "Bard") {
...
var useThemeModeWithChatWeb = (enable = true) => {
  const [mode, setMode] = (0, import_react.useState)(getCurrentChatWebColorSchema);
  (0, import_react.useEffect)(() => {
    if (!enable) {
      return;
    }
    const observer = chatWebSiteColorSchemaListener(() => {
      setMode(getCurrentChatWebColorSchema());
    });
    return () => {
...
var useThemeModeWithChatWeb_default = useThemeModeWithChatWeb;

// src/components/AppTheme.tsx
var import_jsx_runtime = __toESM(require_jsx_runtime());
var AppThemeProvider = (props) => {
  const chatWebColorSchema = useThemeModeWithChatWeb_default(props.withChatWeb);
  const { customTheme } = customMuiTheme_default({
    colorSchema: props.withChatWeb ? chatWebColorSchema : void 0
  });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_system.ThemeProvider, { theme: customTheme, children: props.children });
};
var AppTheme_default = AppThemeProvider;

// src/components/CustomIcon.tsx
var import_SvgIcon = __toESM(require_SvgIcon());
var import_jsx_runtime2 = __toESM(require_jsx_runtime());
var Expand = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 14 12", ...props, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "path",
    {
...
var ArrowForward = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 15 12", ...props, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { width: "15", height: "12", viewBox: "0 0 15 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "path",
    {
      d: "M11.7827 6.66705H0.666016V5.33372H11.7827L8.04935 1.60039L8.99935 0.667053L14.3327 6.00039L8.99935 11.3337L8.04935 10.4004L11.7827 6.66705Z",
      fill: "currentColor"
    }
  ) }) });
};
var ChatHubTwoLayoutIcon = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 16 16", ...props, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "svg",
    {
      width: "16",
      height: "16",
...
var ChatHubThreeLayoutIcon = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 16 16", ...props, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "svg",
    {
      width: "16",
...
var FullScreen = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 14 14", sx: props.sx, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "path",
    {
      d: "M0.5 13.5V9.88889H1.94444V12.0556H4.11111V13.5H0.5ZM9.88889 13.5V12.0556H12.0556V9.88889H13.5V13.5H9.88889ZM0.5 4.11111V0.5H4.11111V1.94444H1.94444V4.11111H0.5ZM12.0556 4.11111V1.94444H9.88889V0.5H13.5V4.11111H12.0556Z",
      fill: "currentColor"
    }
  ) }) });
};
var FullScreenExit = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 14 14", sx: props.sx, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "path",
    {
      d: "M2.66667 13.5V11.3333H0.5V9.88889H4.11111V13.5H2.66667ZM9.88889 13.5V9.88889H13.5V11.3333H11.3333V13.5H9.88889ZM0.5 4.11111V2.66667H2.66667V0.5H4.11111V4.11111H0.5ZM9.88889 4.11111V0.5H11.3333V2.66667H13.5V4.11111H9.88889Z",
      fill: "currentColor"
    }
  ) }) });
};
var Restart = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 20 22", sx: props.sx, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { width: "20", height: "22", viewBox: "0 0 20 22", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "path",
    {
      d: "M8.84232 21.3632C6.50723 21.0737 4.57259 20.0557 3.03838 18.3092C1.50417 16.5627 0.737061 14.5123 0.737061 12.1579C0.737061 10.8842 0.987938 9.66359 1.48969 8.49605C1.99145 7.32851 2.70548 6.31052 3.6318 5.4421L5.2818 7.0921C4.54846 7.74824 3.99364 8.51052 3.61732 9.37894C3.24101 10.2474 3.05285 11.1737 3.05285 12.1579C3.05285 13.8561 3.5932 15.3566 4.6739 16.6592C5.7546 17.9618 7.14407 18.7579 8.84232 19.0474V21.3632ZM11.1581 21.3632V19.0474C12.8371 18.7386 14.2217 17.9377 15.3121 16.6447C16.4024 15.3517 16.9476 13.8561 16.9476 12.1579C16.9476 10.2281 16.2721 8.58772 14.9213 7.23684C13.5704 5.88596 11.93 5.21052 10.0002 5.21052H9.91337L11.1871 6.48421L9.566 8.10526L5.51337 4.05263L9.566 0L11.1871 1.62105L9.91337 2.89474H10.0002C12.5862 2.89474 14.7765 3.7921 16.5713 5.58684C18.366 7.38158 19.2634 9.57193 19.2634 12.1579C19.2634 14.493 18.4963 16.5338 16.9621 18.2803C15.4278 20.0267 13.4932 21.0544 11.1581 21.3632Z",
      fill: "currentColor"
    }
  ) }) });
};
var ArrowRight = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 16 14", sx: props.sx, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { width: "16", height: "14", viewBox: "0 0 16 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "path",
    {
      fillRule: "evenodd",
      clipRule: "evenodd",
      d: "M15.094 6.19192C15.5403 6.63822 15.5403 7.36192 15.094 7.80822L9.95112 12.951C9.50482 13.3973 8.78122 13.3973 8.33492 12.951C7.88852 12.5047 7.88852 11.7811 8.33492 11.3348L11.5267 8.14292L1.71442 8.14292C1.08322 8.14292 0.571521 7.63122 0.571521 7.00002C0.571521 6.36892 1.08322 5.85722 1.71442 5.85722L11.5267 5.85722L8.33492 2.66532C7.88852 2.21902 7.88852 1.49542 8.33492 1.04912C8.78122 0.602768 9.50482 0.602768 9.95112 1.04912L15.094 6.19192Z",
      fill: "currentColor"
    }
  ) }) });
};
var Delete = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 20 20", sx: props.sx, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "path",
    {
...
var ChatGPTIcon = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 24 24", sx: props.sx, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { clipPath: "url(#clip0_4133_35975)", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("clipPath", { id: "clip0_4133_35975", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("rect", { width: "24", height: "24", fill: "white" }) }) })
  ] }) });
};
var BingIcon = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "svg",
    {
      width: "24",
      height: "24",
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { clipPath: "url(#clip0_234_9664)", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "path",
            {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("defs", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
            "linearGradient",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { stopColor: "#37BDFF" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "0.25", stopColor: "#26C6F4" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "0.5", stopColor: "#15D0E9" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "0.75", stopColor: "#3BD6DF" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "1", stopColor: "#62DCD4" })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
            "linearGradient",
            {
              ...
              gradientUnits: "userSpaceOnUse",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { stopColor: "#1B48EF" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "0.5", stopColor: "#2080F1" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "1", stopColor: "#26B8F4" })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
            "linearGradient",
            {
              ...
              gradientUnits: "userSpaceOnUse",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { stopColor: "#39D2FF" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "0.5", stopColor: "#248FFA" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "1", stopColor: "#104CF5" })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
            "linearGradient",
            {
              ...
              gradientUnits: "userSpaceOnUse",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { stopColor: "white" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "1" })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("clipPath", { id: "clip0_234_9664", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("rect", { width: "24", height: "24", fill: "white" }) })
        ] })
      ]
    }
  ) });
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("defs", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
            "radialGradient",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { stopColor: "#1BA1E3" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "0.0001", stopColor: "#1BA1E3" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "0.300221", stopColor: "#5489D6" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "0.545524", stopColor: "#9B72CB" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "0.825372", stopColor: "#D96570" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("stop", { offset: "1", stopColor: "#F49C46" })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("clipPath", { id: "clip0_1_2", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("rect", { width: "24", height: "24", fill: "white" }) })
        ] })
      ]
    }
  ) });
};
var ClaudeIcon = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "svg",
    {
      width: "24",
      ...
      xmlns: "http://www.w3.org/2000/svg",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("rect", { width: "256", height: "256", fill: "#D19974" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "path",
          {
            fillRule: "evenodd",
...
var ChatGPTOutlinedIcon = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "svg",
    {
      width: "24",
      height: "24",
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "path",
        {
          d: "M21.6748 9.97835C21.9281 9.22799 22.0158 8.43302 21.9325 7.64653C21.849 6.86003 21.5964 6.10019 21.1912 5.41787C20.5906 4.38582 19.6734 3.56871 18.5717 3.08444C17.4699 2.60018 16.2408 2.47379 15.0614 2.72353C14.5295 2.13207 13.8757 1.65952 13.1437 1.33755C12.4117 1.01557 11.6185 0.851582 10.8171 0.856555C9.61139 0.853694 8.43596 1.22868 7.46018 1.92748C6.48438 2.62627 5.75874 3.61277 5.38781 4.74472C4.60237 4.90337 3.86032 5.22574 3.21136 5.69025C2.56241 6.15477 2.02151 6.7507 1.62488 7.43818C1.01954 8.4674 0.761147 9.6596 0.886962 10.8431C1.01278 12.0266 1.5163 13.14 2.32491 14.0228C2.07172 14.7731 1.9839 15.5682 2.0673 16.3547C2.15071 17.1411 2.40341 17.901 2.80853 18.5833C3.40913 19.6153 4.32646 20.4324 5.4282 20.9167C6.52991 21.4009 7.75908 21.5273 8.93833 21.2777C9.47032 21.8691 10.1241 22.3416 10.856 22.6636C11.5881 22.9856 12.3812 23.1496 13.1826 23.1446C14.3889 23.1477 15.565 22.7726 16.5411 22.0734C17.5174 21.3741 18.2432 20.3869 18.6137 19.2543C19.3992 19.0956 20.1412 18.7732 20.7902 18.3088C21.4391 17.8442 21.98 17.2482 22.3766 16.5608C22.9813 15.5317 23.239 14.3397 23.1129 13.1566C22.9868 11.9737 22.4833 10.8608 21.6748 9.97835ZM13.1845 21.6876C12.1942 21.689 11.235 21.3468 10.4747 20.721C10.509 20.7025 10.5692 20.67 10.6083 20.6463L15.106 18.0829C15.2189 18.0195 15.3126 17.9276 15.3776 17.8166C15.4426 17.7057 15.4764 17.5796 15.4756 17.4515V11.195L17.3767 12.2781C17.3866 12.283 17.3952 12.2902 17.4017 12.2992C17.4081 12.3082 17.4122 12.3186 17.4136 12.3295V17.5107C17.4122 18.6174 16.9663 19.6784 16.1736 20.4612C15.3809 21.2442 14.306 21.6851 13.1845 21.6876ZM4.08927 17.8548C3.59326 17.0092 3.4145 16.0184 3.58427 15.0559C3.61767 15.0757 3.67601 15.1108 3.71786 15.1345L8.21555 17.6979C8.32765 17.7625 8.45516 17.7966 8.58499 17.7966C8.71477 17.7966 8.84228 17.7625 8.95438 17.6979L14.4455 14.5695V16.7357C14.4462 16.7468 14.444 16.7578 14.4393 16.7679C14.4345 16.7779 14.4274 16.7866 14.4184 16.7933L9.87176 19.3834C8.8992 19.9362 7.74418 20.0855 6.66013 19.799C5.57606 19.5123 4.65149 18.8132 4.08927 17.8548ZM2.90605 8.16668C3.3999 7.31994 4.17992 6.67169 5.10949 6.3353C5.10949 6.37353 5.10726 6.44123 5.10726 6.4882V11.615C5.10647 11.7431 5.14026 11.869 5.20514 11.98C5.27001 12.0908 5.36365 12.1826 5.47643 12.246L10.9677 15.374L9.06659 16.4571C9.05721 16.4633 9.04643 16.4669 9.03525 16.4679C9.02407 16.4689 9.01277 16.4671 9.00244 16.4629L4.45531 13.8704C3.4845 13.3157 2.77622 12.4037 2.4858 11.3345C2.19538 10.2654 2.34651 9.12613 2.90605 8.16668ZM18.5252 11.7529L13.0339 8.62453L14.935 7.54188C14.9444 7.53581 14.9551 7.53207 14.9663 7.53107C14.9775 7.53006 14.9887 7.53185 14.9991 7.5362L19.5463 10.1264C20.2429 10.5234 20.8104 11.108 21.1826 11.8119C21.5546 12.5156 21.7157 13.3095 21.6471 14.1004C21.5784 14.8912 21.2829 15.6466 20.7949 16.2777C20.307 16.9088 19.6469 17.3898 18.8921 17.664C18.8921 17.6254 18.8921 17.5578 18.8921 17.5107V12.3839C18.8931 12.2561 18.8596 12.1303 18.7952 12.0194C18.7307 11.9085 18.6375 11.8167 18.5252 11.7529ZM20.4173 8.94309C20.3838 8.92287 20.3256 8.88814 20.2837 8.86446L15.786 6.30103C15.6738 6.2365 15.5464 6.20247 15.4166 6.20247C15.2868 6.20247 15.1593 6.2365 15.0472 6.30103L9.55592 9.42956V7.26334C9.55542 7.25224 9.55744 7.24121 9.56226 7.23118C9.56694 7.22115 9.57416 7.21241 9.58315 7.20577L14.1298 4.61773C14.8263 4.22145 15.6229 4.02906 16.4263 4.06308C17.2295 4.09711 18.0063 4.35615 18.666 4.80989C19.3255 5.26363 19.8406 5.8933 20.1507 6.62527C20.4608 7.35723 20.5533 8.16116 20.4173 8.94309ZM8.52242 12.804L6.62089 11.7209C6.61095 11.7161 6.60231 11.7088 6.59586 11.6998C6.58943 11.6908 6.5853 11.6805 6.58395 11.6695V6.4882C6.58445 5.69465 6.81407 4.91764 7.24586 4.24815C7.67771 3.57865 8.29388 3.04437 9.02226 2.70785C9.75069 2.37133 10.561 2.24648 11.3587 2.34792C12.1564 2.44937 12.9084 2.77291 13.5264 3.28068C13.4922 3.29912 13.4324 3.33165 13.3928 3.35538L8.89514 5.91878C8.78225 5.98208 8.68857 6.07389 8.62356 6.1848C8.55862 6.29568 8.5248 6.42167 8.52553 6.54971L8.52242 12.804ZM9.55504 10.6071L12.0008 9.21333L14.4464 10.6062V13.3928L12.0008 14.7856L9.55504 13.3928V10.6071Z",
          fill: "currentColor"
        }
      )
    }
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "path",
          {
            fillRule: "evenodd",
            clipRule: "evenodd",
            d: "M10.2333 3.53516L16.8 20.4643H13.4695L12.1597 17.0199H4.64041L3.33058 20.4643H6.10352e-05L6.56683 3.53516H10.2333ZM5.83939 13.8669H10.9607L8.3947 7.11953L5.83939 13.8669Z",
            fill: "currentColor"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "path",
          {
            d: "M17.5295 3.53516L24 20.4643H20.7582L14.4001 3.53516H17.5295Z",
            fill: "currentColor"
          }
        )
      ]
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "svg",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "path",
        {
          d: "M9.46755 2.99585V3.83998V5.24687H11.1558V3.83998V2.99585H12.8441V3.83998V5.24687H14.5324V3.83998V2.99585H16.2206V3.83998V5.24687H17.0648H18.753V6.93514V7.77928H20.1599H21.0041V9.46755H20.1599H18.753V11.1558H20.1599H21.0041V12.8441H20.1599H18.753V14.5324H20.1599H21.0041V16.2206H20.1599H18.753V17.0648V18.753H17.0648H16.2206V20.1599V21.0041H14.5324V20.1599V18.753H12.8441V20.1599V21.0041H11.1558V20.1599V18.753H9.46755V20.1599V21.0041H7.77928V20.1599V18.753H6.93514H5.24687V17.0648V16.2206H3.83998H2.99585V14.5324H3.83998H5.24687V12.8441H3.83998H2.99585V11.1558H3.83998H5.24687V9.46755H3.83998H2.99585V7.77928H3.83998H5.24687V6.93514V5.24687H6.93514H7.77928V3.83998V2.99585H9.46755ZM17.0648 6.93514H6.93514V17.0648H17.0648V6.93514ZM15.5172 9.18617V9.74893V14.251V14.8137H14.1103V14.251V9.74893V9.18617H15.5172ZM11.1312 9.18617L11.2508 9.49568L13.3119 14.8137H11.803L11.5286 14.1103H9.65748L9.38313 14.8137H7.87776L9.93886 9.49568L10.0584 9.18617H11.1312ZM10.5931 11.6975L10.2026 12.7034H10.9835L10.5931 11.6975Z",
          fill: "CurrentColor"
        }
      )
    }
...
var CaptivePortal = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { ...props, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("g", { mask: "url(#mask0_1921_34815)", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "path",
    {
...
var CustomIcon = ({ icon, sx }) => {
  const renderIcon = () => {
    switch (icon) {
      case "Expand":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Expand, { sx });
      case "ArrowForward":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ArrowForward, { sx });
      case "ChatHubTwoLayoutIcon":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChatHubTwoLayoutIcon, { sx });
      case "ChatHubThreeLayoutIcon":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChatHubThreeLayoutIcon, { sx });
      case "FullScreen":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(FullScreen, { sx });
      case "FullScreenExit":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(FullScreenExit, { sx });
      case "Delete":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Delete, { sx });
      case "Restart":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Restart, { sx });
      case "ArrowRight":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ArrowRight, { sx });
      case "Edit":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Edit, { sx });
      case "ChatGPTIcon":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChatGPTIcon, { sx });
      case "ChatGPTOutlinedIcon":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChatGPTOutlinedIcon, { sx });
      case "BingIcon":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(BingIcon, { sx });
      case "BardIcon":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(BardIcon, { sx });
      case "ClaudeIcon":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ClaudeIcon, { sx });
      case "ClaudeOutlinedIcon":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ClaudeOutlinedIcon, { sx });
      case "AIChip":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AIChip, { sx });
      case "Read":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Read, { sx });
      case "CaptivePortal":
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CaptivePortal, { sx });
      default:
        return null;
    }
  };
...
var WebChatGPTLogo = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_SvgIcon.default, { viewBox: "0 0 24 24", sx: { color: "primary.main", ...props.sx }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 22 22", fill: "none", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { clipPath: "url(#clip0_5391_39565)", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "path",
        {
          fillRule: "evenodd",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("g", { mask: "url(#mask0_5391_39565)", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "path",
        {
          d: "M18.0921 18.1034C19.9118 16.2865 21.0375 13.7749 21.0375 11.0004C21.0375 5.45682 16.5436 0.962891 11 0.962891C5.45646 0.962891 0.962524 5.45682 0.962524 11.0004C0.962524 16.5439 5.45646 21.0378 11 21.0378C12.4612 21.0378 13.8495 20.7256 15.1017 20.1642L18.7031 21.0312C18.8795 21.0737 19.0337 20.9054 18.9758 20.7334L18.0921 18.1034Z",
          fill: "white"
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("g", { mask: "url(#mask1_5391_39565)", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "path",
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("clipPath", { id: "clip0_5391_39565", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("rect", { width: "22", height: "22", fill: "white" }) }) })
  ] }) });
};
