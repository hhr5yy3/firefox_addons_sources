var pageParser = function() {
  ...
  const C = Object.freeze({
    status: "aborted"
  }), Pe = (e) => ({ status: "dirty", value: e }), z$1 = (e) => ({ status: "valid", value: e }), Jt = (e) => e.status === "aborted", Wt = (e) => e.status === "dirty", Fe = (e) => e.status === "valid", Ge = (e) => typeof Promise < "u" && e instanceof Promise;
  function _t(e, t, r, s) {
  ...
  class Ze extends P {
    ...
    _parse(t) {
      ...
      return z$1(s.then((n) => this._def.type.parseAsync(n, {
        path: r.path,
  ...
  class ce extends P {
    _parse(t) {
      return this._getType(t) === y.undefined ? z$1(void 0) : this._def.innerType._parse(t);
    }
    unwrap() {
  ...
  class Ee extends P {
    _parse(t) {
      return this._getType(t) === y.null ? z$1(null) : this._def.innerType._parse(t);
    }
    unwrap() {
      return this._def.innerType;
    }
  ...
  const pi = Se.merge(
    ...
    ...e,
    genre: I.Webpage
  }), cs = (e) => Object.keys(e.shape), gi = cs(Se), yi = cs(as), vi = (e, t, r) => {
    if (r.length > 0 && typeof r[0] == "string") {
      const s = t.startsWith("rft_") ? t : `rft.${t}`;
      e.append(s, r[0]);
    }
  }, _i = (e, t, r) => {
    e.append(t, r);
    ...
    return Object.entries(e).forEach(([r, s]) => {
      Array.isArray(s) ? vi(t, r, s) : typeof s == "string" && s && (yi.includes(r) ? _i(t, r, s) : bi(t, r, s));
    }), t;
  }, br = (e, t, r, s) => {
    const n = t.getAll(r).filter((i) => !!i).map((i) => i.trim());
    return n.length === 0 ? e : { ...e, [s]: n };
  }, Si = (e) => {
    const t = xi(e), r = (n, i) => {
      if (i === "au")
        return br(n, t, "rft.au", "au");
      if (i === "rft_id")
        return br(n, t, "rft_id", "rft_id");
      const a = t.get(`rft.${i}`);
      return a ? { ...n, [i]: a.trim() } : n;
    }, s = gi.reduce(r, {});
    return Object.keys(s).length === 0 ? null : s;
  }, xi = (e) => URL.canParse(e) ? new URL(e).searchParams : new URLSearchParams(e);
  ...
  function M() {
    return { bookmarkingWorkflowUrl: null, resource: null };
  }
  function T(e) {
    return { bookmarkingWorkflowUrl: null, resource: e };
  }
  function Oi() {
    return { z3988SearchResult: true };
  }
  const Ti = (e) => {
    const t = e.getAttribute("title");
    return t ? Si(t) : null;
  }, ys = ({ document: e }) => {
    const t = Array.from(e.querySelectorAll(".Z3988"));
    if (t.length === 0)
      return M();
    const r = t.map(Ti).find((s) => s !== null);
    return r ? T(r) : M();
  }, Pi = (e) => {
    const t = Array.from(e.querySelectorAll(".author > a")).map((r) => {
      var s;
      return ((s = r.textContent) == null ? void 0 : s.trim()) ?? "";
    }).filter(Boolean);
    return t.length ? t : void 0;
  }, Li = (e) => {
    var t;
    return ((t = e.querySelector(
      "#rpi-attribute-book_details-edition > .rpi-attribute-value > span"
    )) == null ? void 0 : t.textContent) ?? void 0;
  }, ji = (e) => {
    var s, n;
    const t = ((s = e.querySelector(
      "#rpi-attribute-book_details-isbn10 > .rpi-attribute-value > span"
    )) == null ? void 0 : s.textContent) ?? void 0, r = ((n = e.querySelector(
      "#rpi-attribute-book_details-isbn13 > .rpi-attribute-value > span"
    )) == null ? void 0 : n.textContent) ?? void 0;
    if (t && r)
      return `${t},${r}`;
    if (t)
      return t;
    ...
    var t;
    return ((t = e.querySelector(
      "#rpi-attribute-book_details-series > .rpi-attribute-value > a"
    )) == null ? void 0 : t.textContent) ?? void 0;
  }, Bi = (e) => {
    var s, n;
    const t = ((s = e.querySelector(
      "#rpi-attribute-book_details-fiona_pages > .rpi-attribute-value > span"
    )) == null ? void 0 : s.textContent) ?? void 0;
    return (t ? (n = /\d+/.exec(t)) == null ? void 0 : n[0] : null) ?? void 0;
  }, Mi = ({ url: e, document: t }) => {
    var h, b;
    const r = Pi(t), s = Li(t), n = ji(t), i = Vi(t), a = Zi(t), o = qi(t), l = ((b = (h = t.getElementById("productTitle")) == null ? void 0 : h.textContent) == null ? void 0 : b.trim()) ?? void 0, u = Bi(t);
    return {
      bookmarkingWorkflowUrl: null,
      resource: F(I.Book, {
        au: r,
        date: i,
        edition: s,
  ...
  }, vs = (e) => Array.from(e.querySelectorAll(".author-source-list li a")).filter((t) => t.childNodes.length > 0).map((t) => {
    var r;
    return (r = t.childNodes[0].textContent) == null ? void 0 : r.trim();
  }).filter((t) => !!t), _s = (e) => {
    var r, s;
    const t = e.querySelector(".article-header");
    return (s = (r = t == null ? void 0 : t.querySelector("h1 span")) == null ? void 0 : r.textContent) == null ? void 0 : s.trim();
  }, bs = (e) => {
    var r, s;
    return { date: (s = (r = e == null ? void 0 : e.textContent) == null ? void 0 : r.match(/\d{4}/)) == null ? void 0 : s[0], pub: "Elsevier Inc." };
  }, Ui = (e) => {
    var a, o, l;
    const t = e.querySelector(".article-meta");
    if (!t)
      return {};
    const r = ((a = t.querySelector(".issue")) == null ? void 0 : a.textContent) ?? void 0, s = ((l = (o = t.querySelector(".title")) == null ? void 0 : o.textContent) == null ? void 0 : l.trim()) ?? void 0, [n, i] = ((r == null ? void 0 : r.split(",")) ?? []).map(
      (u) => u.trim()
    );
    return {
      volume: he(n),
    ...
    var u, d;
    const t = (u = e.querySelector(".article-header .source")) == null ? void 0 : u.textContent, r = (d = t == null ? void 0 : t.match(/\d{4}-\d{2}-\d{2}/)) == null ? void 0 : d[0], s = t == null ? void 0 : t.match(/Pages (\d+-\d+)/), [n, i] = ((s == null ? void 0 : s[1].split("-")) ?? []).map((h) => h.trim()), { jtitle: a, volume: o, issue: l } = Ui(e);
    return T(
      U(I.Article, {
        au: vs(e),
        atitle: _s(e),
    ...
    var l, u;
    const [t, r] = e.querySelectorAll(".source"), { date: s, pub: n } = bs(r), i = e.querySelector(".browse__book-toc"), [a, o] = (((u = (l = i == null ? void 0 : i.querySelector("h1")) == null ? void 0 : l.textContent) == null ? void 0 : u.split(",")) ?? []).map((d) => d.trim());
    return T(
      F(I.Book, {
        btitle: a,
        edition: o,
        pub: n,
        au: t.textContent ? [t.textContent] : void 0,
        date: s
      })
    );
  }, Wi = (e) => {
    ...
    if (!t)
      return {};
    const r = ((o = t.querySelector(".edition")) == null ? void 0 : o.textContent) ?? void 0, s = ((u = (l = t.querySelector(".title")) == null ? void 0 : l.textContent) == null ? void 0 : u.trim()) ?? void 0, n = t.querySelector(".copyright"), { date: i, pub: a } = bs(n);
    return {
      edition: r,
      btitle: s,
      date: i,
    ...
    var d;
    const { edition: t, btitle: r, date: s, pub: n } = Wi(e), i = (d = e.querySelector(".article-header .source")) == null ? void 0 : d.textContent, a = /(\d+-\d+|[IVXLCDM]+-[IVXLCDM]+)/i, o = i == null ? void 0 : i.match(a), [l, u] = ((o == null ? void 0 : o[1].split("-")) ?? []).map((h) => h.trim());
    return T(
      F(I.Bookitem, {
        au: vs(e),
        atitle: _s(e),
    ...
    var o, l, u, d, h, b, v;
    const r = (l = (o = e.querySelector(".c-cksc-content-header__title")) == null ? void 0 : o.textContent) == null ? void 0 : l.trim(), s = (d = (u = e.querySelector(".c-cksc-content-nice__button")) == null ? void 0 : u.textContent) == null ? void 0 : d.trim(), n = (b = (h = e.querySelector(".c-cksc-content-nice__date")) == null ? void 0 : h.textContent) == null ? void 0 : b.trim(), i = e.evaluate(
      '//p[contains(text(), "ISBN")]',
      e,
      null,
      XPathResult.ANY_TYPE
    ), a = Yt((v = i.iterateNext()) == null ? void 0 : v.textContent);
    return T({
      genre: I.Document,
      title: r,
      pub: s,
  ...
  }, Es = (e) => e.querySelector(".browse-toc") ?? e.querySelector(".browse__journal"), Xi = (e) => {
    var s, n;
    const t = Es(e), r = (s = t == null ? void 0 : t.querySelector("h1")) == null ? void 0 : s.firstElementChild;
    return (n = r == null ? void 0 : r.textContent) == null ? void 0 : n.trim();
  }, Hi = (e) => {
    var o, l, u;
    const t = Es(e), r = t == null ? void 0 : t.querySelector("figure figcaption.source");
    if (r) {
      const [d, h, b] = (((o = r.textContent) == null ? void 0 : o.split(",")) ?? []).map(
        (v) => v.trim()
      );
      return {
        date: d,
    ...
    const s = (l = t == null ? void 0 : t.querySelector("p")) == null ? void 0 : l.textContent, [n, i] = (s == null ? void 0 : s.split(",")) ?? [];
    return {
      date: ((u = t == null ? void 0 : t.querySelector(".source span")) == null ? void 0 : u.textContent) ?? void 0,
      volume: he(n),
      issue: he(i)
    };
  }, Yi = (e) => {
    const { date: t, volume: r, issue: s } = Hi(e);
    return T(
      U(I.Journal, {
        jtitle: Xi(e),
        date: t,
  ...
  var Ss = /* @__PURE__ */ ((e) => (e.Book = "Book", e.Chapter = "Book Chapter", e.Article = "Full Text Article", e.Journal = "Journal", e.Guideline = "Guideline", e))(Ss || {});
  const Ki = (e) => Object.values(Ss).includes(
    e
  ), Qi = (e, t) => {
    const r = e.querySelector(".content-type") ?? e.querySelector(".c-cksc-content-header__content-type");
    if (!r)
      return t.includes("journal") ? "Journal" : void 0;
    ...
    "@context": c.string()
  }), ta = (e) => qe.safeParse(e).success, xs = 'script[type="application/ld+json"]', $s = (e) => Array.from(e.querySelectorAll(xs)), Kt = (e) => e.querySelector(xs), At = (e) => {
    ...
    "@graph": c.array(ra)
  }), na = (e) => sa.safeParse(e).success, ia = (e) => {
    const t = $s(e);
    if (t.length === 0)
      return null;
    const r = t.map(At).filter(na).map((s) => s["@graph"]);
    return r.length !== 1 ? null : r[0];
  }, aa = (e, t) => e.find((r) => r["@type"] === t) ?? null, oa = (e, t) => e.find((r) => r["@id"] === t) ?? null, ca = (e) => {
    const t = aa(e, "WebPage");
    if (!t)
      return null;
    const r = t.author ? oa(e, t.author["@id"]) : void 0;
    return os({
      au: r != null && r.name ? [r.name] : void 0,
    ...
    e.querySelectorAll(`meta[${t}='${r}']`)
  ).map((s) => s.getAttribute("content")).filter((s) => !!(s != null && s.trim())), Rs = (e) => {
    const t = /* @__PURE__ */ new Map(), r = e.split(";").filter((s) => !!s);
    for (const s of r) {
      const [n, i, a] = s.split(":");
      t.set(n, { type: i, value: a });
    }
    return t;
  }, ua = (e) => {
    const { pathname: t } = new URL(e);
    return t.startsWith("/toc/") ? "journal" : t.startsWith("/article/") ? "article" : void 0;
  }, da = (e) => {
    var l, u, d, h, b;
    const t = (d = (u = (l = e.querySelector("header h1 span")) == null ? void 0 : l.firstChild) == null ? void 0 : u.textContent) == null ? void 0 : d.trim(), r = (b = (h = e.querySelector("header p span")) == null ? void 0 : h.textContent) == null ? void 0 : b.trim(), s = /\d{4}-\d{3}[\dX]/g, n = (r == null ? void 0 : r.match(s)) ?? [], [i, a] = [n[0], n[1]], o = e.evaluate(
      '//dt[contains(text(), "Publisher")]/following-sibling::dd/a',
      e,
      null,
    ...
    let t, r;
    const s = ne(e, "name", "citation_issn");
    return s.length === 2 ? (t = s[1], r = s[0]) : t = s[0], { eissn: t, issn: r };
  }, pa = (e) => {
    const t = p(e, "name", "citation_journal_title"), r = p(e, "name", "citation_title"), s = ne(e, "name", "citation_author"), n = p(e, "name", "citation_doi"), { eissn: i, issn: a } = ha(e), o = p(e, "name", "citation_publisher"), l = p(e, "name", "citation_publication_date"), u = p(e, "name", "citation_volume"), d = p(e, "name", "citation_issue"), h = p(e, "name", "citation_firstpage"), b = p(e, "name", "citation_lastpage");
    return T(
      U(I.Article, {
        jtitle: t,
        atitle: r,
  ...
  var w = /* @__PURE__ */ ((e) => (e[e.None = 0] = "None", e[e.Book = 1] = "Book", e[e.Chapter = 2] = "Chapter", e[e.Journal = 3] = "Journal", e[e.Article = 4] = "Article", e[e.AudioVisual = 5] = "AudioVisual", e[e.Webpage = 6] = "Webpage", e))(w || {});
  const ma = (e) => {
    var n;
    const t = p(e, "name", "pbContext");
    if (!t)
      return w.None;
    const r = Rs(t);
    switch (r.has("page") ? (n = r.get("page")) == null ? void 0 : n.value : null) {
      case "Article/Chapter View":
        return w.Article;
    ...
    var r, s;
    const t = (s = (r = e.querySelector('meta[property="article:author"]')) == null ? void 0 : r.getAttribute("content")) == null ? void 0 : s.split(",").map((n) => n.trim());
    return t && t.length > 0 ? t : void 0;
  }, ws = (e) => {
    const t = /* @__PURE__ */ new Map(), r = Array.from(e.querySelectorAll(".rlist>li>span")).map((i) => {
      var a;
      return (a = i.textContent) == null ? void 0 : a.trim();
    }).join(""), s = /^ISSN:\s(\d{4}-\d{3}(?:\d|X))/.exec(r);
    s && t.set("issn", s[1]);
    const n = /Online ISSN:\s(\d{4}-\d{3}(?:\d|X))/.exec(r);
    return n && t.set("eissn", n[1]), t;
  }, ya = (e) => {
    var t;
    return ((t = e.querySelector(
      'span[property="isPartOf"][typeof="PublicationVolume"] > span[property="volumeNumber"]'
    )) == null ? void 0 : t.textContent) ?? void 0;
  }, va = (e) => {
    var t;
    return ((t = e.querySelector(
      'span[property="isPartOf"][typeof="PublicationIssue"] > span[property="issueNumber"]'
    )) == null ? void 0 : t.textContent) ?? void 0;
  }, _a = (e) => {
    var t;
    return ((t = e.querySelector('meta[name="dc.Identifier"][scheme="doi"]')) == null ? void 0 : t.getAttribute("content")) ?? void 0;
  }, ba = (e) => {
    var t;
    return ((t = e.querySelector("h1")) == null ? void 0 : t.textContent) ?? void 0;
  }, Ea = (e) => {
    var a;
    const t = /* @__PURE__ */ new Map(), r = (a = e.querySelector("h2.heading-m")) == null ? void 0 : a.textContent, s = r == null ? void 0 : r.match(/Issue\s+(\d+(?:-\d+)?)/);
    s && t.set("issue", s[1]);
    const n = r == null ? void 0 : r.match(/Volume\s+(\d+)/);
    n && t.set("volume", n[1]);
    const i = r == null ? void 0 : r.match(/(\d{4})$/);
    return i && t.set("date", i[1]), t;
  }, Sa = (e) => {
    const t = ga(e.document), r = p(e.document, "name", "dc.Date"), s = _a(e.document), n = ws(e.document), i = n.get("issn"), a = n.get("eissn"), o = va(e.document), l = p(
      e.document,
      "name",
      "citation_journal_title"
    ), u = p(e.document, "name", "dc.Publisher"), d = p(e.document, "name", "dc.Title"), h = ya(e.document);
    return U(I.Article, {
      au: t,
      date: r,
      eissn: a,
    ...
    const t = ws(e.document), r = t.get("issn"), s = t.get("eissn"), n = ba(e.document), i = Ea(e.document), a = i.get("issue"), o = i.get("volume"), l = i.get("date");
    return U(I.Journal, {
      eissn: s,
      issn: r,
      jtitle: n,
    ...
    var i;
    const t = p(e, "name", "citation_type"), r = p(
      e,
      "name",
    ...
    if (t === "CHP")
      return w.Chapter;
    const s = e.querySelector(".book-edition-year");
    return (i = s == null ? void 0 : s.textContent) != null && i.includes("Book") ? w.Book : e.getElementById("journal-title") ? w.Journal : w.None;
  }, Qt = (e) => {
    var t;
    return p(e, "name", "citation_doi") ?? p(e, "name", "dc.identifier") ?? ((t = e.querySelector(".doi .anchor-text")) == null ? void 0 : t.textContent) ?? void 0;
  }, Ra = (e) => {
    var s, n;
    const t = Array.from(
      e.querySelectorAll(".kf-details .kf-detail-item:has(h3)")
    ), r = /* @__PURE__ */ new Map();
    for (const i of t) {
      const a = (s = i.querySelector("h3")) == null ? void 0 : s.textContent, o = (n = i.querySelector("p")) == null ? void 0 : n.textContent;
      a && o && r.set(a, o);
    }
    return r;
  }, er = (e, t) => {
    const r = Array.from(e.querySelectorAll(t)).map((s) => s.textContent).filter((s) => !!s);
    return r.length > 0 ? r : void 0;
  }, wa = (e) => {
    var r;
    const t = (r = e.querySelector(".js-issn")) == null ? void 0 : r.textContent;
    if (t)
      return t.replace("Online ISSN: ", "");
  }, Ca = (e) => {
    const t = e.get("DOI");
    if (t)
      return URL.canParse(t) ? new URL(t).pathname.substring(1) : t;
  }, ka = (e) => {
    const t = Ra(e), r = p(e, "property", "og:title"), s = p(e, "property", "og:book:isbn"), n = t.get("Published"), i = er(e, ".authors-container .author-detail h3"), a = Qt(e) ?? Ca(t);
    return F(I.Book, {
      au: i,
      date: n,
      doi: a,
    ...
    var d;
    const t = p(e, "property", "og:title"), r = p(e, "property", "og:book:isbn"), s = p(e, "name", "citation_publication_date"), n = er(e, ".author-group .button-link-text"), i = p(e, "name", "citation_firstpage"), a = p(e, "name", "citation_lastpage"), o = p(e, "name", "citation_publisher"), l = Qt(e), u = p(e, "name", "citation_inbook_title") ?? ((d = e.querySelector(".publication-title")) == null ? void 0 : d.textContent) ?? void 0;
    return F(I.Bookitem, {
      au: n,
      btitle: u,
      date: s,
    ...
    var h;
    const t = p(e, "property", "og:title"), r = p(e, "name", "citation_issn"), s = p(e, "name", "citation_publication_date"), n = er(e, ".author-group .button-link-text"), i = p(e, "name", "citation_publisher"), a = p(e, "name", "citation_firstpage"), o = p(e, "name", "citation_issue"), l = p(e, "name", "citation_volume"), u = Qt(e), d = p(e, "name", "citation_journal_title") ?? ((h = e.querySelector(".publication-title")) == null ? void 0 : h.textContent) ?? void 0;
    return U(I.Article, {
      au: n,
      jtitle: d,
      date: s,
    ...
    var s;
    const t = ((s = e.getElementById("journal-title")) == null ? void 0 : s.textContent) ?? void 0, r = wa(e);
    return U(I.Journal, {
      issn: r,
      title: t
    });
    ...
    const t = p(e, "name", "pbContext");
    return t && Rs(t).has("article") ? w.Article : w.Journal;
  }, La = (e) => {
    var n;
    const t = e.querySelector(".itemPageRangeHistory");
    if (!t)
      return;
    const s = Array.from(t.childNodes).find(
      (i) => {
        var a;
        return (a = i.textContent) == null ? void 0 : a.trim().startsWith("Page");
      }
    );
    if (s) {
      const i = (n = s.textContent) == null ? void 0 : n.replace(/Pages?/, "").trim();
      return i || void 0;
    }
  }, ja = (e) => {
    var n, i;
    const t = (n = e.querySelector(".issue-heading")) == null ? void 0 : n.textContent;
    return t ? (i = t.split(",")[0]) == null ? void 0 : i.replace("Volume", "").trim() : void 0;
  }, Va = (e) => {
    var s;
    const t = (s = e.querySelector(
      ".issue-heading .nav-toc-list"
    )) == null ? void 0 : s.textContent;
    return t ? t.replace("Issue", "").trim() : void 0;
  }, Za = (e) => {
    const t = p(e, "property", "og:title"), r = p(e, "name", "dc.Publisher"), s = p(e, "name", "dc.Date"), n = p(e, "name", "publication_doi"), i = p(e, "name", "citation_journal_title"), a = ne(e, "name", "dc.Creator"), o = ja(e), l = Va(e), u = La(e), d = u != null && u.includes("-") ? u.split("-")[0] : u, h = u != null && u.includes("-") ? u.split("-")[1] : u;
    return U(I.Article, {
      au: a,
      jtitle: i,
      date: s,
    ...
    const t = p(e, "property", "og:title"), r = p(e, "name", "publication_doi");
    return U(I.Journal, {
      doi: r,
      title: t
    });
  ...
  function Cs(e) {
    return ms.safeParse(e).success;
  }
  function Ma(e) {
    return gs.safeParse(e).success;
  }
  function ph(e) {
    return ps.safeParse(e).success;
  }
  const Ua = (e) => {
    var s, n;
    const r = (n = (s = Array.from(e.querySelectorAll("tr th")).find((i) => {
      var a;
      return ((a = i.textContent) == null ? void 0 : a.trim()) === "DOI:";
    })) == null ? void 0 : s.nextElementSibling) == null ? void 0 : n.querySelector('span[property="identifier"]');
    return (r == null ? void 0 : r.textContent) ?? void 0;
  }, Da = (e) => {
    const t = /Record\/(\d+)/.exec(e);
    if (t && t.length > 1)
      return t[1];
  }, Ja = (e) => {
    const { url: t, document: r } = e, s = ys(e);
    if (!Cs(s))
      return s;
    const n = Ua(r);
    return n && (s.resource.rft_id = [`info:doi/${n}`]), s.resource.bibid = Da(t), s;
  }, Wa = qe.extend({
  ...
  }), za = (e) => Wa.safeParse(e).success, Fa = (e) => {
    const t = $s(e);
    if (t.length === 0)
      return null;
    const r = t.map(At).filter(za);
    return r.length !== 1 ? null : r[0];
  }, Ga = ({
    url: e,
    document: t
  ...
  }, ks = (e) => p(e, "name", "doi") ?? p(e, "name", "DOI") ?? p(e, "name", "citation_doi") ?? p(e, "name", "dc.identifier") ?? p(e, "name", "prism.doi") ?? void 0, Is = (e) => {
    var n, i;
    const t = ((n = e.editor) == null ? void 0 : n.map((a) => a.name)) ?? [], s = [...((i = e.author) == null ? void 0 : i.map((a) => a.name)) ?? [], ...t];
    if (s.length !== 0)
      return s;
  };
  var ct = /* @__PURE__ */ ((e) => (e.Book = "Book", e.Journal = "Journal", e.Periodical = "Periodical", e.PublicationVolume = "PublicationVolume", e.ScholarlyArticle = "ScholarlyArticle", e.VideoObject = "VideoObject", e.WebPage = "WebPage", e))(ct || {}), ge = /* @__PURE__ */ ((e) => (e.Article = "article", e.Book = "book", e.Paper = "Paper", e.Video = "video.other", e.Website = "website", e))(ge || {}), ee = /* @__PURE__ */ ((e) => (e.Article = "/article/", e.Book = "/book/", e.Chapter = "/chapter/", e.Video = "/video/", e.ReferenceWorkEntry = "/referenceworkentry/", e.ReferenceWork = "/referencework/", e.Protocol = "/protocol/", e.Collections = "/collections/", e.Journal = "/journal/", e.JournalIssue = "/volumes-and-issues/", e))(ee || {});
  const Ns = c.object({
  ...
  }), Os = (e) => Ns.safeParse(e).success, Xa = qe.extend({
    "@type": c.literal(ct.WebPage),
    mainEntity: Ns
  }), Ha = (e) => Xa.safeParse(e).success, Ya = c.object({
    "@type": c.array(c.string()),
    name: c.string().optional(),
    issn: c.array(c.string()),
    volumeNumber: c.string().optional()
  }), Sr = (e) => Ya.safeParse(e).success, Ka = (e, t) => {
    var r;
    return p(e, "name", "citation_issn") ?? p(e, "name", "prism.issn") ?? (Os(t.isPartOf) ? (r = t.isPartOf.issn) == null ? void 0 : r[0] : void 0);
  }, xr = (e, t) => {
    const r = Is(t), s = p(e, "name", "citation_online_date"), n = ks(e), i = p(e, "name", "citation_issue"), a = Ka(e, t), o = Sr(t.isPartOf) && t.isPartOf.issn.length > 0 ? t.isPartOf.issn[1] : void 0, l = t.pageStart, u = t.pageEnd, d = t.headline, h = t.isPartOf.name, b = Sr(t.isPartOf) ? t.isPartOf.volumeNumber : void 0;
    return U(I.Article, {
      au: r,
      date: s,
      doi: n,
  ...
  }), eo = (e) => Qa.safeParse(e).success, to = (e) => {
    const t = e.querySelectorAll(
      ".c-bibliographic-information__list-item"
    ), r = /* @__PURE__ */ new Map();
    return t.forEach((s) => {
      var a, o, l, u;
      const n = (o = (a = s.querySelector(".u-text-bold")) == null ? void 0 : a.textContent) == null ? void 0 : o.trim(), i = (u = (l = s.querySelector(".c-bibliographic-information__value")) == null ? void 0 : l.textContent) == null ? void 0 : u.trim();
      n && i && r.set(n, i);
    }), r;
  }, ro = (e, t) => {
    var d, h, b;
    const r = to(e), s = Is(t), n = (d = t.copyrightYear) == null ? void 0 : d.toString(), i = ks(e) ?? r.get(
      "DOI"
      /* DOI */
    ), a = t.name ?? r.get(
      "Book Title"
      ...
      "Softcover ISBN"
      /* SOFTCOVER_ISBN */
    ), l = ((h = t.numberOfPages) == null ? void 0 : h.toString()) ?? r.get(
      "Number of Pages"
      /* NUMBER_OF_PAGES */
    ), u = ((b = t.publisher) == null ? void 0 : b.name) ?? r.get(
      "Publisher"
      /* PUBLISHER */
    );
    return F(I.Book, {
    ...
    description: c.string()
  }), no = (e) => so.safeParse(e).success, io = (e) => {
    const t = e.editor.map(
      ({ givenName: a, familyName: o }) => `${a} ${o}`
    ), r = e.name, [s, n] = e.issn, i = e.publisher.name;
    return U(I.Journal, {
      au: t,
      jtitle: r,
      eissn: s,
  ...
  }), oo = (e) => ao.safeParse(e).success, co = (e, t) => {
    var a;
    const r = Array.from(
      e.querySelectorAll('dd[data-test="video-segment-author"]')
    ).map((o) => {
      var l;
      return (l = o.textContent) == null ? void 0 : l.trim();
    }).filter((o) => !!o), s = t != null && t.uploadDate ? new Date(t.uploadDate).getFullYear().toString() : void 0, n = (t == null ? void 0 : t.name) ?? p(e, "property", "og:title") ?? void 0, i = ((a = e.querySelector("video-about-doi")) == null ? void 0 : a.textContent) ?? void 0;
    return Ce({
      au: r.length > 0 ? r : void 0,
      date: s,
      doi: i,
      title: n
    });
  }, lo = (e) => {
    const t = p(e, "property", "og:title");
    return os({
      title: t
    });
  }, uo = (e, t) => {
    const r = p(t, "property", "og:type");
    return r === ge.Article && e.includes(ee.Article) ? w.Article : r === ge.Book && (e.includes(ee.Book) || e.includes(ee.ReferenceWork)) ? w.Book : r === ge.Paper && e.includes(ee.Chapter) ? w.Chapter : r === ge.Paper && (e.includes(ee.ReferenceWorkEntry) || e.includes(ee.Protocol)) ? w.Article : r === ge.Video && e.includes(ee.Video) ? w.AudioVisual : r === ge.Website && (e.includes(ee.Collections) || e.includes(ee.JournalIssue)) ? w.Webpage : r === ge.Website && e.includes(ee.Journal) ? w.Journal : w.None;
  }, ho = (e, t, r) => e === w.AudioVisual && oo(r) ? T(co(t, r)) : e === w.Book && eo(r) ? T(ro(t, r)) : (e === w.Chapter || e === w.Article) && Os(r) ? T(xr(t, r)) : e === w.Article && Ha(r) ? T(
    xr(t, r.mainEntity)
  ) : e === w.Journal && no(r) ? T(io(r)) : M(), po = ({ url: e, document: t }) => {
    const r = uo(e, t);
    if (r === w.Webpage)
      return T(lo(t));
    const s = Kt(t);
    ...
    const t = p(e, "property", "og:type");
    return t === "Book" || t === "books.book" ? w.Book : t === "Chapter" ? w.Chapter : t === "Journal" ? w.Journal : t === "Article" ? w.Article : w.None;
  }, Rt = (e) => {
    const t = ne(
      e,
      "name",
      ...
      e.querySelectorAll("#product-details-content .product-authors")
    ).map((n) => n.textContent).filter((n) => !!n), s = /* @__PURE__ */ new Set([...t, ...r]);
    return s.size > 0 ? [...s] : void 0;
  }, go = (e) => {
    const t = Array.from(
      e.querySelectorAll("#product-details-content .text-piped p")
    ).map((r) => r.textContent).find((r) => r == null ? void 0 : r.endsWith(" pages"));
    if (t)
      return Ft(t);
  }, wt = (e) => {
    const t = /* @__PURE__ */ new Map(), r = Array.from(
      e.querySelectorAll(".journal-info-container .info-block")
    ).flatMap((s) => Array.from(s.querySelectorAll(".info_label")));
    for (const s of r) {
      const n = s.nextElementSibling;
      if (!(n != null && n.classList.contains("info_value")))
        continue;
      const i = $r(s.textContent, ":"), a = $r(n.textContent, ":");
      !i || !a || fo.has(i) && t.set(i, a);
    }
    return t;
  }, Ct = (e, t) => p(e, "property", "books:release_date") ?? p(e, "name", "citation_online_date") ?? t.get(
    "First published"
    /* FirstPublished */
  ) ?? void 0, tr = (e, t) => p(e, "name", "dc.identifier") ?? p(e, "name", "citation_doi") ?? p(e, "name", "publication_doi") ?? t.get(
    "DOI"
    /* Doi */
  ) ?? void 0, Ts = (e, t) => {
    const r = new Set(
      [
        p(e, "property", "books:isbn"),
        t.get(
          "Print ISBN"
          /* PrintIsbn */
        ),
    ...
    return r.size > 0 ? [...r].join(",") : void 0;
  }, yo = (e) => {
    let t, r;
    const s = e.querySelector(
      ".cover-image__details div:first-of-type"
    );
    if (s && s.childNodes.length === 2) {
      const [n, i] = s.childNodes;
      n.textContent && (t = Ft(n.textContent)), i.textContent && (r = Ft(i.textContent));
    }
    return { volume: t, issue: r };
  }, vo = (e) => {
    const t = wt(e), r = Rt(e), s = p(e, "property", "og:title"), n = Ct(e, t), i = tr(e, t), a = Ts(e, t), o = go(e);
    return F(I.Book, {
      au: r,
      date: n,
      doi: i,
    ...
    const t = wt(e), r = Rt(e), s = p(e, "name", "citation_book_title"), n = Ct(e, t), i = tr(e, t), a = Ts(e, t), o = p(e, "name", "citation_publisher"), l = p(e, "property", "og:title");
    return F(I.Bookitem, {
      au: r,
      btitle: s,
      date: n,
    ...
    const t = wt(e), r = Rt(e), s = Ct(e, t), n = t.get(
      "Online ISSN"
      /* OnlineIssn */
    ), i = t.get(
      "Print ISSN"
      /* PrintIssn */
    ), a = p(e, "property", "og:title"), { volume: o, issue: l } = yo(e);
    return U(I.Journal, {
      au: r,
      date: s,
      eissn: n,
    ...
    const t = wt(e), r = Rt(e), s = Ct(e, t), n = tr(e, t), i = p(e, "name", "citation_issn"), a = p(e, "name", "citation_journal_title"), o = p(e, "property", "og:title");
    return U(I.Article, {
      au: r,
      date: s,
      doi: n,
    ...
    const t = ne(e, "name", "citation_author");
    return t.length > 0 ? t : void 0;
  }, $o = ({ document: e }) => {
    const t = xo(e), r = p(e, "name", "citation_publication_date"), s = p(e, "name", "citation_doi"), n = p(e, "name", "citation_isbn"), i = p(e, "name", "citation_publisher"), a = p(e, "name", "citation_title") ?? e.title, o = Ce({
      au: t,
      date: r,
      doi: s,
      isbn: n,
    ...
    document: e
  }) => Array.from(e.querySelectorAll(".Z3988")).length <= 1 ? M() : Oi(), Ro = (e) => {
    var r;
    const t = (r = e.querySelector(
      ".content-meta-data__authors"
    )) == null ? void 0 : r.textContent;
    if (t)
      return t.split(/,\s+|\s+and\s+/).filter((s) => !!s);
  }, wo = (e) => {
    const t = Array.from(
      e.querySelectorAll(
        '.item-authors [data-qa="item-contributors"], .item-authors [data-qa="item-creators"]'
      )
    ).map((r) => r.textContent).filter((r) => !!r);
    return t.length ? t : void 0;
  }, Co = (e) => {
    const t = Array.from(
      e.querySelectorAll(".contrib-type-author .name")
    ).map((r) => r.textContent).filter((r) => !!r);
    return t.length ? t : void 0;
  }, ke = (e) => {
    ...
    var r, s;
    return ((r = e.querySelector('[data-qa="published-date"]')) == null ? void 0 : r.textContent) ?? ((s = e.querySelector(".summary-image")) == null ? void 0 : s.textContent) ?? We(t == null ? void 0 : t.get("date")) ?? We(t == null ? void 0 : t.get("copyright date")) ?? We(t == null ? void 0 : t.get("published date"));
  }, Ps = (e) => {
    const t = e.find((r) => r.startsWith("https://doi.org/"));
    if (t)
      return t.replace("https://doi.org/", "");
  }, Ls = (e) => {
    const t = e.get("local identifier");
    if (t != null && t.length)
      return Ps(t);
  }, We = (e) => {
    if (e != null && e.length)
    ...
    return Array.from(e.querySelectorAll(".metadata-element, .metadata")).map((r) => {
      var a;
      const s = r.querySelector(".metadata-label"), n = (a = s == null ? void 0 : s.textContent) == null ? void 0 : a.trim().toLowerCase(), i = Array.from(r.querySelectorAll(".metadata-value")).map((o) => o.textContent).filter((o) => !!o);
      return { name: n, values: i };
    }).forEach(({ name: r, values: s }) => {
      !r || !s.length || t.set(r, s);
    }), t;
  }, js = (e) => {
    var a, o, l, u, d;
    const t = Ne(e), r = e.querySelector(".summary-journal"), s = Array.from((r == null ? void 0 : r.childNodes) ?? []), n = ((a = s[0]) == null ? void 0 : a.textContent) ?? ((o = e.querySelector(".journal-link")) == null ? void 0 : o.textContent) ?? void 0;
    return {
      pub: ((u = (l = s[2]) == null ? void 0 : l.textContent) == null ? void 0 : u.replace(/Published By:\s+?/i, "")) ?? We(t.get("publisher")) ?? ((d = e.querySelector(".publisher-link")) == null ? void 0 : d.textContent) ?? void 0,
      jtitle: n
    };
  }, kt = (e) => {
    var t;
    return he((t = e.querySelector('[data-qa="page-count"]')) == null ? void 0 : t.textContent);
  }, lt = (e, t) => {
    var r;
    return ((r = e.querySelector(".publisher-link")) == null ? void 0 : r.textContent) ?? We(t == null ? void 0 : t.get("publisher"));
  }, xe = (e) => {
    var t, r, s, n, i, a, o, l;
    return ((r = (t = e.querySelector('[data-qa="item-title"]')) == null ? void 0 : t.textContent) == null ? void 0 : r.trim()) ?? ((n = (s = e.querySelector("mfe-turnaway-pharos-heading")) == null ? void 0 : s.textContent) == null ? void 0 : n.trim()) ?? ((a = (i = e.querySelector(".metadata mfe-toc-pharos-heading")) == null ? void 0 : i.textContent) == null ? void 0 : a.trim()) ?? ((l = (o = e.querySelector(".journal_header-title")) == null ? void 0 : o.textContent) == null ? void 0 : l.trim()) ?? void 0;
  }, rr = (e) => {
    if (!URL.canParse(e))
      return;
    const t = new URL(e);
    ...
    const t = e.querySelector(
      ".ccda-container > :first-child"
    );
    let r, s;
    if ((n = t == null ? void 0 : t.textContent) != null && n.includes("Volume") || (i = t == null ? void 0 : t.textContent) != null && i.includes("Issue")) {
      const a = t.textContent.trim().split(/,\s+/);
      for (const o of a)
        o.startsWith("Volume") ? s = he(o) : o.startsWith("Issue") && (r = he(o));
    }
    return { issue: r, volume: s };
  }, Io = (e) => {
    var d;
    const t = xe(e), r = ke(e), s = Ie(e), { jtitle: n, pub: i } = js(e), a = kt(e), { issue: o, volume: l } = ko(e), u = Ps(
      Array.from(
        ((d = e.querySelector(".content-meta-data-stables")) == null ? void 0 : d.childNodes) ?? []
      ).map((h) => h.textContent ?? "")
    );
    return U(I.Article, {
      atitle: t,
    ...
    const r = Ne(e), s = ke(e), n = Ie(e, r), i = xe(e), a = lt(e, r), o = rr(t);
    return Ce({
      au: s,
      date: n,
      pub: a,
    ...
    const t = Ne(e), r = ke(e), s = xe(e), n = Ie(e), i = kt(e), a = lt(e, t), o = Ls(t);
    return F(I.Book, {
      au: r,
      date: n,
      doi: o,
    ...
    var d, h;
    const t = Ne(e), r = ke(e), s = xe(e), n = ((d = e.querySelector(".book-title-link")) == null ? void 0 : d.textContent) ?? void 0, i = Ie(e, t), a = Array.from(
      e.querySelectorAll('[data-qa="book"] > span')
    ).map((b) => b.textContent ?? ""), o = kt(e), l = ((h = a.find((b) => b.includes("pp."))) == null ? void 0 : h.match(/(\d+)-(\d+)/)) ?? void 0, u = lt(e, t);
    return F(I.Bookitem, {
      atitle: s,
      au: r,
      btitle: n,
      date: i,
      epage: l == null ? void 0 : l[2],
      pub: u,
      pages: o,
      spage: l == null ? void 0 : l[1]
    });
  }, Po = (e) => {
    const t = Ne(e), r = ke(e), s = xe(e), n = Ie(e), i = kt(e), a = lt(e, t), o = Ls(t);
    return F(I.Document, {
    ...
    const r = Ne(e), s = ke(e), n = Ie(e, r), i = xe(e), a = rr(t);
    return fi({
      au: s,
      date: n,
      title: i,
    ...
    var i, a, o, l;
    const { pub: t } = js(e), r = xe(e), s = ((a = (i = e.querySelector(".eissn")) == null ? void 0 : i.textContent) == null ? void 0 : a.replace(/EISSN\s+/, "").trim()) ?? void 0, n = ((l = (o = e.querySelector(".issn")) == null ? void 0 : o.textContent) == null ? void 0 : l.replace(/ISSN\s+/, "").trim()) ?? void 0;
    return U(I.Journal, {
      eissn: s,
      issn: n,
      jtitle: r,
  ...
  var X = /* @__PURE__ */ ((e) => (e.Article = "journal article", e.Audio = "audio", e.Book = "book", e.Chapter = "book chapter", e.Document = "document", e.Image = "image", e.Journal = "journal", e.ResearchReport = "research report", e.Serial = "serial", e.Video = "video", e))(X || {});
  const Vo = (e, t) => {
    const r = Ne(e), s = ke(e), n = Ie(e, r), i = xe(e), a = lt(e, r), o = rr(t);
    return Ce({
      au: s,
  ...
  }, Zo = (e) => Object.values(X).includes(e), qo = (e) => {
    var n, i, a, o;
    if (e.querySelector(".journal_header-title"))
      return X.Journal;
    if (e.querySelector(".journal-link"))
      return X.Article;
    const s = ((i = (n = e.querySelector(".content-type > span")) == null ? void 0 : n.textContent) == null ? void 0 : i.toLowerCase().trim()) ?? ((o = (a = e.querySelector(".content-meta-data-label")) == null ? void 0 : a.textContent) == null ? void 0 : o.toLowerCase().trim());
    return Zo(s) ? s : null;
  }, Bo = (e, t) => {
    switch (qo(e)) {
      case X.Article:
    ...
    if (e)
      return typeof e == "string" ? e : Array.isArray(e) ? e.length === 0 ? void 0 : ze(e[0].name) : ze(e.name);
  }, ht = (...e) => {
    const t = new Set(e.filter((r) => !!r));
    if (t.size !== 0)
      return [...t];
  }, Uo = (e) => {
    const t = Vs(e.mainEntity.creator);
    return t ? [t] : void 0;
  }, ut = ({
    lcn: e,
    title: t
    ...
    const r = ht(
      ...
      e != null && e.mainEntity.isbn ? Yt(e.mainEntity.isbn) : void 0,
      ...t.isbns ?? []
    ), i = ht(
      ...(e == null ? void 0 : e.mainEntity.issn) ?? [],
      ...t.issns ?? []
    ), [a, o] = ((l = e == null ? void 0 : e.mainEntity.pagination) == null ? void 0 : l.split("-")) ?? [];
    return {
      authors: r,
      date: t.date,
      doi: ze(t.dois),
      edition: (e == null ? void 0 : e.mainEntity.edition) ?? t.edition,
      epage: o,
      eissn: ze(s),
      lcn: t.lcn ?? (e == null ? void 0 : e.identifier.value),
      isbn: n == null ? void 0 : n.join(","),
      issn: ze(i),
      issue: e == null ? void 0 : e.mainEntity.issueNumber,
      jtitle: t.jtitle,
      publisher: t.publisher ?? Vs(e == null ? void 0 : e.mainEntity.publisher),
      spage: a,
      title: (e == null ? void 0 : e.name) ?? t.title,
      volume: e == null ? void 0 : e.mainEntity.volumeNumber
    };
  }, Jo = (e) => U(I.Article, {
    ...ut(e),
    au: e.authors,
    ...
    date: e.date,
    pub: e.publisher
  }), Yo = /([0-9]{4}-[0-9]{1,2}-[0-9]{1,2}|[0-9]{4}-[0-9]{1,2}|[0-9]{4})/, wr = /(E?ISBN|E?ISSN|DOI)\s*:\s*/g, sr = (e) => `*:has([title*="${e}" i]) + .item-details-element-container prm-highlight`, Ko = (e) => {
    if (!e)
      return;
    const t = Yo.exec(e);
    if (t)
    ...
    const t = Array.from(
      e.querySelectorAll(sr("Identifier"))
    ), r = {};
    return t.map((s) => s.textContent).filter((s) => !!s).forEach((s) => {
      const n = [];
      let i;
      for (; (i = wr.exec(s)) !== null; )
        n.push({
          id: i[1].toLowerCase(),
          index: i.index,
          start: wr.lastIndex
        });
      n.forEach(({ id: a, start: o }, l) => {
        var u;
        r[a] || (r[a] = []), r[a].push(s.substring(o, (u = n[l + 1]) == null ? void 0 : u.index));
      });
    }), r;
  }, ec = (e) => Array.from(e.querySelectorAll(sr("Author"))).filter(
    (t) => !!t.textContent && t.parentElement !== null && t.parentElement.getAttribute("aria-hidden") !== "true"
  ).map((t) => t.textContent.trim()), me = (e, t) => {
    var r, s;
    return (s = (r = e.querySelector(sr(t))) == null ? void 0 : r.textContent) == null ? void 0 : s.trim();
  }, tc = (e) => {
    const t = me(e, "Creation Date"), r = me(e, "Edition"), s = me(e, "Publication Date"), n = me(e, "Is Part Of"), i = me(e, "Publisher"), a = me(e, "Title"), o = me(e, "MMS ID") ?? me(e, "Record ID"), l = ec(e), u = Qo(e), [d] = (n == null ? void 0 : n.split(",")) ?? [], h = Ko(s ?? t), b = [...u.isbn ?? [], ...u.eisbn ?? []].map((v) => Yt(v)).filter((v) => !!v);
    return {
      authors: l,
      date: h,
      dois: u.doi,
  ...
  var Zs = /* @__PURE__ */ ((e) => (e.Article = "Article", e.Book = "Book", e.Periodical = "Periodical", e.Journal = "Journal", e.AudioCD = "Audio CD", e.CreativeWork = "CreativeWork", e.Movie = "Movie", e.Video = "Video", e))(Zs || {});
  const rc = (e) => Object.values(Zs).includes(e), sc = (e, t) => {
    var s;
    const r = (t == null ? void 0 : t.mainEntity["@type"]) ?? ((s = e.querySelector(".media-content-type")) == null ? void 0 : s.textContent) ?? void 0;
    if (rc(r))
      return r;
  }, nc = ({ document: e }) => {
    const t = Xo(e), r = tc(e), s = Do(t, r);
    switch (sc(e, t)) {
      case "Article":
        return T(Jo(s));
      case "Book":
    ...
    const t = e.querySelectorAll('[id="Info"] > p'), r = Array.from(t).find((i) => {
      var a;
      return (a = i.textContent) == null ? void 0 : a.includes("Document Type");
    }), s = r == null ? void 0 : r.textContent, n = p(e, "name", "DC.identifier");
    return n != null && n.startsWith("info:doi/") || s != null && s.includes("Article") ? w.Article : n != null && n.startsWith("urn:issn:") ? w.Journal : void 0;
  }, ac = (e) => {
    const t = p(
      e,
      "name",
      "DCTERMS.bibliographicCitation"
    ), [r, s, n, i] = (t == null ? void 0 : t.split(",")) ?? [];
    return {
      journalTitle: r,
      volume: s,
      issue: n,
    ...
    const t = p(e, "name", "DC.identifier"), r = t ? t.split("info:doi/") : null;
    return (r == null ? void 0 : r[1]) ?? void 0;
  }, cc = (e) => e.evaluate(
    '//*[@id="altLayoutPublisherLogo"]/p/a[1]',
    e,
    null,
    XPathResult.STRING_TYPE,
    null
  ).stringValue, lc = (e) => {
    const [t, r] = e ? e.trim().split("-") : [void 0, void 0], s = r == null ? void 0 : r.replace(/\(\d+\)/, "").trim();
    return {
      spage: t,
      epage: s
    };
  }, uc = (e) => {
    const t = p(e, "name", "DCTERMS.issued");
    if (!t)
      return;
    const s = /\d{4}/.exec(t);
    return s ? s[0] : void 0;
    ...
    var v, $, K;
    const t = p(e, "name", "DC.title"), r = p(e, "name", "DC.publisher"), s = uc(e), n = ac(e), i = (v = n.journalTitle) == null ? void 0 : v.trim(), a = ($ = n.volume) == null ? void 0 : $.trim(), o = (K = n.issue) == null ? void 0 : K.trim(), l = n.pages ? lc(n.pages) : void 0, u = l == null ? void 0 : l.spage, d = l == null ? void 0 : l.epage, h = ne(e, "name", "DC.creator"), b = oc(e);
    return U(I.Article, {
      au: h,
      jtitle: i,
      date: s,
    ...
    const t = p(e, "name", "DC.title"), r = p(e, "name", "DC.publisher"), s = cc(e);
    return U(I.Journal, {
      issn: s,
      title: t,
      pub: r
  ...
  }, fc = /^\d{4}-\d{3}[\dX]$/i, mc = (e) => fc.test(e), gc = (e) => {
    const t = e.filter(mc);
    return t.length ? t : void 0;
  }, nr = (e) => {
    const t = ne(e, "name", "citation_author");
    ...
    const t = p(e, "name", "citation_publication_date"), r = t == null ? void 0 : t.match(/^\d{4}/);
    return r == null ? void 0 : r[0];
  }, yc = (e) => p(e, "name", "citation_doi"), qs = (e) => {
    const t = ne(e, "name", "citation_isbn");
    return t.length ? t.join(",") : void 0;
  }, Bs = (e) => gc(ne(e, "name", "citation_issn")), ar = (e) => p(e, "name", "citation_journal_title"), or = (e) => p(e, "name", "citation_publisher"), It = (e) => p(e, "name", "citation_title"), vc = (e) => p(e, "name", "citation_doi"), cr = (e) => p(e, "name", "citation_firstpage"), lr = (e) => p(e, "name", "citation_lastpage"), _c = (e) => p(e, "name", "citation_issue"), bc = (e) => p(e, "name", "citation_volume"), Ec = (e) => {
    var t;
    return U(I.Article, {
      atitle: It(e),
      au: nr(e),
    ...
    spage: cr(e),
    epage: lr(e)
  }), Ms = (e) => !!e.isbn, $c = (e) => !!e.issn || e.type === "Article" && !!e.journalTitle || !Ms(e) && !!e.journalTitle, Ac = (e) => !!e.title, Rc = (e) => {
    const t = {
      type: vc(e),
      isbn: qs(e),
      issn: Bs(e),
    ...
    return Ms(t) ? Sc(e) : $c(t) ? Ec(e) : Ac(t) ? xc(e) : null;
  }, wc = ({ document: e }) => {
    const t = Rc(e);
    return t ? T(t) : M();
  }, Cc = c.object({
  ...
  }), kc = (e) => Cc.safeParse(e).success, Ic = (e) => {
    const t = e.textContent;
    if (!t)
      return null;
    try {
    ...
    if (!r)
      return M();
    const s = r.mainEntity.type, n = (u = r.mainEntity.author) == null ? void 0 : u.map((b) => b.name), i = (d = r.datePublished) == null ? void 0 : d.substring(0, 4), a = r.mainEntity.name, o = r.mainEntity.isbn, l = (h = r.mainEntity.publisher) == null ? void 0 : h.name;
    switch (s) {
      case "Book":
        return T(
          F(I.Book, {
    ...
    const t = Array.from(e.querySelectorAll("a[rel=author]")).map((r) => {
      var s;
      return ((s = r.textContent) == null ? void 0 : s.trim()) ?? "";
    }).filter(Boolean);
    return t.length ? t : void 0;
    ...
    var r;
    const t = Array.from(e.querySelectorAll("strong")).filter((s) => {
      var n;
      return (n = s.textContent) == null ? void 0 : n.startsWith("ISBN");
    }).map((s) => {
      var n, i;
      return (i = (n = s.nextElementSibling) == null ? void 0 : n.textContent) == null ? void 0 : i.trim();
    });
    if (t.length !== 0)
      return (r = t[0]) == null ? void 0 : r.replace(/\s+/, ",");
  }, Pc = ({ url: e, document: t }) => {
    var o, l;
    const r = ((l = (o = t.querySelector("h3.page-title")) == null ? void 0 : o.textContent) == null ? void 0 : l.trim()) ?? void 0, s = Oc(t), n = p(t, "property", "article:published_time"), i = Tc(t), a = F(I.Book, {
      au: s,
      date: n == null ? void 0 : n.substring(0, 4),
      isbn: i,
      pub: "Milne Open Textbooks",
      title: r,
      uri: e
    });
    return T(a);
  }, Lc = (e) => {
    switch (p(e, "property", "og:type")) {
      case "Article":
        return "Article";
      case "Journal":
        return "Journal";
  ...
  function jc(e) {
    const t = p(e, "property", "og:title"), r = p(e, "name", "dc.Publisher"), s = p(e, "name", "publication_doi");
    return T(
      U(I.Journal, {
        jtitle: t,
        pub: r,
  ...
  function Vc(e) {
    var o;
    const t = p(e, "name", "dc.Title"), r = ne(e, "name", "dc.Creator"), s = (o = p(e, "name", "dc.Date")) == null ? void 0 : o.substring(0, 4), n = p(e, "name", "publication_doi"), i = p(e, "name", "citation_journal_title"), a = p(e, "name", "dc.Publisher");
    return T(
      U(I.Article, {
        atitle: t,
        au: r,
  ...
  const Cr = {
    ...
    Milne: Pc,
    AhaJournals: Zc
  }, qc = "5.14.0", Us = () => qc, Bc = ["com.au", "com", "ca", "co.uk", "de", "fr", "nl"], Mc = Bc.flatMap((e) => [
    `amazon.${e}`,
    `www.amazon.${e}`
  ]);
  ({
  ...
  const Ds = c.object({
    ...
    version: c.string()
  }), Dc = (e) => Object.values(Z).includes(e), Jc = (e) => typeof e == "object" && e !== null;
  c.object({
    url: c.string(),
  ...
  const Zd = (e, t) => qd(t) ? t.hostnames.includes(new URL(e).hostname) : Bd(t) ? !!e.match(t.regexp) : false, qd = (e) => Ds.safeParse(e).success, Bd = (e) => Js.safeParse(e).success, Md = (e, t) => t ? Vd.satisfies(e, t) : true, Ud = (e, t, r) => Md(
    t,
    r.libraryVersionRange
  ) && Zd(e, r.matcher), Dd = (e, t) => e.siteRegistrations.filter(
    (r) => Ud(t, Us(), r)
  ), Jd = (e, t) => Dd(e, t).flatMap(
    ({ parsers: n, name: i }) => n.filter(
      (a) => Dc(a) && a in Cr
    ).map((a) => ({ parser: Cr[a], parserType: a, name: i }))
  ), Wd = (e, t) => {
    const r = Jd(e, t.url);
    for (const { parser: s, parserType: n, name: i } of r) {
      const a = s(t);
      if (Cs(a) || Ma(a))
        return {
          ...a,
    ...
    switch (t) {
      case we.CA:
        return new URL(`https://${e}.rl.ca.talis.com`);
      default:
        return new URL(`https://${e}.rl.talis.com`);
    }
  }, bh = (e, t) => {
    const r = zd(e, t);
    return new URL("/ui/forms/bookmarklet.html", r);
  }, Eh = (e, t, r) => {
    const s = Ei(t);
    s.append("fast", "true"), s.append("breakout", "true"), r && s.append("referrer", r.referrer);
    const n = new URL(e.toString());
    return n.search = s.toString(), n;
  };
  var util;
  (function(util2) {
  ...
  pageParser;
  const bookmarkLinkClass = "talis-z3988-link";
  const extractZ3988Url = (title, tenant) => {
    const baseUrl = bh(tenant.id, tenant.region);
    const openUrlResource = Si(title);
    const bookmarkingUrl = Eh(
      baseUrl,
      openUrlResource ?? {},
      {
        parserName: null,
    ...
    return appendTrackingParams(
      bookmarkingUrl.toString(),
      ParserMechanism.SearchResultsZ3988
    );
  };
  const removePreviousZ3988Links = (document2) => {
    document2.querySelectorAll(`.${bookmarkLinkClass}`).forEach((element) => {
      element.remove();
    });
  };
  const getZ3988Elements = (document2, tenant) => {
    const elements = document2.querySelectorAll(".Z3988");
    const output = [];
    for (const element of elements) {
      ...
      if (title) {
        output.push({
          element,
          bookmarkingUrl: extractZ3988Url(title, tenant)
        });
      }
    }
    return output;
  };
  const createBookmarkingLink = (bookmarkingUrl) => {
    const link = document.createElement("a");
    link.classList.add(bookmarkLinkClass);
    link.textContent = "Add to Reading Lists";
    link.setAttribute("href", bookmarkingUrl);
    return link;
  };
  const appendBookmarkingLinks = (bookmarkedElements) => {
    for (const { bookmarkingUrl, element } of bookmarkedElements) {
      const link = createBookmarkingLink(bookmarkingUrl);
      element.insertAdjacentElement("afterend", link);
    }
  };
  const performLibraryParsing = (registry) => {
    try {
      return _h(registry, {
  ...
  const extractDocumentHtml = (document2) => new XMLSerializer().serializeToString(document2);
  const processPageParsingRequest = ({
    registry,
    tenant
  }) => {
    removePreviousZ3988Links(document);
    const result2 = performLibraryParsing(registry);
    if (Ma(result2)) {
      appendBookmarkingLinks(getZ3988Elements(document, tenant));
      return Promise.resolve(result2);
    }
    if (!ph(result2)) {
      return Promise.resolve(result2);
    ...
    return Promise.resolve({
      url: window.location.href,
      html: extractDocumentHtml(document)
    });
  };
  pageParser;
  const definition = defineUnlistedScript({
    main() {
      addMessageListener(
        BrowserMessageType.PageParsingRequest,
        processPageParsingRequest
      );
    }
  });
  pageParser;
  ...
  const result = (async () => {
    try {
      ...
      logger.error(
        `The unlisted script "${"page-parser"}" crashed on startup!`,
        err
      );
      throw err;
    }
