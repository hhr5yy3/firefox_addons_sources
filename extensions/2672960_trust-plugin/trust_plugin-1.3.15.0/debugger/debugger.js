...
const testXmlSignature = new FileInfo(Base64.encode(String.raw `<?xml version="1.0" encoding="utf-8" standalone="no" ?><elementOne>
          Text1
          <element2>
               Text2
               <element3>
...
const testXmlTransform = new FileInfo(String.raw `<?xml version="1.0" encoding="UTF-8"?>
<!--
 &amp; not replaces
 &lt; not replaces
 &gt; not replaces
...
const testXmlDetachedSignature = new FileInfo(String.raw `<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns="urn://x-artefacts-smev-gov-ru/services/message-exchange/types/1.1" xmlns:ns1="urn://x-artefacts-smev-gov-ru/services/message-exchange/types/basic/1.1">
   <soapenv:Header/>
   <soapenv:Body>
      <ns:AckRequest>
...
const test1KbContent = new FileInfo("", "", "");
const testContent = new FileInfo( Base64.encode("unsigned file content"), "", "base64", "id1", "test.txt");
...
function getModulesConfiguration() {
     ...
     let message = new Message(_id, "system", "config", "");
...
$(document).ready(function () {
     ...
     */
     bind("system_handshake", "click", function () {
          clearSystemLog();
          system.handshake( systemCallBack );
     });
     bind("system_echo", "click", function () {
          clearSystemLog();
          system.echo( "test", systemCallBack );
     });
     bind("system_cache", "click", function () {
          clearSystemLog();
          system.cache( "false", systemCallBack );
     });
     bind("system_lastError", "click", function () {
          clearSystemLog();
          system.lastError( systemCallBack );
     });
     bind("system_config", "click", function () {
          clearSystemLog();
          system.config( systemCallBack );
     });
     bind("system_ipConfig", "click", function () {
          clearSystemLog();
          system.ipConfig(systemCallBack);
     });
     bind("system_close", "click", function () {
          clearSystemLog();
          system.close( systemCallBack );
     });
     bind("system_protocol", "click", function () {
          clearSystemLog();
          system.protocol( systemCallBack );
     });
     ...
     */
     bind("crypto_providers", "click", function () {
          ...
          crypto.providers(request, cryptoCallBack);
     });
     ...
     bind("crypto_certificatesAll", "click", function () {
          ...
          crypto.certificates(request, cryptoCallBack);
     });
     ...
     bind("crypto_tokensAll", "click", function () {
          ...
          crypto.tokens(request, cryptoCallBack);
     });
     ...
     bind("crypto_certificateFieldsAll", "click", function () {
          ...
          crypto.certificateFields(request, cryptoCallBack);
     });
     ...
     bind("crypto_addCertificateWithoutContainer", "click", function () {
          ...
          crypto.addCertificate(request, cryptoCallBack);
     });
     ...
     bind("crypto_deleteCertificate", "click", function () {
          ...
          crypto.deleteCertificate(request, cryptoCallBack);
     });
     ...
     bind("crypto_certificateRequestPcCsp", "click", function () {
          ...
          crypto.certificateRequest(request, cryptoCallBack);
     });
     ...
     bind("crypto_attachedSignature", "click", function () {
          ...
          crypto.signature(request, cryptoCallBack);
     });
     ...
     bind("crypto_nonVisualizationSignatureWithoutCertificateWithCertificateResponse", "click", function () {
          ...
          crypto.signatureV2(request, cryptoCallBack);
     });
     ...
     bind("crypto_visualizationSignatureFilesSignParams", "click", function () {
          ...
          request.certificate = systemCertificate;
          request.files = [ 
            new FileInfo( "", "d:/3.txt", "", "id3"),
            new FileInfo( "", "d:/2.txt", "", "id2"),
            new FileInfo( "", "d:/1.txt", "", "id1"),
          ];
     ...
     bind("crypto_signatureFromUrl", "click", function () {
          ...
          request.certificate = systemCertificate;
          request.files = [ 
               new FileInfo( "", "https://plugin-demo.iitrust.ru/static/system.js", "url", "id1"),
               new FileInfo( "", "https://plugin-demo.iitrust.ru/static/crypto.js", "url", "id2"),
               new FileInfo( "", "https://plugin-demo.iitrust.ru/static/1.txt",     "url", "id3"),
          ];
     ...
     bind("crypto_signatureWithMix", "click", function () {
          ...
          selectFile.onchange = (event) => {
               ...
               if (files.length > 0) {
                    ...
                    request.certificate = systemCertificate;
                    request.files = [
                         new FileInfo( "", "https://plugin-demo.iitrust.ru/static/system.js", "url", "id2"),
                         file,
                    ];
     ...
     bind("crypto_signatureChunkedFile", "click", function () {
          ...
          request.files = [ new FileInfo("", "", "base64", "id1", "name1.txt") ];
          ...
          for (let i = 0; i < chunks.length; i++) {
              ...
              crypto.signatureV2({ ...request, meta: meta}, cryptoCallBack);
          }
     });
     ...
     bind("crypto_setChunkSize", "click", function () {
          clearCryptoLog();
          let chunkSize = crypto.chunkSize() << 1;
     ...
     bind("crypto_xmlNormalize", "click", function () {
          ...
          crypto.normalize(request, cryptoCallBack);
     });
     bind("crypto_hashGostR3411_256", "click", function () {
          ...
          crypto.hash(request, cryptoCallBack);
     });
     ...
     */
     bind("content_disconnect", "click", function () {
          clearContentLog();
          let message = new Message(_id, "system", "disconnect", "");
          window.postMessage(message, '*');
     });
     bind("content_post", "click", function () {
          ...
          let message = new Message(_id, module, method, data);
     ...
     */
     ...
     window.postMessage(new Message(_id, "system", "handshake", "", "", _ping), '*');
});
