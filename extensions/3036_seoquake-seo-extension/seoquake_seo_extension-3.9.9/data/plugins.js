...
},{"../common/Lib":7,"../common/analytics/clientMixin":8,"../common/utils/entities":150,"./ClientMessages":2,"./DeathQueue":3,"./clientTranslate":4}],2:[function(require,module,exports){
'use strict';
...
var Google2Plugin = function (_BaseSERPPlugin) {
  ...
  _createClass(Google2Plugin, [{
    ...
    value: function getResultElements() {
      var selector = '#res div.rc div.s,' + '#res li.g > div.rc div.s,' + '#res li.g > div.vsc div.s,' + '#res div.g div.yuRUbf,' + '#botstuff div.g div.yuRUbf,' + '#ires div.g > div.rc div.s,' + '#ires div.g > div > div.rc div.s,' + '#ires div.g > div > div > div.rc div.s,' + '#ires li.g div.rc div.s';
  ...
  _createClass(SERPControlPanel, [{
    ...
    value: function createControlBlock() {
      ...
      this._panelSort.init().then(function () {
        ...
        _this._panelSort.showAS = _this._plugin.pluginConfiguration.show_semrush_panel;
...
var SortPanel = function () {
  ...
  _createClass(SortPanel, [{
    ...
    value: function recreateSortList() {
      ...
      if (this._showAS) {
        this._selectField.appendChild(dom('option', { value: 'AS' }, 'AS'));
      }
...
var SEMrushParametersPanel = function () {
  ...
  _createClass(SEMrushParametersPanel, [{
    ...
    value: function init() {
      ...
      this._asBar = new ProgressBar(50, 100, { title: 'AS:', showPercent: true });
