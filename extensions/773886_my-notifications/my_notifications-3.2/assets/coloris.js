    ...
    for (var key in options) {
      switch (key) {
        ...
        case 'clearButton':
          ...
          if (typeof options.clearButton === 'object') {
            if (options.clearButton.label) {
              ...
              clearButton.innerText = settings.clearLabel;
            }
        ...
        case 'closeLabel':
          ...
          closeButton.innerText = settings.closeLabel;
          break;
        case 'a11y':
          ...
          if (update) {
            ...
            openLabel.innerText = settings.a11y.open;
            swatchLabel.innerText = settings.a11y.swatch;
