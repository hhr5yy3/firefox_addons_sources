...
`;
  ...
  const _PanelStubOptions = class _PanelStubOptions {
  };
  _PanelStubOptions.MatchedLogins = {
  ...
  _PanelStubOptions.GeneratePasswordLegacy = {
  ...
  _PanelStubOptions.GeneratePassword = {
    id: "KeeAddonPanelGeneratePassword",
    height: 500,
    width: 450,
  ...
  let PanelStubOptions = _PanelStubOptions;
  class PanelStub {
  ...
  class FormSaving {
    //TODO:5: May be overkill to have all this data available for saving
  ...
  if (document.body) {
    ...
    window.addEventListener("pagehide", () => {
      ...
      formFilling == null ? void 0 : formFilling.removeKeeIconFromAllFields();
      Port.shutdown();
      connected = false;
      frameId = void 0;
      formUtils = void 0;
