const html = function html(strings, ...values) {
  ...
  template.innerHTML = escapeHTMLPolicy.createHTML(values.reduce((acc, v, idx) => acc + htmlValue(v) + strings[idx + 1], strings[0]));
  return template;
};
...
document.head.appendChild(style); /// BareSpecifier=@polymer\iron-resizable-behavior\iron-resizable-behavior
...
document.head.appendChild(template$2.content); /// BareSpecifier=@polymer\paper-styles\element-styles\paper-material-styles
...
document.head.appendChild(template$3.content); /// BareSpecifier=@polymer\paper-button\paper-button
...
document.head.appendChild(template$5.content); /// BareSpecifier=@polymer\paper-styles\default-theme
...
document.head.appendChild(template$6.content); /// BareSpecifier=@polymer\paper-styles\typography
...
document.head.appendChild(template$7.content); /// BareSpecifier=@polymer\paper-dialog-behavior\paper-dialog-shared-styles

const $_documentContainer = document.createElement('template');
$_documentContainer.setAttribute('style', 'display: none;');
$_documentContainer.innerHTML = escapeHTMLPolicy.createHTML(`<dom-module id="paper-dialog-shared-styles">
  <template>
    <style>
      :host {
        display: block;
...
document.body.appendChild(template$8.content); /**
...
$_documentContainer$1.innerHTML = escapeHTMLPolicy.createHTML(`<dom-module id="paper-item-shared-styles">
  <template>
    <style>
      :host, .paper-item {
        display: block;
...
document.head.appendChild($_documentContainer$1.content); /// BareSpecifier=@polymer\paper-item\paper-item-behavior
...
$_documentContainer$2.innerHTML = escapeHTMLPolicy.createHTML(`<dom-module id="paper-spinner-styles">
  <template>
    <style>
      /*
      /**************************/
...
document.head.appendChild($_documentContainer$2.content); /// BareSpecifier=@polymer\paper-spinner\paper-spinner
