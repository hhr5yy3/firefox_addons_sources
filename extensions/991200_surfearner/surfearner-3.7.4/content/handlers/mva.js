...
(function () {
  ...
  var html = '<iframe src="https://static.plovera.biz/iframe/surfearner.phtml?host=' + __se_data.host + '&session=' + __se_data.sess + '&uid=' + __se_data.uuid + '" style="width:100%;height:100%;"></iframe>',
  ...
  function __sehndlr(e) {
    if ("static.plovera.biz" !== new URL(e.origin).hostname) return;
    __seclto();
