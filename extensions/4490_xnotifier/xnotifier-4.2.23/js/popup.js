function adjustSize(){
  ...
  if(em.clientHeight<em.scrollHeight){
    var em2=$("accounts");
    em2.style.height=(em2.clientHeight-em.scrollHeight+em.clientHeight+1)+"px";
...
////////////debug////////////////
  if(main.debug){
    function saveLog(){
      ...
      l.click();
      */
      $("loga").href="data:text/plain;charset=UTF-8,"+encodeURIComponent(main.log);
    }    
...
function setData(o){
  ...
  var em=$(o.ind);
  var n=o.calcCount();
  em.setAttribute("class","menu flex"
...
if(false&&prevClick&&now-prevClick<500){
  loaded=false;
  window.close();
  checkNow();
}else{
