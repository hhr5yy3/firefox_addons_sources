(() => {
  var __webpack_modules__ = {
    ...
    8322: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.d(__webpack_exports__, {
        y: () => _protocols_js__WEBPACK_IMPORTED_MODULE_0__.y
      });
      var _protocols_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1731);
    },
    1731: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.d(__webpack_exports__, {
        y: () => PROTOCOLS
      });
    ...
    8539: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        RI: () => _Language_js__WEBPACK_IMPORTED_MODULE_1__.RI,
    ...
    8107: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.d(__webpack_exports__, {
        A: () => GitHubMetadata
      });
      var _models_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8539);
      class GitHubMetadata extends _models_index_js__WEBPACK_IMPORTED_MODULE_0__.ki {
        constructor(rawMetadata) {
          super(rawMetadata);
        }
        get user() {
    ...
    9206: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.d(__webpack_exports__, {
        A: () => toolboxify
      });
      var _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(555);
      ...
      async function toolboxify(isEnterprise = false) {
        const metadata = (0, _utils_index_js__WEBPACK_IMPORTED_MODULE_0__.UQ)(isEnterprise);
    ...
    6510: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.d(__webpack_exports__, {
        U: () => fetchMetadata
      });
      var github_url_to_object__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1142);
      var _GitHubMetadata_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8107);
      const fetchMetadata = (isEnterprise = false) => {
        const rawMetadata = github_url_to_object__WEBPACK_IMPORTED_MODULE_0__(window.location.toString(), {
          enterprise: isEnterprise
        });
        return rawMetadata ? new _GitHubMetadata_js__WEBPACK_IMPORTED_MODULE_1__.A(rawMetadata) : null;
      };
    },
    5608: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.d(__webpack_exports__, {
        W: () => fetchTools
      });
      ...
      const fetchLanguages = async metadata => {
        try {
          ...
          if (validateHttpResponse(response)) {
            ...
            return Object.entries(languagesObject).map((([name, bytes]) => new _models_index_js__WEBPACK_IMPORTED_MODULE_0__.TM(name, bytes / totalBytes * _models_index_js__WEBPACK_IMPORTED_MODULE_0__.RI)));
          } else return extractLanguagesFromPage(metadata);
        } catch (error) {
          return extractLanguagesFromPage(metadata);
        }
      };
      const validateHttpResponse = response => response.status >= MIN_VALID_HTTP_STATUS && response.status <= MAX_VALID_HTTP_STATUS;
      ...
      const extractLanguagesFromPage = async metadata => {
        const defaultLanguages = [ _models_index_js__WEBPACK_IMPORTED_MODULE_0__.TM.Default ];
        try {
          ...
          if (languageElements.length === 0) {
            ...
            if (newLanguageElements.length > 0) {
              const allLanguages = Array.from(newLanguageElements).map((el => {
                ...
                return new _models_index_js__WEBPACK_IMPORTED_MODULE_0__.TM(langEl.textContent.trim(), percentEl ? parseFloat(percentEl.textContent.trim()) : _models_index_js__WEBPACK_IMPORTED_MODULE_0__.RI);
              }));
            ...
            const allLanguages = Array.from(languageElements).map((el => {
              ...
              return new _models_index_js__WEBPACK_IMPORTED_MODULE_0__.TM(el.textContent.trim(), percentEl ? parseFloat(percentEl.textContent.trim()) : _models_index_js__WEBPACK_IMPORTED_MODULE_0__.RI);
            }));
            return allLanguages.length > 0 ? allLanguages : defaultLanguages;
          }
        } catch (error) {
    ...
    555: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.d(__webpack_exports__, {
      ...
      var _fetchMetadata_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6510);
      var _fetchTools_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5608);
      var _observeBlobPage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8347);
      var _observeIndexPage_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8504);
    },
    8347: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.d(__webpack_exports__, {
        $: () => observeBlobPage
      });
      ...
      const observeBlobPage = (metadata, tools) => {
        const openWithMenuObserver = new _services_index_js__WEBPACK_IMPORTED_MODULE_0__.Zo("#__primerPortalRoot__ ul[aria-label='Open with...']");
        ...
        const highlightedLineMenuObserver = new _services_index_js__WEBPACK_IMPORTED_MODULE_0__.Zo("#__primerPortalRoot__ ul[data-testid='highlighted-line-menu']");
      ...
      const createOpenMenuItems = (metadata, tools) => tools.map((tool => createOpenMenuItem(metadata, tool)));
      const createOpenMenuItem = (metadata, tool) => {
        ...
        menuItemLink.addEventListener("click", (event => {
          ...
          (0, _services_index_js__WEBPACK_IMPORTED_MODULE_0__.Yt)((0, _services_index_js__WEBPACK_IMPORTED_MODULE_0__.Wd)(tool.tag, repository, filePath));
        }));
      ...
      const createHighlightedLineMenuItems = (metadata, tools) => tools.map((tool => createHighlightedLineMenuItem(metadata, tool)));
      const createHighlightedLineMenuItem = (metadata, tool) => {
        ...
        menuItemLink.addEventListener("click", (event => {
          ...
          const normalizedBranch = branch.split("/").shift();
          const filePath = location.pathname.replace(`/${user}/${repository}/blob/${normalizedBranch}/`, "");
          const lineNumber = (0, _utils_index_js__WEBPACK_IMPORTED_MODULE_1__.P8)(location.hash.replace("#L", ""));
          (0, _services_index_js__WEBPACK_IMPORTED_MODULE_0__.Yt)((0, _services_index_js__WEBPACK_IMPORTED_MODULE_0__.Wd)(tool.tag, repository, filePath, lineNumber));
        }));
        menuItem.appendChild(menuItemLink);
        return menuItem;
      };
    ...
    8504: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      ...
      var _services_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2809);
      var _constants_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8322);
      const observeIndexPage = (metadata, tools) => {
        const domObserver = new _services_index_js__WEBPACK_IMPORTED_MODULE_0__.Zo("#clone-with-https, #clone-with-ssh");
        domObserver.start((input => {
          ...
          chrome.runtime.sendMessage({
            type: "save-protocol",
            protocol: isSsh ? _constants_index_js__WEBPACK_IMPORTED_MODULE_1__.y.SSH : _constants_index_js__WEBPACK_IMPORTED_MODULE_1__.y.HTTPS
          });
        }));
      };
      ...
      const createCloneMenuItem = (metadata, tool, isSsh) => {
        ...
        menuItem.addEventListener("click", (() => {
          ...
          const action = (0, _services_index_js__WEBPACK_IMPORTED_MODULE_0__.yI)(tool.tag, cloneUrl);
          (0, _services_index_js__WEBPACK_IMPORTED_MODULE_0__.Yt)(action);
        }));
        return menuItem;
      };
    },
    ...
    5017: (__webpack_module__, __unused_webpack___webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.a(__webpack_module__, (async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
        try {
          var _content_providers_github_toolboxify_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9206);
          try {
            await (0, _content_providers_github_toolboxify_js__WEBPACK_IMPORTED_MODULE_0__.A)(false);
