/*
 * Clients need not to call any function from this JS file. web_properties.js file has dependency calls in this js file.
 */
...
ProxyCollector.isTimedOut = function (d, e, f) {
  ...
  if (
    e - _timer.duration() <= 0 &&
    ((typeof ProxyCollector.internalPingTime === 'undefined' &&
      new RegExp('internalPingTime').test(d)) ||
      (typeof ProxyCollector.externalPingTime === 'undefined' &&
        new RegExp('externalPingTime').test(d)))
  ) {
    d.call(this, -1);
    f.abort();
  } else {
    if (
      ...
      setTimeout(function () {
        ProxyCollector.isTimedOut(
          d,
          e - (_timer.duration() + ProxyCollector.TIMEOUT_CHECK_FREQUENCY),
          f
        );
    ...
    try {
      m.onreadystatechange = function () {
        if (m.readyState == 4) {
          if (
            (typeof ProxyCollector.internalPingTime === 'undefined' &&
              new RegExp('internalPingTime').test(l)) ||
            (typeof ProxyCollector.externalPingTime === 'undefined' &&
              new RegExp('externalPingTime').test(l))
          ) {
            l.call(this, o.duration());
          }
        }
