(() => {
 var __webpack_modules__ = {
  3440: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   __webpack_require__.d(__webpack_exports__, {
    Fg: () => switchActivation,
    Ts: () => init,
    x$: () => setNetIDPanelPopup,
    yo: () => update
   });
   var _lib_storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(328), _lib_account_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7095), _lib_email_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8579), _webapp_start__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4561), _lib_login_common_start__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9445), _lib_util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4981);
   ...
   function onClick(tab) {
    var duration;
    0 !== _lib_account_list__WEBPACK_IMPORTED_MODULE_1__.j_().length ? (setTimeout((_ => setIcon("envelope")), duration || (0, 
    _lib_util__WEBPACK_IMPORTED_MODULE_5__.YA)(2.75)), chrome.browserAction.setIcon({
     path: "images/refresh-anim.svg"
    }), _webapp_start__WEBPACK_IMPORTED_MODULE_3__.ag()) : (0, _lib_login_common_start__WEBPACK_IMPORTED_MODULE_4__.s)();
   }
   function switchActivation(preview = !0) {
    mode = preview ? MODE_PREVIEW : MODE_CLICK_ONCE;
   }
   function init(animate = !1) {
    update({
     summary: {
      accountCount: 0,
      isLoggedIn: 0,
    ...
    switchActivation((_lib_storage__WEBPACK_IMPORTED_MODULE_0__.fF.smembers("general") || []).indexOf("email_preview") > -1), 
    animate && function(source) {
     let canvas = document.createElement("canvas");
     canvas.id = "ba-original", canvas.width = canvas.height = 64, document.body.appendChild(canvas);
     let ctx = canvas.getContext("2d"), count = 25;
     const angle = 15 * Math.PI / 180, delay = (0, _lib_util__WEBPACK_IMPORTED_MODULE_5__.YA)(1) / 25, rotate = () => {
      count <= 0 ? setIcon("envelope") : (--count, ctx.clearRect(0, 0, canvas.width, canvas.height), 
      ctx.translate(canvas.width / 2, canvas.height / 2), ctx.rotate(angle), ctx.translate(-canvas.width / 2, -canvas.height / 2), 
      ctx.drawImage(img, 0, 0, canvas.width, canvas.height), chrome.browserAction.setIcon({
       imageData: ctx.getImageData(0, 0, canvas.width, canvas.height)
      }), setTimeout(rotate, delay));
     };
     let img = new Image;
     img.onload = _ => {
      ctx.drawImage(img, 0, 0, canvas.width, canvas.height), rotate();
     }, img.src = source;
    }("images/envelope-38.png");
   }
  },
  8855: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   var _lib_account_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7095), _browser_action__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3440), _lib_mail_providers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6181), _lib_notifications__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2069), _vapi_choose_gmail_account__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3514), _lib_observer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1807), _lib_util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4981);
   function onAccountAdded(acc) {
    return _lib_account_list__WEBPACK_IMPORTED_MODULE_0__.TW(), _lib_mail_providers__WEBPACK_IMPORTED_MODULE_2__.Q3(acc) && ((0, 
    _vapi_choose_gmail_account__WEBPACK_IMPORTED_MODULE_4__.X)(acc.emailAddress), onAccountLogin(acc)), 
    new Promise((resolve => {
     let msg = {
      id: "ui-account-added",
   ...
   function onAccountRemoved(acc) {
    _lib_account_list__WEBPACK_IMPORTED_MODULE_0__.TW(), refreshMailBadge();
   }
   ...
   function onMailCheckEvent(param) {
    param.expired || (param.account && (0, _lib_util__WEBPACK_IMPORTED_MODULE_6__.YI)("mail-check: " + param.account.emailAddress + ": " + param.account.newMailCount + " new mails"), 
    refreshMailBadge(), chrome.runtime.sendMessage({
     id: "ui-mail-panel-refresh"
    }, (_ => {
     chrome.runtime.lastError;
    })), param.notificationStyle && param.notificationStyle !== _lib_notifications__WEBPACK_IMPORTED_MODULE_3__.Bz.NONE && _lib_notifications__WEBPACK_IMPORTED_MODULE_3__.A0(param.account, param.notificationStyle));
   }
   function init() {
    (0, _lib_observer__WEBPACK_IMPORTED_MODULE_5__.SR)("mail-check", onMailCheckEvent);
   }
  },
  2184: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   var lodash_es__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4162), _lib_account_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7095), _lib_email_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8579), _lib_observer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1807), _lib_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4981);
   function onMailStatusRequest(request) {
    try {
     var as = _lib_account_list__WEBPACK_IMPORTED_MODULE_0__.Nx();
     request.successCallback(Object.assign({}, as, {
      statusAttr: _lib_email_common__WEBPACK_IMPORTED_MODULE_1__.Sk(as.summary),
      unreadText: _lib_email_common__WEBPACK_IMPORTED_MODULE_1__.pY(as.summary)
     }));
    } catch (e) {
     ddebug(e);
    }
   }
   var _checkNewMailsDebounced = lodash_es__WEBPACK_IMPORTED_MODULE_4__.A((function() {
   ...
   function checkNewMails() {
    _checkNewMailsDebounced();
   }
   function init() {
    (0, _lib_observer__WEBPACK_IMPORTED_MODULE_2__.SR)("mail-status-request", onMailStatusRequest), 
    (0, _lib_observer__WEBPACK_IMPORTED_MODULE_2__.SR)("fetch-mail-count", checkNewMails);
   }
  },
  ...
  5476: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   var lodash_es__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7734), _email_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8855), _lib_mail_providers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6181), _lib_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4981);
   function findOpenTab(email) {
    const entry = registry[email];
    return entry ? entry.tabId : null;
   }
   function findAndRegisterEmailOnPage(tabId, url) {
    let origin = new URL(url).origin;
    if (!_lib_mail_providers__WEBPACK_IMPORTED_MODULE_1__.BX[origin]) return void clearTab(tabId);
    chrome.tabs.executeScript(tabId, {
     code: 'var info = document.querySelector("#unitedinternet_toolbar[primary_mail_address][session_alive=true]"); info ? info.getAttribute("primary_mail_address") : null;'
    }, (emails => {
     chrome.runtime.lastError && (0, _lib_util__WEBPACK_IMPORTED_MODULE_2__.YI)(chrome.runtime.lastError.message), 
     emails && emails[0] && function(email, tabId) {
      email && (registry[email] = {
       tabId
      });
      (0, _lib_util__WEBPACK_IMPORTED_MODULE_2__.YI)("webmailer tabs=", JSON.stringify(registry));
     }(emails[0], tabId);
    }));
   }
   var registry = {};
   function clearTab(tabId) {
    let key = lodash_es__WEBPACK_IMPORTED_MODULE_3__.A(registry, [ "tabId", tabId ]);
    key && delete registry[key];
   }
   function onCreated(tabId) {
    (0, _email_events__WEBPACK_IMPORTED_MODULE_0__.o)();
   }
   function onUpdated(tabId, changeInfo, tab) {
    "complete" === changeInfo.status && tab.url && findAndRegisterEmailOnPage(tabId, tab.url);
   }
   function onClosed(tabId) {
    clearTab(tabId), (0, _lib_util__WEBPACK_IMPORTED_MODULE_2__.YI)("webmailer tabs=", JSON.stringify(registry));
   }
   function init() {
    chrome.tabs.onCreated.addListener(onCreated), chrome.tabs.onUpdated.addListener(onUpdated), 
  ...
  4561: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   "use strict";
   __webpack_require__.d(__webpack_exports__, {
    ag: () => gotoFirstAccountWebmail,
    g0: () => startUsecase,
    l3: () => gotoWebmail,
    uh: () => startWebapp
   });
   var _lib_account_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7095), _lib_mail_providers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6181), _lib_pacs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3516), _lib_loadpage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3806), _lib_observer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1807), _lib_util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4981), _lib_sanitize__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5666), _webapp_nav__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5476);
   function startWebapp(usecase, params = [], target) {
    try {
     (0, _lib_util__WEBPACK_IMPORTED_MODULE_5__.YI)("about to start usecase " + usecase + ", doing login"), 
     (0, _lib_observer__WEBPACK_IMPORTED_MODULE_4__.hb)("do-login", {
      needAccountType: 1,
      successCallback: account => {
       (0, _lib_util__WEBPACK_IMPORTED_MODULE_5__.YI)("got login, starting usecase " + usecase), 
       (0, _lib_observer__WEBPACK_IMPORTED_MODULE_4__.hb)("start-usecase", {
        account,
        usecase,
        params,
        target
   ...
   function gotoFirstAccountWebmail(usecase = "open_mail") {
    let acc = _lib_account_list__WEBPACK_IMPORTED_MODULE_0__.J8();
    acc ? gotoWebmail(acc, usecase) : console.error("--- nobody logged in");
   }
  ...
  7095: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   function Account(address, isNew) {
   ...
   }, Account.getDomainForEmailAddress = function(email) {
    var spl = email.split("@");
   ...
   function GmailAccount(email, isNew) {
    Account.call(this, email, isNew), this._super = Account.prototype, isNew || this._readFromPrefs();
   }
   ...
   }, (0, util.X$)(OutlookAccount, Account);
   ...
   function UnitedInternetLoginTokenLoginAccount(address, isNew) {
    Account.call(this, address, isNew), isNew || (this._readFromPrefs(), this._accessToken = this._getStoredLoginToken());
   }
   ...
   UnitedInternetLoginTokenLoginAccount.prototype = {
    ...
    _verifyAccountSettings: function() {
     ...
     Account.getDomainForEmailAddress(this.emailAddress), sanitize.a.boolean(this._wantStoredLogin);
    },
    _readFromPrefs: function() {
     let acc = storage.vd.get(this.emailAddress);
   ...
   }, (0, util.X$)(UnitedInternetLoginTokenLoginAccount, Account);
   var pacs = __webpack_require__(3516);
   function UnitedInternetOAuthLoginAccount(address, isNew) {
    Account.call(this, address, isNew), isNew || (this._readFromPrefs(), this._refreshToken = this._getStoredRefreshToken());
   }
   ...
   }, (0, util.X$)(UnitedInternetOAuthLoginAccount, Account);
   ...
   var login_common_start = __webpack_require__(9445), _accountCache = {};
   ...
   const refreshAccountCache = getAllExistingAccounts;
   ...
   function getFirstNon1und1LoggedInAccount() {
    return getAllExistingAccounts().find((function(acc) {
     return acc.isLoggedIn && !mail_providers.nc(acc);
    }));
   }
   async function autoLoginIfPossible(provider, firstrun) {
    (0, util.YI)("log into all known accounts");
    let accs = getAllExistingAccounts();
    if (0 !== accs.length) {
     for (var i = 0; i < accs.length; i++) {
      const acc = accs[i];
      provider && provider !== acc.provider || acc.haveStoredLogin && !acc.isLoggedIn && (await acc.login(), 
      acc.isLoggedIn && (0, email_events.I3)(acc));
     }
     (0, email_events.o)();
    } else {
     let active = !0;
     (0, login_common_start.s)(active, firstrun);
    }
   }
   ...
   function makeNewAccount(emailAddress) {
    const domain = Account.getDomainForEmailAddress(emailAddress), config = mail_providers.q[domain];
    if (!config) return {
     error: chrome.i18n.getMessage("error_domain")
    };
    var account = _newAccountOfType(config.type, config.subtype, emailAddress, !0);
    return account.setServerConfig(config), account;
   }
  ...
  7895: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   var lodash_es__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1253), lodash_es__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8218), lodash_es__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9300), _vapi_get_options__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2455), _db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9194), _util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4981);
   async function play() {
    const opts = playerOptions();
    lodash_es__WEBPACK_IMPORTED_MODULE_3__.A((async _ => {
     let audio = new Audio;
     audio.src = await async function(name) {
      if (isBundledPiece(name)) return Promise.resolve(chrome.extension.getURL(name));
      let piece = await _db__WEBPACK_IMPORTED_MODULE_1__.C.get({
       name
      });
      return piece ? piece.data : Promise.resolve(chrome.extension.getURL(DEFAULTS.name));
     }(opts.name), audio.volume = opts.volume % 100 / 100, playFor((0, _util__WEBPACK_IMPORTED_MODULE_2__.YA)(3), audio);
    }), (0, _util__WEBPACK_IMPORTED_MODULE_2__.YA)(3), {
     leading: !0
    })();
   }
   const playFor = (duration, audio) => {
    lodash_es__WEBPACK_IMPORTED_MODULE_4__.A((_ => function(audio) {
     audio.currentTime = (0, _util__WEBPACK_IMPORTED_MODULE_2__.c$)(99999);
    }(audio)), duration), audio.play();
   };
   function options() {
    return _db__WEBPACK_IMPORTED_MODULE_1__.C.orderBy("name").keys().then((names => {
     let opts = playerOptions();
     return opts.pieces = names, (0, _util__WEBPACK_IMPORTED_MODULE_2__.YI)("audio opts=", opts), 
     opts;
    }));
   }
   function playerOptions() {
    return lodash_es__WEBPACK_IMPORTED_MODULE_5__.A({}, DEFAULTS, (0, _vapi_get_options__WEBPACK_IMPORTED_MODULE_0__.$)("sound"));
   }
  ...
  8337: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   var dns_packet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4151), https__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6822), https__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__.n(https__WEBPACK_IMPORTED_MODULE_1__), Buffer = __webpack_require__(2266).Buffer;
  ...
  8579: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   function statusAttr(acc) {
    return acc && acc.isLoggedIn ? acc.newMailCount > 0 ? "new" : "no-new" : "disconnected";
   }
  },
  ...
  9445: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   function startOnboarding(active = !0, firstrun = !1) {
  ...
  6181: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   "use strict";
   __webpack_require__.d(__webpack_exports__, {
    BX: () => providersByWebAppOrigin,
    En: () => outlook,
    Ns: () => providersByID,
    Q3: () => isGmailAccount,
    Qi: () => hasGmailFeedProvider,
    RK: () => BRAND_ACC_TYPE,
    Rz: () => isOutlookAccount,
    T3: () => hasOAuth2Provider,
    bV: () => isBrandAccount,
    hK: () => isThirdPartyAccount,
    nc: () => has1und1Provider,
    nr: () => lookupProviderByEmail,
    px: () => hasOutlookProvider,
    q: () => providersByEmailDomain,
    tc: () => gmail
   });
   var _sanitize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5666), tldjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6507), _dns_over_https__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8337), _oauth2_providers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7245);
   ...
   const providersByID = providers.reduce(((map, p) => (map[p.provider] = p, map)), {}), providersByMX = providers.reduce(((map, p) => {
    ...
    return map;
   }), {}), providersByWebAppOrigin = providers.reduce(((map, p) => {
    if (p.webappOrigin) {
    ...
    return map;
   }), {}), hasOAuth2Provider = p => "oauth2" === p.subtype, hasGmailFeedProvider = p => p.provider === gmail.provider, hasOutlookProvider = p => p.provider === outlook.provider, has1und1Provider = p => p.provider === _1und1.provider, isBrandAccount = acc => acc.type === BRAND_ACC_TYPE, isGmailAccount = acc => acc.type === gmail.type, isOutlookAccount = acc => acc.type === outlook.type, isThirdPartyAccount = acc => isGmailAccount(acc) || isOutlookAccount(acc), getProviderFromDNSAnswer = exchanges => {
    let provider;
   ...
   async function lookupProviderByEmail(email) {
    if (!_sanitize__WEBPACK_IMPORTED_MODULE_0__.a.emailaddress(email, !1)) throw Error("error_email");
    const [, domain] = email.split("@");
    return await async function(domain) {
     let p = providersByEmailDomain[domain];
     if (p) return p;
     const exchange = await _dns_over_https__WEBPACK_IMPORTED_MODULE_2__.$("MX", domain);
  ...
  2069: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   var _vapi_delete_message__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3187), _vapi_get_options__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2455), _vapi_open_message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6976), _vapi_open_webmail__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2946), _vapi_request_active_account_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4101), _audio__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7895), _util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4981);
   ...
   function showForNetID(siteData) {
    const id = `netid/${(0, _util__WEBPACK_IMPORTED_MODULE_6__.HO)(Number.MAX_SAFE_INTEGER)}`;
   ...
   async function showForAccount(acc, notificationStyle) {
    if (await new Promise(((resolve, reject) => {
     chrome.windows.getCurrent((async win => {
      chrome.runtime.lastError, resolve(win && "fullscreen" === win.state);
     }));
    }))) return;
    const opts = (0, _vapi_get_options__WEBPACK_IMPORTED_MODULE_1__.$)(acc.emailAddress);
    if (function(opts, notificationStyle) {
     if (notificationStyle === NotificationStyle.NONE) return;
     if (!opts.email_play_sound) return;
     _audio__WEBPACK_IMPORTED_MODULE_5__.ZH();
    }(opts, notificationStyle), notificationStyle !== NotificationStyle.NONE && opts.email_notifications) {
     var id = "";
     if (notificationStyle === NotificationStyle.MANY) !function(id, receiver) {
      _showNotification(id, {
       type: "basic",
       title: chrome.i18n.getMessage("notification_message"),
       message: receiver,
       iconUrl: "images/notification.png"
      });
     }(id = `mail/${(0, _util__WEBPACK_IMPORTED_MODULE_6__.HO)(Number.MAX_SAFE_INTEGER)}`, acc.emailAddress); else if (notificationStyle === NotificationStyle.ONE) {
      let msg = (0, _vapi_request_active_account_data__WEBPACK_IMPORTED_MODULE_4__.Dh)(acc.emails[0], acc);
      id = `message/${msg.id}`, msg.body && function(id, receiver, msg) {
       const clip = msg.attachmentsText ? "📎 " : "";
       _showNotification(id, {
        type: "basic",
        contextMessage: receiver,
        message: `${chrome.i18n.getMessage("notification_from")}: ${msg.sender}`,
        title: `${clip}${msg.subject}`,
        iconUrl: "images/notification.png"
       });
      }(id, acc.emailAddress, msg), msg.displayURL && (_idToMessageUrl[id] = msg.displayURL);
     }
     _idToAccount[id] = acc.emailAddress;
    }
   }
   ...
   function _showNotification(id, options, timeout) {
    chrome.notifications.create(id, options, (id => {
     chrome.runtime.lastError ? (0, _util__WEBPACK_IMPORTED_MODULE_6__.YI)(chrome.runtime.lastError.message) : setTimeout((_ => {
      delete _idToAccount[id], delete _idToMessageUrl[id], delete _idToNetIDTargetUrl[id], 
      chrome.notifications.clear(id);
     }), timeout || (0, _util__WEBPACK_IMPORTED_MODULE_6__.YA)(7));
    }));
   }
  ...
  7245: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   const _data = __webpack_require__(7279), {webde, gmx, gmxcom, mailcom, gmail, outlook} = _data;
  },
  1807: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   "use strict";
   __webpack_require__.d(__webpack_exports__, {
    SR: () => registerObserver,
    bL: () => unregisterObserver,
    hb: () => notifyObservers
   });
   ...
   function unregisterObserver(msg, observer) {
    !function(observerList, msg, observer) {
     (0, _util__WEBPACK_IMPORTED_MODULE_0__.vA)("string" == typeof msg, "need message type"), 
     (0, _util__WEBPACK_IMPORTED_MODULE_0__.vA)("function" == typeof observer, "need function"), 
     (0, _util__WEBPACK_IMPORTED_MODULE_0__.q_)(observerList, (function(e) {
      return e.msg == msg && e.func == observer;
     }));
    }(_observers, msg, observer);
   }
  ...
  328: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   let accounts, netid, options, stats, tokens, pendingTiles, _allItems = {};
   function init() {
    return new Promise(((resolve, reject) => {
     chrome.storage.local.get(null, (items => {
      chrome.runtime.lastError && reject(chrome.runtime.lastError.message), _allItems = items, 
      stats = new Storage("stats4", _allItems), options = new Storage("options4", _allItems), 
      accounts = new Storage("accounts4", _allItems), netid = new Storage("netid5", _allItems), 
      tokens = new Storage("tokens4", _allItems), pendingTiles = new Storage("pending_tiles", {}), 
      chrome.storage.onChanged.addListener((changes => {
       changes?.pending_tiles && (changes?.pending_tiles?.newValue || (pendingTiles = new Storage("pending_tiles", {})));
      })), resolve();
     }));
    }));
   }
  ...
  4981: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   const supportsNetId = !0, isUrl = s => /^https?\:\/\/.+/.test(s);
   function browserLocale() {
    return chrome.i18n.getUILanguage() || navigator.language;
   }
   function browserLang() {
    return browserLocale().replace("_", "-").split("-")[0];
   }
   function browserCountry() {
    return browserLocale().replace("_", "-").split("-")[1];
   }
   ...
   function truncateMiddle(str, n = 20) {
    if (str.length <= n) return str;
    const ratio = n / str.length;
    return truncate(str, parseInt((str.length - 6) * ratio)) + str.substr(str.length - 6);
   }
   ...
   function arrayRemoveAllWhere(array, func) {
    assert("function" == typeof func), assert("number" == typeof array.length);
    for (var i = 0; i < array.length; i++) func(array[i]) && (array.splice(i, 1), i--);
   }
  ...
  2455: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   __webpack_require__.d(__webpack_exports__, {
    $: () => getOptions,
    j: () => getOptionsForAllAccounts
   });
   var _lib_account_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7095), _lib_storage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(328);
   ...
   function getOptionsForAllAccounts() {
    let result = {};
    return _lib_account_list__WEBPACK_IMPORTED_MODULE_0__.j_().map((a => {
     const namespace = a.emailAddress, opts = _lib_storage__WEBPACK_IMPORTED_MODULE_1__.fF.smembers(namespace) || [];
     let tmp = {};
     opts.map((e => tmp[e] = !0)), result[namespace] = tmp;
    })), result;
   }
  },
  ...
  4101: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
   ...
   __webpack_require__.d(__webpack_exports__, {
    Dh: () => mapMessageRecord,
    Gy: () => orderByUserPref,
    Fp: () => requestActiveAccountData
   });
   var mapKeys = __webpack_require__(539), account_list = __webpack_require__(7095), mail_providers = __webpack_require__(6181), preload = __webpack_require__(4130), util = __webpack_require__(4981);
   const CRITERIA = {
    "has-delete-message-scope": {
     min_version: "4.4.700",
     check: function(criteria, ...args) {
      let account = args.shift();
      if ((0, util.vA)(account), (0, util.vA)(preload.valid(criteria.min_version)), mail_providers.Q3(account)) return !1;
      if (mail_providers.Rz(account)) return !0;
      let llv = account.getLastLogin();
      return !!llv && preload.satisfies(preload.coerce(llv), `>= ${criteria.min_version}`);
     }
    }
   };
   function isOn(featureId, ...args) {
    const criteria = CRITERIA[featureId];
    return (0, util.vA)(criteria, "unknown criteria"), criteria.check(criteria, ...args);
   }
   var get_options = __webpack_require__(2455), email_status = __webpack_require__(2184), ext_update_available = __webpack_require__(7683);
   function mapMessageRecord(msg, acc) {
    return mail_providers.bV(acc) ? function(msg) {
     let r = {
      body: msg.body || "",
      id: msg.mailIdentifier || msg.id,
      link: msg.displayURL,
      sender: msg.authorRealname,
      subject: msg.subject || "",
      timestamp: msg.date.getTime()
     };
     const c = msg.attachments.length;
     return 1 === c ? r.attachmentsText = (0, util.kU)(msg.attachments[0].filename, 32) : c > 1 && (r.attachmentsText = chrome.i18n.getMessage("message_attachments_multiple", [ c ])), 
     r;
    }(msg) : (mail_providers.Rz(acc), msg);
   }
   function orderByUserPref(accounts) {
    let order = (0, get_options.$)("accounts").order;
    if (!order) return accounts;
    let tmp = mapKeys.A(order.split("|"));
    return accounts.forEach((acc => {
     tmp[acc.email] = acc;
    })), Object.values(tmp).filter((item => "object" == typeof item));
   }
   function requestActiveAccountData() {
    let data = [];
    try {
     (0, email_status.p)();
     let all = account_list.j_();
     for (let i = 0; i < all.length; i++) {
      let acc = all[i];
      const accountRecord = {
       email: acc.emailAddress,
       isBrandAccount: mail_providers.bV(acc),
       isLoggedIn: acc.isLoggedIn,
       unread: acc.newMailCount,
       canDelete: isOn("has-delete-message-scope", acc),
       canCompose: !mail_providers.nc(acc.config),
       canLogout: !mail_providers.Qi(acc.config),
       messages: []
      }, maxMessages = all.length > 1 ? 5 : 7;
      for (let i = 0; i < acc.emails.length && !(i >= maxMessages); i++) {
       const msg = acc.emails[i];
       accountRecord.messages.push(mapMessageRecord(msg, acc));
      }
      data.push(accountRecord);
     }
    } catch (e) {
     (0, util.YI)(e);
    }
    return {
     accounts: orderByUserPref(data),
     requiresUpdate: ext_update_available.X.available
    };
   }
  },
  ...
  1671: (module, exports, __webpack_require__) => {
   !function() {
    "use strict";
    ...
    var p = 1e3, v = 1e6, b = 1e9, y = 1e12, c = 1e15, m = [ "zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen" ], w = [ "zero", "ten", "twenty", "thirty", "forty", "fifty", "sixty", "seventy", "eighty", "ninety" ];
    function x(e, t) {
     ...
     return n = function e(t) {
      ...
      t = Math.abs(t)), t < 20 ? (n = 0, r = m[t]) : t < 100 ? (n = t % 10, r = w[Math.floor(t / 10)], 
      n && (r += "-" + m[n], n = 0)) : t < p ? (n = t % 100, r = e(Math.floor(t / 100)) + " hundred") : t < v ? (n = t % p, 
      r = e(Math.floor(t / p)) + " thousand,") : t < b ? (n = t % v, r = e(Math.floor(t / v)) + " million,") : t < y ? (n = t % b, 
      r = e(Math.floor(t / b)) + " billion,") : t < c ? (n = t % y, r = e(Math.floor(t / y)) + " trillion,") : t <= 9007199254740992 && (n = t % c, 
  ...
  5026: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
   "use strict";
   __webpack_require__.d(__webpack_exports__, {
    A: () => __WEBPACK_DEFAULT_EXPORT__
   });
   const __WEBPACK_DEFAULT_EXPORT__ = function(func, wait, args) {
  ...
  3868: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
   ...
   var _baseFor_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7077), _keys_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7352);
   const __WEBPACK_DEFAULT_EXPORT__ = function(object, iteratee) {
    return object && (0, _baseFor_js__WEBPACK_IMPORTED_MODULE_0__.A)(object, iteratee, _keys_js__WEBPACK_IMPORTED_MODULE_1__.A);
   };
  },
  ...
  7101: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
   "use strict";
   __webpack_require__.d(__webpack_exports__, {
    A: () => _baseIteratee
   });
   var _Stack = __webpack_require__(3921), _MapCache = __webpack_require__(9137);
   const _setCacheAdd = function(value) {
    return this.__data__.set(value, "__lodash_hash_undefined__"), this;
   };
   const _setCacheHas = function(value) {
   ...
   const _arraySome = function(array, predicate) {
    for (var index = -1, length = null == array ? 0 : array.length; ++index < length; ) if (predicate(array[index], index, array)) return !0;
    return !1;
   };
   const _cacheHas = function(cache, key) {
    return cache.has(key);
   };
   const _equalArrays = function(array, other, bitmask, customizer, equalFunc, stack) {
    var isPartial = 1 & bitmask, arrLength = array.length, othLength = other.length;
    if (arrLength != othLength && !(isPartial && othLength > arrLength)) return !1;
    var arrStacked = stack.get(array), othStacked = stack.get(other);
    if (arrStacked && othStacked) return arrStacked == other && othStacked == array;
    var index = -1, result = !0, seen = 2 & bitmask ? new _SetCache : void 0;
   ...
   var _Symbol = __webpack_require__(272), _Uint8Array = __webpack_require__(8205), eq = __webpack_require__(6855);
   const _mapToArray = function(map) {
    var index = -1, result = Array(map.size);
    return map.forEach((function(value, key) {
     result[++index] = [ key, value ];
    })), result;
   };
   const _setToArray = function(set) {
    var index = -1, result = Array(set.size);
    return set.forEach((function(value) {
     result[++index] = value;
    })), result;
   };
   var symbolProto = _Symbol.A ? _Symbol.A.prototype : void 0, symbolValueOf = symbolProto ? symbolProto.valueOf : void 0;
   const _equalByTag = function(object, other, tag, bitmask, customizer, equalFunc, stack) {
    switch (tag) {
   ...
   const _arrayPush = function(array, values) {
    for (var index = -1, length = values.length, offset = array.length; ++index < length; ) array[offset + index] = values[index];
    return array;
   };
   var isArray = __webpack_require__(5264);
   const _baseGetAllKeys = function(object, keysFunc, symbolsFunc) {
    var result = keysFunc(object);
    return (0, isArray.A)(object) ? result : _arrayPush(result, symbolsFunc(object));
   };
   const _arrayFilter = function(array, predicate) {
   ...
   const lodash_es_stubArray = function() {
    return [];
   };
   var propertyIsEnumerable = Object.prototype.propertyIsEnumerable, nativeGetSymbols = Object.getOwnPropertySymbols;
   const _getSymbols = nativeGetSymbols ? function(object) {
    return null == object ? [] : (object = Object(object), _arrayFilter(nativeGetSymbols(object), (function(symbol) {
     return propertyIsEnumerable.call(object, symbol);
    })));
   } : lodash_es_stubArray;
   var keys = __webpack_require__(7352);
   const _getAllKeys = function(object) {
    return _baseGetAllKeys(object, keys.A, _getSymbols);
   };
   var _equalObjects_hasOwnProperty = Object.prototype.hasOwnProperty;
   const _equalObjects = function(object, other, bitmask, customizer, equalFunc, stack) {
   ...
   var _getNative = __webpack_require__(7893), _root = __webpack_require__(7156);
   const _DataView = (0, _getNative.A)(_root.A, "DataView");
   var _Map = __webpack_require__(9896);
   const _Promise = (0, _getNative.A)(_root.A, "Promise");
   const _Set = (0, _getNative.A)(_root.A, "Set");
   const _WeakMap = (0, _getNative.A)(_root.A, "WeakMap");
   var _baseGetTag = __webpack_require__(4117), _toSource = __webpack_require__(1632), dataViewCtorString = (0, 
   _toSource.A)(_DataView), mapCtorString = (0, _toSource.A)(_Map.A), promiseCtorString = (0, 
   _toSource.A)(_Promise), setCtorString = (0, _toSource.A)(_Set), weakMapCtorString = (0, 
   _toSource.A)(_WeakMap), getTag = _baseGetTag.A;
   (_DataView && "[object DataView]" != getTag(new _DataView(new ArrayBuffer(1))) || _Map.A && "[object Map]" != getTag(new _Map.A) || _Promise && "[object Promise]" != getTag(_Promise.resolve()) || _Set && "[object Set]" != getTag(new _Set) || _WeakMap && "[object WeakMap]" != getTag(new _WeakMap)) && (getTag = function(value) {
    var result = (0, _baseGetTag.A)(value), Ctor = "[object Object]" == result ? value.constructor : void 0, ctorString = Ctor ? (0, 
    _toSource.A)(Ctor) : "";
   ...
   var isBuffer = __webpack_require__(913), isTypedArray = __webpack_require__(8102), _baseIsEqualDeep_hasOwnProperty = Object.prototype.hasOwnProperty;
   const _baseIsEqualDeep = function(object, other, bitmask, customizer, equalFunc, stack) {
    var objIsArr = (0, isArray.A)(object), othIsArr = (0, isArray.A)(other), objTag = objIsArr ? "[object Array]" : _getTag(object), othTag = othIsArr ? "[object Array]" : _getTag(other), objIsObj = "[object Object]" == (objTag = "[object Arguments]" == objTag ? "[object Object]" : objTag), othIsObj = "[object Object]" == (othTag = "[object Arguments]" == othTag ? "[object Object]" : othTag), isSameTag = objTag == othTag;
    if (isSameTag && (0, isBuffer.A)(object)) {
     if (!(0, isBuffer.A)(other)) return !1;
     objIsArr = !0, objIsObj = !1;
    }
    if (isSameTag && !objIsObj) return stack || (stack = new _Stack.A), objIsArr || (0, 
    isTypedArray.A)(object) ? _equalArrays(object, other, bitmask, customizer, equalFunc, stack) : _equalByTag(object, other, objTag, bitmask, customizer, equalFunc, stack);
    if (!(1 & bitmask)) {
   ...
   const _baseIsEqual = function baseIsEqual(value, other, bitmask, customizer, stack) {
    return value === other || (null == value || null == other || !(0, isObjectLike.A)(value) && !(0, 
    isObjectLike.A)(other) ? value != value && other != other : _baseIsEqualDeep(value, other, bitmask, customizer, baseIsEqual, stack));
   };
   const _baseIsMatch = function(object, source, matchData, customizer) {
   ...
   const _isStrictComparable = function(value) {
    return value == value && !(0, isObject.A)(value);
   };
   const _getMatchData = function(object) {
    for (var result = (0, keys.A)(object), length = result.length; length--; ) {
     var key = result[length], value = object[key];
     result[length] = [ key, value, _isStrictComparable(value) ];
    }
    return result;
   };
   const _matchesStrictComparable = function(key, srcValue) {
    return function(object) {
     return null != object && (object[key] === srcValue && (void 0 !== srcValue || key in Object(object)));
    };
   };
   const _baseMatches = function(source) {
   ...
   var isSymbol = __webpack_require__(8525), reIsDeepProp = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, reIsPlainProp = /^\w*$/;
   const _isKey = function(value, object) {
    if ((0, isArray.A)(value)) return !1;
    var type = typeof value;
    return !("number" != type && "symbol" != type && "boolean" != type && null != value && !(0, 
    isSymbol.A)(value)) || (reIsPlainProp.test(value) || !reIsDeepProp.test(value) || null != object && value in Object(object));
   };
   function memoize(func, resolver) {
    ...
    return memoized.cache = new (memoize.Cache || _MapCache.A), memoized;
   }
   memoize.Cache = _MapCache.A;
   const lodash_es_memoize = memoize;
   var rePropName = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, reEscapeChar = /\\(\\)?/g;
   const _stringToPath = function(func) {
   ...
   const _arrayMap = function(array, iteratee) {
    for (var index = -1, length = null == array ? 0 : array.length, result = Array(length); ++index < length; ) result[index] = iteratee(array[index], index, array);
    return result;
   };
   var _baseToString_symbolProto = _Symbol.A ? _Symbol.A.prototype : void 0, symbolToString = _baseToString_symbolProto ? _baseToString_symbolProto.toString : void 0;
   const _baseToString = function baseToString(value) {
    if ("string" == typeof value) return value;
    if ((0, isArray.A)(value)) return _arrayMap(value, baseToString) + "";
    if ((0, isSymbol.A)(value)) return symbolToString ? symbolToString.call(value) : "";
    var result = value + "";
    return "0" == result && 1 / value == -Infinity ? "-0" : result;
   };
   const lodash_es_toString = function(value) {
    return null == value ? "" : _baseToString(value);
   };
   const _castPath = function(value, object) {
    return (0, isArray.A)(value) ? value : _isKey(value, object) ? [ value ] : _stringToPath(lodash_es_toString(value));
   };
   const _toKey = function(value) {
    if ("string" == typeof value || (0, isSymbol.A)(value)) return value;
    var result = value + "";
    return "0" == result && 1 / value == -Infinity ? "-0" : result;
   };
   const _baseGet = function(object, path) {
    for (var index = 0, length = (path = _castPath(path, object)).length; null != object && index < length; ) object = object[_toKey(path[index++])];
    return index && index == length ? object : void 0;
   };
   const lodash_es_get = function(object, path, defaultValue) {
    var result = null == object ? void 0 : _baseGet(object, path);
    return void 0 === result ? defaultValue : result;
   };
   const _baseHasIn = function(object, key) {
    return null != object && key in Object(object);
   };
   var isArguments = __webpack_require__(9792), _isIndex = __webpack_require__(2318), isLength = __webpack_require__(2793);
   const _hasPath = function(object, path, hasFunc) {
    for (var index = -1, length = (path = _castPath(path, object)).length, result = !1; ++index < length; ) {
     var key = _toKey(path[index]);
     if (!(result = null != object && hasFunc(object, key))) break;
     object = object[key];
    }
    return result || ++index != length ? result : !!(length = null == object ? 0 : object.length) && (0, 
    isLength.A)(length) && (0, _isIndex.A)(key, length) && ((0, isArray.A)(object) || (0, 
    isArguments.A)(object));
   };
   const lodash_es_hasIn = function(object, path) {
    return null != object && _hasPath(object, path, _baseHasIn);
   };
   const _baseMatchesProperty = function(path, srcValue) {
   ...
   const _baseProperty = function(key) {
    return function(object) {
     return null == object ? void 0 : object[key];
    };
   };
   const _basePropertyDeep = function(path) {
    return function(object) {
     return _baseGet(object, path);
    };
   };
   const lodash_es_property = function(path) {
    return _isKey(path) ? _baseProperty(_toKey(path)) : _basePropertyDeep(path);
   };
   const _baseIteratee = function(value) {
    return "function" == typeof value ? value : null == value ? identity.A : "object" == typeof value ? (0, 
    isArray.A)(value) ? _baseMatchesProperty(value[0], value[1]) : _baseMatches(value) : lodash_es_property(value);
   };
  },
  ...
  9300: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
   "use strict";
   __webpack_require__.d(__webpack_exports__, {
    A: () => __WEBPACK_DEFAULT_EXPORT__
   });
   var _assignValue_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(528), _copyObject_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4346), _createAssigner_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5780), _isArrayLike_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8999), _isPrototype_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8272), _keys_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7352), hasOwnProperty = Object.prototype.hasOwnProperty;
   const __WEBPACK_DEFAULT_EXPORT__ = (0, _createAssigner_js__WEBPACK_IMPORTED_MODULE_0__.A)((function(object, source) {
    if ((0, _isPrototype_js__WEBPACK_IMPORTED_MODULE_1__.A)(source) || (0, _isArrayLike_js__WEBPACK_IMPORTED_MODULE_2__.A)(source)) (0, 
    _copyObject_js__WEBPACK_IMPORTED_MODULE_3__.A)(source, (0, _keys_js__WEBPACK_IMPORTED_MODULE_4__.A)(source), object); else for (var key in source) hasOwnProperty.call(source, key) && (0, 
    _assignValue_js__WEBPACK_IMPORTED_MODULE_5__.A)(object, key, source[key]);
   }));
  },
  ...
  8218: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
   "use strict";
   __webpack_require__.d(__webpack_exports__, {
    A: () => __WEBPACK_DEFAULT_EXPORT__
   });
   var _baseDelay_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5026), _baseRest_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2299), _toNumber_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2565);
   const __WEBPACK_DEFAULT_EXPORT__ = (0, _baseRest_js__WEBPACK_IMPORTED_MODULE_0__.A)((function(func, wait, args) {
    return (0, _baseDelay_js__WEBPACK_IMPORTED_MODULE_1__.A)(func, (0, _toNumber_js__WEBPACK_IMPORTED_MODULE_2__.A)(wait) || 0, args);
   }));
  },
  ...
  7734: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
   "use strict";
   __webpack_require__.d(__webpack_exports__, {
    A: () => lodash_es_findKey
   });
   const _baseFindKey = function(collection, predicate, eachFunc) {
    var result;
    return eachFunc(collection, (function(value, key, collection) {
     if (predicate(value, key, collection)) return result = key, !1;
    })), result;
   };
   var _baseForOwn = __webpack_require__(3868), _baseIteratee = __webpack_require__(7101);
   const lodash_es_findKey = function(object, predicate) {
    return _baseFindKey(object, (0, _baseIteratee.A)(predicate, 3), _baseForOwn.A);
   };
  },
  ...
  7352: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
   "use strict";
   __webpack_require__.d(__webpack_exports__, {
    A: () => lodash_es_keys
   });
   var _arrayLikeKeys = __webpack_require__(2192), _isPrototype = __webpack_require__(8272);
   const _nativeKeys = (0, __webpack_require__(1440).A)(Object.keys, Object);
   var _baseKeys_hasOwnProperty = Object.prototype.hasOwnProperty;
   const _baseKeys = function(object) {
    if (!(0, _isPrototype.A)(object)) return _nativeKeys(object);
    var result = [];
   ...
   const lodash_es_keys = function(object) {
    return (0, isArrayLike.A)(object) ? (0, _arrayLikeKeys.A)(object) : _baseKeys(object);
   };
  },
  539: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
   "use strict";
   __webpack_require__.d(__webpack_exports__, {
    A: () => __WEBPACK_DEFAULT_EXPORT__
   });
   var _baseAssignValue_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6003), _baseForOwn_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3868), _baseIteratee_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7101);
   const __WEBPACK_DEFAULT_EXPORT__ = function(object, iteratee) {
    var result = {};
    return iteratee = (0, _baseIteratee_js__WEBPACK_IMPORTED_MODULE_0__.A)(iteratee, 3), 
    (0, _baseForOwn_js__WEBPACK_IMPORTED_MODULE_1__.A)(object, (function(value, key, object) {
     (0, _baseAssignValue_js__WEBPACK_IMPORTED_MODULE_2__.A)(result, iteratee(value, key, object), value);
    })), result;
   };
  },
  ...
  1253: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
   ...
   var _debounce_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4162), _isObject_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2922);
   const __WEBPACK_DEFAULT_EXPORT__ = function(func, wait, options) {
    var leading = !0, trailing = !0;
    if ("function" != typeof func) throw new TypeError("Expected a function");
    return (0, _isObject_js__WEBPACK_IMPORTED_MODULE_0__.A)(options) && (leading = "leading" in options ? !!options.leading : leading, 
    trailing = "trailing" in options ? !!options.trailing : trailing), (0, _debounce_js__WEBPACK_IMPORTED_MODULE_1__.A)(func, wait, {
     leading,
     maxWait: wait,
     trailing
    });
 ...
 module), (() => {
  "use strict";
  var storage = __webpack_require__(328);
  chrome.runtime.onMessage.addListener((function(request, sender, sendResponse) {
   if ("get-ext-info" !== request.id) return;
   let manifest = chrome.runtime.getManifest(), installDate = new Date(storage.M1.get("installtime") || 0).toISOString(), kid = storage.M1.get("kid").toString();
   var ch;
   sendResponse({
    product: "toolbar",
    version: manifest.version,
    brand: "webde",
    variant: (ch = "amo", "oem" === ch ? "full" : "oemntp" === ch ? "ntp" : "oemdsp" === ch ? "dsp" : "mffpr" === ch ? "bundle" : ch),
    installDate,
    kid
   });
  }));
  var observer = __webpack_require__(1807), webapp_start = __webpack_require__(4561), config = __webpack_require__(5543);
  function startWebappFromAction(action, params = []) {
   const ACTION_URL_MAPPING = {
    "goto-shopping": config.w.shoppingURL,
    "goto-help": config.w.helpURL,
    "goto-help-center": config.w.helpCenterURL,
    "goto-blog": config.w.blogURL,
    "goto-forum": config.w.forumURL,
    "goto-news": config.w.newsURL,
    "goto-control-center": config.w.controlCenterURL
   }, usecase = {
    "goto-inbox": "home",
    "goto-address-book": "addressbook",
    "goto-calendar": "calendar",
    "goto-mail-composer": "compose",
    "goto-online-storage": "smartdrive",
    "goto-office": "open_ooeditor"
   }[action];
   if (usecase) return (0, webapp_start.uh)(usecase, params, "current"), !0;
   const url = ACTION_URL_MAPPING[action] || config.w.mailcheckProductPageURL;
   return !!url && (chrome.tabs.update({
    url
   }), !0);
  }
  const updateBadge = param => {
   const summary = param.summary || param, isLoggedIn = summary.isLoggedIn > 0, text = isLoggedIn ? summary.totalMailCount : chrome.i18n.getMessage("login").toUpperCase(), msg = Object.assign({}, param, {
    id: "set-badge",
    text,
    isLoggedIn
   });
  ...
  var util = __webpack_require__(4981);
  const portal_page_badge_registerEventHandlers = port => {
   const fn = param => ((param, port) => {
    const summary = param.summary, text = summary.isLoggedIn > 0 ? summary.totalMailCount : chrome.i18n.getMessage("login_submit").toUpperCase();
    port.postMessage({
     id: "set-badge",
     text
    });
   })(param, port);
   (0, observer.SR)("mail-check-with-summary", fn), port.onDisconnect.addListener((_ => {
    (0, observer.bL)("mail-check-with-summary", fn);
   }));
  }, onConnectHandler = port => {
   port.sender.id === chrome.runtime.id && "portal-webapps-cs" === port.name && port.onMessage.addListener((msg => {
    "SYN" === msg.id ? (portal_page_badge_registerEventHandlers(port), port.postMessage({
     id: "ACK"
    }), (0, util.YI)("mailcheck controls badges on portal (not newtab extension)")) : "INIT" === msg.id ? (0, 
    observer.hb)("mail-status-request", {
     successCallback: _ => {}
    }) : "uninstall" === msg.action ? chrome.management.uninstallSelf((() => {
     console.log("uninstall done");
    })) : msg.action ? startWebappFromAction(msg.action) : (0, util.YI)("WARNING: unknown message [portal-page-badge]");
   }));
  };
  var audio = __webpack_require__(7895);
  var choose_gmail_account = __webpack_require__(3514), account_list = __webpack_require__(7095), mail_providers = __webpack_require__(6181), get_options = __webpack_require__(2455), request_active_account_data = __webpack_require__(4101);
  var browser_action = __webpack_require__(3440), delay = __webpack_require__(8218);
  function go(url) {
   return url || url;
  }
  const SERP_FROM_LASTTAB_REGEX = /q=.*&(src|origin)=tb_lasttab_/, LASTTAB_REGEX = /lasttab\?src=tb_lasttab_/, lastTabUrlFilter = tab => LASTTAB_REGEX.test(tab.url), OAUTH_POPUP_URL_REGEX = /(1und1.de|web.de|gmx.net|gmx.com|mail.com)\/(login\/oauth2|oauth2)\//, isPopupFilter = tab => OAUTH_POPUP_URL_REGEX.test(tab.url);
  ...
  function createLastTab() {
   ignoreRelatedUpdateEvent = !0, chrome.tabs.create({
    ...
    pinned: !0,
    active: !1,
    url: go(config.w.lastTabURL)
   });
  }
  let eventsHandledCount = -1;
  const incEventCounter = () => eventsHandledCount++;
  ...
  function last_tab_init(openImmediately = !0) {
   const opts = storage.fF.smembers("general") || [];
   delay.A((_ => switchActivation(opts.indexOf("search_last_tab") > -1, openImmediately)), (0, 
   util.YA)(3));
  }
  function installMailtoHandler(tabId) {
   chrome.tabs.executeScript(tabId, {
    ...
    chrome.runtime.lastError && (0, util.YI)(chrome.runtime.lastError.message);
   }));
  }
  function onTabUpdated(tabId, changeInfo, tab) {
   "complete" === changeInfo.status && tab.url && /^https?:\/\//.test(tab.url) && installMailtoHandler(tabId);
  }
  function mailto_handler_switchActivation(enabled = !0) {
  ...
  const sValueProp = "value", sAttributesProp = "attr", sAttrPref = "@", sElementListPrefix = "$", sConflictSuffix = "_", aCache = [], rIsBool = /^(?:true|false)$/i;
  ...
  function createObjTree(oParentNode, nVerb, bFreeze, bNesteAttr) {
   ...
   for (var nElId = nLevelStart; nElId < nLevelEnd; nElId++) (sProp = aCache[nElId].nodeName) != sValueProp && sProp != sAttributesProp || (sProp += sConflictSuffix), 
   vContent = createObjTree(aCache[nElId], nVerb, bFreeze, bNesteAttr), vResult.hasOwnProperty(sProp) || (vResult[sProp] = vContent, 
   vResult[sElementListPrefix + sProp] = []), vResult[sElementListPrefix + sProp].push(vContent), 
   nLength++;
   if (bAttributes) {
    const nAttrLen = oParentNode.attributes.length, sAPrefix = bNesteAttr ? "" : sAttrPref, oAttrParent = bNesteAttr ? {} : vResult;
    ...
    bNesteAttr && (bFreeze && Object.freeze(oAttrParent), vResult[sAttributesProp] = oAttrParent, 
    nLength -= nAttrLen - 1);
   }
   return 3 === nVerb || (2 === nVerb || 1 === nVerb && nLength > 0) && sCollectedTxt ? vResult[sValueProp] = vBuiltVal : !bHighVerb && 0 === nLength && sCollectedTxt && (vResult = vBuiltVal), 
  ...
  var email_events = __webpack_require__(8855), notifications = __webpack_require__(2069);
  ...
  function onUpdated(tabId, changeInfo, tab) {
   ...
   site && function(sitename) {
    const key = sitename, shownAt = showtimes[key] || Date.now() - (0, util.c$)(1);
    return Math.abs(Date.now() - shownAt) > (0, util.Gx)(1) && (showtimes[key] = Date.now(), 
    !0);
   }(site.name) ? function(site) {
    browser_action.x$(site), notifications.zC(site);
   }(site) : (0, email_events.o)();
  }
  function netid_switchActivation(enabled = !0) {
   if (util.pQ) if (chrome.tabs.onUpdated.hasListener(onUpdated) && chrome.tabs.onUpdated.removeListener(onUpdated), 
   enabled) {
    const fetcher = function() {
     config.w.netid.feedURL && DocumentCache.fetch(go(config.w.netid.feedURL), storage.xK, parseConfig);
    };
    (0, util.cu)(fetcher, null, 1e3), chrome.tabs.onUpdated.addListener(onUpdated);
   } else (0, email_events.o)(), showtimes = {};
  }
  const SP = go(config.w.searchPAURL), SERP_REGEX = /[\?\&](q|query|k|field-keywords|_nkw)=([^\&]+)/;
  function TabHistory() {
   this._history = {};
  }
  ...
  function onClicked(tab) {
   const term = function(url) {
    const matches = url && url.match(SERP_REGEX);
    return matches && matches.length >= 3 ? matches[2] : null;
   }(tabHistory.get(tab.id));
   let url = term ? SP.concat("?q=", term) : SP;
   chrome.tabs.update({
    url
   });
  }
  function search_page_action_onTabUpdated(tabId, changeInfo, tab) {
   displayPageAction(tabId), "complete" === changeInfo.status && tabHistory.set(tabId, tab.url);
  }
  function onTabRemoved(tabId) {
   tabHistory.remove(tabId);
  }
  let displayPageAction = _ => {};
  function onTabActivated(info) {
   displayPageAction(info.tabId);
  }
  function search_page_action_switchActivation(enabled = !0) {
   displayPageAction = enabled ? tabId => {
    tabId && chrome.pageAction.show(tabId);
   } : tabId => {
    tabId && chrome.pageAction.hide(tabId);
   }, chrome.tabs.query({
    active: !0
   }, (tab => displayPageAction(tab.id)));
  }
  const converter = __webpack_require__(1671);
  function storeOption(key, value, namespace) {
   const ns = "string" == typeof namespace ? namespace : "general";
   if ("number" == typeof value) {
    const numberNS = `${ns}-numbers`;
    let data = storage.fF.get(numberNS) || {};
    data[key] = value, storage.fF.set(numberNS, data);
   } else if ("string" == typeof value) {
    const stringNS = `${ns}-strings`;
    let data = storage.fF.get(stringNS) || {};
    data[key] = value, storage.fF.set(stringNS, data);
   } else if ("object" == typeof value) {
    const objectNS = `${ns}-objects`;
    let data = storage.fF.get(objectNS) || {};
    data[key] = JSON.stringify(value), storage.fF.set(objectNS, data);
   } else !0 === Boolean(value) ? storage.fF.sadd(ns, key) : !1 === Boolean(value) ? storage.fF.srem(ns, key) : (0, 
   util.YI)("WARN: store what?");
  }
  function set_option_setOption(key, value, namespace) {
   return storeOption(key, value, namespace), function(key, value, namespace) {
    if ("sound" !== namespace) if (/^rating-\d/.test(key)) {
     const url = go(config.w.ratingURL + converter.toWords(value));
     chrome.tabs.create({
      url,
      active: !0
     });
    ...
    case "mailto_handler":
     mailto_handler_switchActivation(value);
     break;
    ...
    case "search_from_url_bar":
     search_page_action_switchActivation(value);
     break;

    case "email_preview":
     browser_action.Fg(value), (0, email_events.o)();
     break;

    case "email_unread_mode":
     {
      let acc = account_list.CM(namespace);
      acc && (acc.unreadMode = value), (0, email_events.o)();
      break;
     }

    case "netid_suggest":
     netid_switchActivation(value);
     break;

    case "privacy_usage_data":
    case "privacy_usage_data_tcf":
  ...
  async function validate_email_password_validateEmailAndPassword(email, password, createMode) {
   let status = function(email) {
    if (!email) return {
     error: chrome.i18n.getMessage("error_noEmailAndPassword")
    };
    const rx = /^[a-z0-9\-%+_\.]+@[a-z0-9\-\.]+\.[a-z]+$/;
    try {
     if (!rx.test(email)) return {
      error: chrome.i18n.getMessage("error_syntax")
     };
    } catch (e) {
     return {
      error: e._message
   ...
   if (!status.ok) return status;
   const provider = await mail_providers.nr(email);
   if (mail_providers.px(provider)) return {
    error: chrome.i18n.getMessage("error_domain")
   };
   if (!provider) return {
    error: chrome.i18n.getMessage("error_domain")
   };
   (0, util.YI)("validate email=" + email + "; provider=" + provider.provider);
   const pwd = mail_providers.T3(provider) || mail_providers.Qi(provider) ? null : password;
   if (pwd && (status = function(password) {
    return password ? password.length < 2 ? {
     error: chrome.i18n.getMessage("error_password")
    } : {
     ok: !0
    } : {
     error: chrome.i18n.getMessage("error_noPassword")
    };
   }(pwd)), !status.ok) return status;
   let acc = account_list.CM(email);
   return acc && createMode && (status = {
    error: chrome.i18n.getMessage("error_exists")
   }), status.ok ? (!acc && createMode && (acc = account_list.Me(email)), status = await async function(acc, pwd) {
    (0, util.vA)(acc, "no login w/o account, dude"), pwd && acc.setPassword(pwd), acc.isLoggedIn && mail_providers.bV(acc) && acc.logout();
    const status = await acc.login();
    return (0, util.YI)(`login status: ${JSON.stringify(status)}`), status;
   }(acc, password), status.ok && (status.closeWindow = mail_providers.Q3(acc) || mail_providers.Rz(acc), 
   createMode ? (acc.saveToPrefs(), (0, email_events.zu)(acc).then((_ => (0, email_events.I3)(acc)))) : (0, 
   email_events.I3)(acc)), status) : status;
  }
  var loadpage = __webpack_require__(3806);
  var open_message = __webpack_require__(6976), delete_message = __webpack_require__(3187);
  var open_webmail = __webpack_require__(2946);
  var axios = __webpack_require__(7527);
  function handleFirefox() {
   chrome.management.getSelf((info => {
    info.updateUrl ? async function(updateUrl) {
     let path = (await axios.A.get(updateUrl)).data.addons;
     if (!path) return;
     if (path = path[chrome.runtime.id], !path) return;
     if (path = path.updates[0], !path) return;
     const link = path.update_link;
     link && chrome.tabs.create({
      url: link
     });
    }(info.updateUrl) : function() {
     let storeUrl = `${config.m}/${chrome.runtime.id}`;
     storeUrl && chrome.tabs.create({
      url: storeUrl
     });
    }();
   }));
  ...
  chrome.runtime.onMessage.addListener(((request, sender, sendResponse) => {
   ...
   case "update-extension":
    response = void handleFirefox();
    break;

   case "choose-gmail-account":
    response = (0, choose_gmail_account.X)(request.email);
    break;

   case "get-accounts":
    response = function() {
     const opts = (0, get_options.j)(), response = account_list.j_().map((a => ({
      email: a.emailAddress,
      isLoggedIn: a.isLoggedIn,
      isOutlook: mail_providers.px(a.config),
      isGmail: mail_providers.Qi(a.config),
      notification: opts[a.emailAddress].email_notifications,
      preview: opts[a.emailAddress].email_preview,
      remember: a.wantStoredLogin,
      sound: opts[a.emailAddress].email_play_sound,
      unreadMode: a.unreadMode
     })));
     return (0, request_active_account_data.Gy)(response);
    }();
    break;

   case "get-audio-options":
    return audio.fF().then(sendResponse), !0;

   case "get-general-options":
    response = (0, get_options.$)();
    break;

   case "get-account-options":
    response = (0, get_options.j)();
    break;

   case "set-option":
    response = set_option_setOption(request.key, request.value, request.namespace);
    break;

   case "validate-email-password":
    return validate_email_password_validateEmailAndPassword(request.email, request.password, request.createMode).then(sendResponse), 
    !0;

   case "request-aticve-account-data":
    response = (0, request_active_account_data.Fp)();
    break;

   case "logout-from-all-accounts":
    account_list.j_().forEach((acc => {
     acc.logout();
    })), response = !0;
    break;

   case "launch-oauth2-web-auth-flow":
    return async function(email) {
     let acc = account_list.CM(email);
     (0, util.vA)(acc);
     const status = await acc.login();
     return status.ok && (0, email_events.I3)(acc), status;
    }(request.email).then(sendResponse), !0;

   case "logout-from-single-account":
    response = function(email) {
     let acc = account_list.CM(email);
     return acc && acc.logout(), !0;
    }(request.email);
    break;
   ...
   case "remove-account":
    response = function(email) {
     let status = {
      wasOutlook: !1
     }, acc = account_list.CM(email);
     return acc && (status.wasOutlook = mail_providers.px(acc.config), acc.deleteAccount(), 
     (0, email_events.bT)(acc)), status;
    }(request.email);
    break;

   case "send-feedback":
    request.text, response = !0;
    break;

   case "compose-message":
    response = function(email) {
     const acc = account_list.CM(email);
     mail_providers.bV(acc) ? (0, webapp_start.g0)(acc, "mail_compose", []) : acc.composeUrl && (0, 
     loadpage.eM)(acc.composeUrl);
    }(request.email);
    break;

   case "compose-mailto-message":
    response = function(params) {
     const acc = account_list.vW();
     if (!acc) return chrome.tabs.create({
      url: go(config.w.login.createAccountURLWeb),
      active: !0
     }), {
      ok: !0
     };
     if (mail_providers.bV(acc)) {
      let iacp = {};
      params.to && (iacp.to = [ params.to ]), params.cc && (iacp.cc = [ params.cc ]), 
      params.bcc && (iacp.bcc = [ params.bcc ]), params.subject && (iacp.subject = params.subject), 
      params.body && (iacp.body = params.body), (0, util.YI)([ iacp ]), (0, webapp_start.g0)(acc, "mail_compose", [ iacp ]);
     } else if (mail_providers.Q3(acc)) {
      let url = acc.composeUrl;
      if (!url) return;
      params.to && (url = url.concat("&to=" + encodeURIComponent(params.to))), params.cc && (url = url.concat("&cc=" + encodeURIComponent(params.cc))), 
      params.bcc && (url = url.concat("&bcc=" + encodeURIComponent(params.bcc))), params.subject && (url = url.concat("&subject=" + encodeURIComponent(params.subject))), 
      params.body && (url = url.concat("&body=" + encodeURIComponent(params.body))), console.error(url), 
      (0, loadpage.eM)(url);
     } else if (mail_providers.Rz(acc)) {
      let url = acc.composeUrl;
      if (!url) return;
      params.to && (url = url.concat("&to=" + encodeURIComponent(params.to))), params.cc && (url = url.concat("&cc=" + encodeURIComponent(params.cc))), 
      params.bcc && (url = url.concat("&bcc=" + encodeURIComponent(params.bcc))), params.subject && (url = url.concat("&subject=" + encodeURIComponent(params.subject))), 
      params.body && (url = url.concat("&body=" + encodeURIComponent(params.body))), console.error(url), 
      (0, loadpage.eM)(url);
     } else (0, util.YI)("!!! compose: unknown account type");
     return {
      ok: !0
     };
    }(request.params);
   ...
   case "open-message":
    response = (0, open_message.G)(request.email, request.mid, request.url);
    break;

   case "delete-message":
    response = (0, delete_message.R)(request.email, request.mid);
    break;

   case "mark-read-message":
    email = request.email, mid = request.mid, response = void account_list.CM(email).markAsRead(mid);
    break;

   case "open-options-page":
    (0, util.Ig)(), response = chrome.runtime.lastError;
    break;

   case "open-options-email-tab":
    const handshakeHandler = ack => {
     "open-options-tab-ack" === ack.id && (chrome.runtime.sendMessage({
      id: "open-options-email-tab",
      email: request.email
     }, (_ => !0)), chrome.runtime.onMessage.removeListener(handshakeHandler));
    };
    chrome.runtime.onMessage.addListener(handshakeHandler), (0, util.Ig)(), response = chrome.runtime.lastError;
    break;

   case "open-webmail":
    response = (0, open_webmail.O)(request.email, request.target);
    break;

   case "open-go-link":
    response = function(key, target = "tab") {
     if (!config.w[key]) return (0, util.YI)("${key}: go-link not found"), "#";
     const url = go(config.w[key]);
     chrome.tabs.create({
      url,
      active: !0
     });
    }(request.key, request.target);
    break;

   case "request-badge-state":
    (0, observer.hb)("mail-status-request", {
     successCallback: summary => updateBadge(summary)
    });
    break;

   case "start-webapp":
    response = startWebappFromAction(request.action, request.params);
    break;
  ...
  function productTypeCode() {
   return mailCheckTypeCodes.amo;
  }
  function isAIBDisabled() {
  ...
  async function isBrandDSP() {
   {
    ...
    let dsp = engines.find((e => e.isDefault));
    return dsp && (result = 1 === DSP_NAMES[dsp.name.toLowerCase()]), result;
   }
  }
  async function sendEvent(payload, callback) {
   return fetch(config.w.aib2.pingURL, {
    method: "POST",
    credentials: "omit",
    headers: {
    ...
    (0, util.YI)(`aib2: response ok=${response.ok}`), response.ok && callback && callback();
   })).catch((error => {
    (0, util.YI)(`aib2: error=${error}`);
   }));
  }
  function sendStartEvent() {
   if (isAIBDisabled()) return;
   sendEvent({
    webEventData: {
     addOnInfo: {
      addOnName: "mailcheck",
      ...
      addOnVariant: productTypeCode()
     },
     browserInfo: {
      browserLanguage: (0, util.B7)()
     },
     clientEventData: {
      businessEventType: "initialize",
      clientTimestamp: (new Date).getTime() / 1e3,
      softwareName: "mailcheck",
      softwareVersion: chrome.runtime.getManifest().version,
      brand: "webde",
      applicationArea: "addon",
      contentLanguage: (0, util.B7)(),
      contentCountry: (0, util.PM)(),
      userHttpRequest: {},
      variantInfo: {
       userSegment: storage.M1.get("class")
      },
      clientInfo: {},
      ...
      trackingSoftware: {
       tswName: "mailcheck",
       tswVersion: chrome.runtime.getManifest().version
      }
     },
     pageUrl: "",
     pageViewId: esm_browser_v4()
    },
    userInteractionInfo: {
     componentName: "mailcheck"
    }
   }).then((_ => {})).catch((r => console.error(r)));
  }
  async function setUninstallURL(disabled = !1) {
   if (chrome.runtime.setUninstallURL) {
    const url = await async function(disabled = !1) {
     const url = new URL(config.w.aib.uninstallURL);
     if (url.searchParams.set("t", productTypeCode()), disabled) return url.href;
     const summary = account_list.Nx().summary;
     url.searchParams.set("ac", summary.accountCount), url.searchParams.set("li", summary.isLoggedIn);
     const installDate = new Date(storage.M1.get("installtime") || 0).toISOString().split("T")[0];
     url.searchParams.set("id", installDate);
     const lastAIB = new Date(storage.M1.get("aib_daily") || 0).toISOString().split("T")[0];
     url.searchParams.set("la", lastAIB), url.searchParams.set("3p", summary.thirdPartyCount), 
     url.searchParams.set("b", "webde"), url.searchParams.set("m", storage.M1.get("class")), 
     url.searchParams.set("v", chrome.runtime.getManifest().version), url.searchParams.set("k", storage.M1.get("kid"));
     let brandDSP = await isBrandDSP();
     return url.searchParams.set("s", brandDSP ? 1 : 0), url.href;
    }(disabled);
    chrome.runtime.setUninstallURL(url);
   }
  }
  async function buildDailyEvent() {
   const summary = account_list.Nx().summary, installDate = new Date(storage.M1.get("installtime") || 0).toISOString().split("T")[0], lastAIB = new Date(storage.M1.get("aib_daily") || 0).toISOString().split("T")[0];
   let brandDSP = await isBrandDSP();
   return {
    webEventData: {
     addOnInfo: {
      ...
      addOnVersion: chrome.runtime.getManifest().version,
      addOnVariant: productTypeCode(),
      addOnKid: storage.M1.get("kid"),
      addOnInstallDate: installDate,
      addOnAccountsCount: summary.accountCount,
      addOnAccountsLoggedInCount: summary.isLoggedIn,
      addOnAccountsExternalCount: summary.thirdPartyCount,
      addOnRequestDate: lastAIB,
      addOnDefaultSearch: brandDSP
     },
     browserInfo: {
      browserLanguage: (0, util.B7)()
     },
     clientEventData: {
      businessEventType: "timing",
      clientTimestamp: (new Date).getTime() / 1e3,
      softwareName: "mailcheck",
      softwareVersion: chrome.runtime.getManifest().version,
      brand: "webde",
  ...
  async function build7DaysEvent() {
   let ev = await buildDailyEvent();
   return ev.userInteractionInfo.componentPath = "7d", ev;
  }
  async function build30DaysEvent() {
   let ev = await buildDailyEvent();
   return ev.userInteractionInfo.componentPath = "30d", ev;
  }
  function aib() {
   async function _aib(prefname, intervalMS, eventBuilder) {
    if ((storage.M1.get(`aib_${prefname}`) || 0) > new Date - intervalMS) return;
    const event = await eventBuilder();
    await sendEvent(event, (() => {
     storage.M1.set(`aib_${prefname}`, (new Date).getTime());
    }));
   }
   const isDisabled = isAIBDisabled();
   if (setUninstallURL(isDisabled).then((_ => {})), isDisabled) return;
   const dims = (0, util.c$)(24);
   Promise.all([ _aib("daily", dims, buildDailyEvent), _aib("weekly", 7 * dims, build7DaysEvent), _aib("monthly", 30 * dims, build30DaysEvent) ]).then((() => !0));
  }
  function aib_site_identity_onMessage(request, sender, sendResponse) {
   if ("get-aib-identity" === request.id) return async function() {
    const summary = account_list.Nx().summary, installDate = new Date(storage.M1.get("installtime") || 0).toISOString().split("T")[0], lastAIB = new Date(storage.M1.get("aib_daily") || 0).toISOString().split("T")[0];
    let brandDSP = await isBrandDSP();
    return {
     addOnInfo: {
  ...
  function sendInstallEvent() {
   if (isAIBDisabled()) return;
   if (0 != (storage.M1.get("install_event_sent") || !1)) return;
   sendEvent({
    webEventData: {
     addOnInfo: {
      addOnName: "mailcheck",
      ...
      addOnVariant: productTypeCode(),
      addOnKid: storage.M1.get("kid"),
      addOnInstallDate: (new Date).toISOString().split("T")[0]
     },
     browserInfo: {
      browserLanguage: (0, util.B7)()
     },
     clientEventData: {
      businessEventType: "install",
      clientTimestamp: (new Date).getTime() / 1e3,
      softwareName: "mailcheck",
      softwareVersion: chrome.runtime.getManifest().version,
      brand: "webde",
    ...
    storage.M1.set("install_event_sent", !0);
   })).then((_ => {})).catch((r => console.error(r)));
  }
  function aib2_init() {
   if (config.w.aib2 && config.w.aib2.pingURL) try {
    isAIBDisabled() || chrome.runtime.onMessage.addListener(aib_site_identity_onMessage), 
    (0, util.cu)(sendStartEvent, null, (0, util.YA)(3)), (0, util.cu)(sendInstallEvent, null, (0, 
    util.YA)(5)), (0, util.cu)(aib, null, (0, util.YA)(7)), (0, util.tS)(aib, null, (0, 
    util.Gx)(15));
   } catch (e) {
    (0, util.YI)(e), (0, util.Mc)(e);
   } else (0, util.YI)("missing aib2 config for brand webde");
  }
  function _setUrlParam(url, key, value) {
   let u = new URL(url);
   return u.searchParams.set(key, value), u;
  }
  function backtab_ads_onMessage(request, sender) {
   if ("bta-open-tab" !== request.id) return !1;
   chrome.tabs.update(sender.tab.id, {
    url: request.target
   });
   let targetUrl = /^moz-extension:\/\//.test(sender.tab.url) ? _setUrlParam(config.w.searchReferrer, "src", "tb_newtab_ff") : function(url) {
    let u = _setUrlParam(url, "comp", "web_backtab_ads"), src = u.searchParams.get("src");
    return /^tb_backtab_/.test(src) && u.searchParams.delete("src"), u;
   }(sender.tab.url);
  ...
  const browserActionMenu = {
   id: "ba-options",
   title: chrome.i18n.getMessage("context_menu_options_label"),
   ...
   id: "cm-search",
   title: chrome.i18n.getMessage("context_menu_search_label"),
   contexts: [ "page", "image", "link", "selection" ],
   onclick: info => {
    let url = go(config.w.cm.searchURL) + (info.selectionText || "");
    (0, loadpage.eM)(url);
   }
  }, switchOnOff = state => {
   state ? chrome.contextMenus.create(searchMenu, (_ => {
    chrome.runtime.lastError;
   })) : chrome.contextMenus.remove(searchMenu.id, (_ => {
    chrome.runtime.lastError;
   }));
  };
  function context_menu_mailcheck_init() {
   chrome.contextMenus.create(browserActionMenu);
   !function(enabled = !0) {
    switchOnOff(enabled);
   }((storage.fF.smembers("general") || []).indexOf("search_context_menu") > -1);
  }
  var email_status = __webpack_require__(2184);
  __webpack_require__(9194);
  chrome.runtime.getURL("images/wallpaper.jpg");
  var ext_update_available = __webpack_require__(7683), preload = __webpack_require__(4130);
  async function ext_lifecycle_onUpdated(pv) {
   await new Promise(((resolve, reject) => {
    (0, util.YI)("--- enter migration phase");
    try {
     resolve();
    } catch (e) {
     (0, util.YI)("--- migration failed"), (0, util.YI)(e), resolve();
    }
    (0, util.YI)("--- leave migration phase");
   }));
  }
  async function initStats() {
   let wasFirstRun = !1;
   if (storage.M1.get("installtime") || (wasFirstRun = !0, storage.M1.set("installtime", (new Date).setMinutes(0, 0, 0)), 
   set_option_setOption("email_preview", !0), set_option_setOption("netid_suggest", util.pQ), 
   set_option_setOption("privacy_usage_data", !0), set_option_setOption("privacy_usage_data_tcf", !1), 
   storeOption("search_last_tab", !1), set_option_setOption("search_context_menu", !1), 
   set_option_setOption("search_from_url_bar", !1)), storage.M1.get("class") || (wasFirstRun = !0, 
   storage.M1.set("class", Math.floor(100 * Math.random()) + 1)), !storage.M1.get("kid")) {
    wasFirstRun = !0;
    const kid = await function() {
     const KID_RE = /^https?\:\/\/.+#\.(.+)/;
     return new Promise((resolve => {
      let kid = "#.undef.undef.undef.undef";
      chrome.tabs.query({}, (function(tabs) {
       for (let i = 0; i < tabs.length; i++) if (tabs[i].url) {
        let match = KID_RE.exec(tabs[i].url);
    ...
    storage.M1.set("kid", kid);
   }
   return wasFirstRun;
  }
  chrome.runtime.onInstalled.addListener((details => {
   (0, util.YI)(`got ${details.reason} event; details=`, details), "install" === details.reason || "update" === details.reason && ext_lifecycle_onUpdated(details.previousVersion);
   ...
   ext_update_available.X.available = preload.lt(current, newest);
  }));
  var webapp_nav = __webpack_require__(5476);
  const bootstrapSecondaryComponents = async wasFirstRun => (webapp_nav.T(), context_menu_mailcheck_init(), 
  search_page_action_switchActivation((storage.fF.smembers("general") || []).indexOf("search_from_url_bar") > -1), 
  chrome.pageAction.onClicked.addListener(onClicked), chrome.tabs.onUpdated.addListener(search_page_action_onTabUpdated), 
  chrome.tabs.onRemoved.addListener(onTabRemoved), chrome.tabs.onActivated.addListener(onTabActivated), 
  chrome.runtime.onMessage.addListener(backtab_ads_onMessage), last_tab_init(!wasFirstRun), 
  chrome.runtime.onConnect.addListener(onConnectHandler), mailto_handler_switchActivation((storage.fF.smembers("general") || []).indexOf("mailto_handler") > -1), 
  function() {
   if (!util.pQ) return;
   netid_switchActivation((storage.fF.smembers("general") || []).indexOf("netid_suggest") > -1);
  }(), wasFirstRun);
  (async () => {
   await storage.Ts();
  ...
  })().then((wasFirstRun => (async wasFirstRun => ((0, util.cu)(aib2_init), email_events.Ts(), 
  email_status.T(), browser_action.Ts(wasFirstRun && !0), wasFirstRun))(wasFirstRun))).then((wasFirstRun => bootstrapSecondaryComponents(wasFirstRun))).then((wasFirstRun => account_list.l$(null, wasFirstRun))).catch((reason => console.error("fatal error during bootstrap", reason)));
 })();
})();