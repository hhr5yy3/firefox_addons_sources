...
async function openUnreadNotifications() {
	await showToast(async updateToast => {
		...
		if (notifications.length > limit) {
			...
			// Update the UI too
			expectElement('.AppHeader-button--hasIndicator').classList.remove('AppHeader-button--hasIndicator');
		}
	}, {
