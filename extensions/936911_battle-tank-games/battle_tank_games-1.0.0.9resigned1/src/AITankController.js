function AITankController(tank, random, spriteContainer) {
	...
	this._eventManager.addSubscriber(this, [Tank.Event.DESTROYED, PowerUpHandler.Event.FREEZE, FreezeTimer.Event.UNFREEZE]);
	...
	this._eventManager.fireEvent({
		'name': AITankController.Event.CREATED,
		'controller': this
	});
...
AITankController.prototype.destroy = function() {
	...
	this._eventManager.fireEvent({
		'name': AITankController.Event.DESTROYED,
		'controller': this
	});
};
