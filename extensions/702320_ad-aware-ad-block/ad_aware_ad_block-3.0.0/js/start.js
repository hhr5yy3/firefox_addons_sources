...
import './commands.js';
import './messaging.js';
import '../lib/adaware-messaging.js';
import './storage.js';
import './tab.js';
import './ublock.js';
import './utils.js';
...
const onNetWhitelistReady = (netWhitelistRaw, adminExtra) => {
    netWhitelistRaw = netWhitelistRaw.concat(µb.netWhitelistBackup);
...
const onFirstFetchReady = (fetched, adminExtra) => {
    ...
    µb.blockDangerousUrlsStatus = fetched.blockDangerousUrlsStatus;
