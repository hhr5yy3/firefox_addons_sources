...
function trustedSuppressNativeMethod(
    ...
    let ready = function()
    {
        ...
        for (let rule of scriptletRules)
        {
            ...
            {
                if (scriptlet.name === rule.functionName || (scriptlet.aliases && scriptlet.aliases.includes(rule.functionName)))
                    callFunc(rule.arguments, scriptlet.fn);
            }
        }
    }
