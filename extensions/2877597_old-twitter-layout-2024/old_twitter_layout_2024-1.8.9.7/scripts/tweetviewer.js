class TweetViewer {
    constructor(user, tweetData) {
        ...
        chrome.storage.local.get(['viewedtweets'], (result) => {
            ...
            chrome.storage.local.set({ viewedtweets: result.viewedtweets });
        });
        ...
        if(tweetBodyQuote) {
            ...
            if(tweetQuoteTranslate) {
                ...
                tweetQuoteTranslate.addEventListener('click', async e => {
                    ...
                    const { hideOriginalLanguages } = await chrome.storage.local.get('hideOriginalLanguages');
