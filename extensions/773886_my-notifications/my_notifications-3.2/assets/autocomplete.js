(function (global, factory) {
    ...
    function autocomplete(settings) {
        ...
        function resizeEventHandler() {
            if (actualWindowSize[0] !== window.innerWidth || actualWindowSize[1] !== window.innerHeight) {
                actualWindowSize[0] = window.innerWidth
                actualWindowSize[1] = window.innerHeight
                updateIfDisplayed()
            }
        }
