import{b as d}from"./chunk-R24F5SOK.js";import{_ as c,o as a,rb as C}from"./chunk-KWIQ74SK.js";import{t as w}from"./chunk-XEZHZYHW.js";import{b as m,c as T}from"./chunk-D6DH2FN4.js";import{c as y}from"./chunk-QLNQOJCN.js";import{m as g}from"./chunk-QLCKU4H4.js";import{A as p,ta as x}from"./chunk-OJ65X4PZ.js";import{a as b}from"./chunk-335V6TFQ.js";import{f as k,h as t,n as e}from"./chunk-XJB76KNJ.js";t();e();t();e();t();e();var B=k(b()),i=class extends B.default.Component{constructor(o){super(o),this.state={error:null}}static getDerivedStateFromError(o){return o instanceof Error?{error:o}:typeof o=="string"?{error:new Error(o)}:{error:new Error}}componentDidCatch(o,s){o instanceof Error&&x.captureError(o,"generic")}render(){return this.state.error?typeof this.props.fallback=="function"?this.props.fallback(this.state.error):this.props.fallback:this.props.children}};var r=k(b());var F="Unknown Error",S="Looks like you ran into an unknown error. Please close Phantom and try again.",A="Close",E=a(C).attrs({wordBreak:"break-word",color:"#777777",size:16,lineHeight:20.8,maxWidth:"400px"})``,h=a.a.attrs({target:"_blank",rel:"noopener noreferrer"})`
  display: flex;
  align-items: center;
  margin: 0 auto;
  color: #ab9ff2;
...
//# sourceMappingURL=chunk-3C7O5H7L.js.map
