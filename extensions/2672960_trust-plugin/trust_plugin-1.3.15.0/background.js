...
let background = (function () {
    const _ID = "trust.plugin.extension.background";
    const _EOF = "-1";
    ...
    let nmh = (function () {
        ...
        const _HOST = "firefox.trust.plugin";
        const _OBSOLETE_HOST = "trust.plugin";
        const _CONFLICT_HOST = "firefox.gosuslugi.plugin";
        const _OBSOLETE_CONFLICT_HOST = "gosuslugi.plugin";
    ...
    let ws = ( function() {
          const _ID = "trust.plugin.extension.ws";
    ...
    let _request = function (message) {
        ...
        if (_ban && !mandatory) {
            ...
            error_handler.set_message_error(message, null, "Работа TrustPlugin невозможна. Обновите версию приложения");
        ...
        */
        if (typeof _notify[reason] === 'undefined' || !!message) {
            ...
            */
            ...
            switch (reason) {
                ...
                case 'endSign':                    
                    ...
                    break;
                case 'upgrade':
                    options.message = "Ваша версия TrustPlugin устарела. Рекомендуется установить новую версию приложения";
                    options.buttons = [{ title: "Скачать обновление" }];
                    break;
                case 'install':
                    options.message = "Для полноценной работы TrustPlugin необходима установка приложения";
                ...
                case 'unsupportedVersion':
                    options.message = "Работа TrustPlugin невозможна. Обновите версию приложения";
                    options.buttons = [{ title: "Скачать обновление" }];
                    break;
            ...
            */
            if ('mozilla' == _BROWSER) {
                if ('upgrade' == reason) {
                    options.message = "Ваша версия TrustPlugin устарела.\nНажмите на окно, чтобы скачать новую версию приложения";
                }
                if ('install' == reason) {
                    options.message = "Для работы TrustPlugin необходима установка приложения.\nНажмите на окно, чтобы скачать приложение";
                }
