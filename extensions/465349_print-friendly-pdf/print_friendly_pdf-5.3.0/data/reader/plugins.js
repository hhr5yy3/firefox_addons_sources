...
chrome.storage.onChanged.addListener((ps) => {
  ...
  if ("./plugins/tip/core.js" in ps) {
    import("./plugins/tip/core.js").then((o) =>
      o[ps["./plugins/tip/core.js"].newValue ? "enable" : "disable"]()
    );
  }
  if ("./plugins/doi/core.js" in ps) {
    import("./plugins/doi/core.js").then((o) =>
      o[ps["./plugins/doi/core.js"].newValue ? "enable" : "disable"]()
    );
  }
  // if ("./plugins/note/core.js" in ps) {
  //   import("./plugins/note/core.js").then((o) =>
  //     o[ps["./plugins/note/core.js"].newValue ? "enable" : "disable"]()
  //   );
  // }
  if ("./plugins/note/notify.js" in ps) {
    import("./plugins/note/notify.js").then((o) =>
      o[ps["./plugins/note/notify.js"].newValue ? "enable" : "disable"]()
    );
  }
});
