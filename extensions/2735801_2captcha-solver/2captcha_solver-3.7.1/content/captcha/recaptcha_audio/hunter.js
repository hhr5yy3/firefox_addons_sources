(() => {
    ...
    function createButtonStart(widgetId, audioElement) {
        ...
        buttonStart.classList = 'button-holder twocaptcha-button-holder';
        ...
        document.querySelector('.twocaptcha-button-holder button').addEventListener('click', async () => {
    ...
    const addWidgetInfo = function (body, widgetId) {
        document.querySelector('.twocaptcha-button-holder').style = 'animation: blink 1s linear infinite;';
