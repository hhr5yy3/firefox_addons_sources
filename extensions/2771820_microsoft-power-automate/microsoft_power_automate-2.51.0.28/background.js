(() => {
    ...
    var __webpack_modules__ = {
        ...
        88069: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            const communicator_to_native_host_1 = __webpack_require__(89530), background_v1_1 = __webpack_require__(75664), background_v2_1 = __webpack_require__(34968), background_v3_1 = __webpack_require__(56549), logger_1 = __webpack_require__(88901), set_browser_api_1 = __webpack_require__(92025), negotiationFailedError_1 = __webpack_require__(50063);
            ...
            communicator.on("LoadScriptsRequest", (request => {
                ...
                try {
                    ...
                    checkScriptVersion(loadRequest.apiVersion, 4, "API"), null == backgroundScript || backgroundScript.dispose(), 
            ...
            chrome.runtime.onInstalled.addListener((({reason}) => __awaiter(void 0, void 0, void 0, (function*() {
                switch (reason) {
                  case "install":
                    {
        ...
        28230: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            const execute_with_timeout_1 = __webpack_require__(87555);
            class Frame {
                constructor(init) {
                ...
                isAt(ordinal) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        try {
                            return (yield (0, execute_with_timeout_1.executeWithTimeout)(Frame.ordinalTimeout, chrome.tabs.executeScript(this.tabId, {
                                frameId: null !== (_a = this.id) && void 0 !== _a ? _a : 0,
                                matchAboutBlank: !0,
                                code: `var result = false;\n                            if (window.parent !== window && window.parent !== null && window.parent.frames.length > ${ordinal}) {\n                                result = window.parent.frames[${ordinal}] === window;\n                            }\n                            result`
                            }), [ !1 ]))[0];
                        } catch (_c) {
                            return !1;
                        }
        ...
        75664: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            class BackgroundV1 {
                ...
                static onNavigateToUrl(request) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        const url = urlSanitizer.sanitizeUrl(request.url);
                        return yield chrome.tabs.update(request.tabId, {
                            url
                        }), !0;
                    }));
                ...
                injectScripts(tabId) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        try {
                            return yield chrome.tabs.executeScript(tabId, {
                ...
                unRegisterHostEvents() {
                    ...
                    this.communicatorToNative.removeHandler("IsIEModeTabRequest");
                }
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        try {
                            return (yield chrome.tabs.executeScript(this.id, {
                                code: "globalThis._padScriptLoaded_E2C4773F"
                            }))[0] || (logger_1.Logger.log("Injecting scripts to main frame at tab: ", this.id), 
                            yield chrome.tabs.executeScript(this.id, {
                                file: this.contentScriptPath,
                                matchAboutBlank: !0,
                                frameId: frame_1.Frame.MainFrame
                            }), yield chrome.tabs.executeScript(this.id, {
                ...
                injectScriptsToSubFrame(frameId) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        return (0, execute_with_timeout_1.executeWithTimeout)(TabApi.injectionTimeOut, function() {
                            return __awaiter(this, void 0, void 0, (function*() {
                                try {
                                    return (yield chrome.tabs.executeScript(tab.id, {
                                        frameId,
                                        matchAboutBlank: !0,
                                        code: "globalThis._padScriptLoaded_E2C4773F"
                                    }))[0] || (logger_1.Logger.log("Injecting scripts to frame: ", frameId, " at tab: ", tab.id), 
                                    yield chrome.tabs.executeScript(tab.id, {
                                        file: tab.contentScriptPath,
                                        matchAboutBlank: !0,
                                        frameId
                                    }), yield chrome.tabs.executeScript(tab.id, {
                                        file: tab.apiScriptPath,
                                        matchAboutBlank: !0,
                                        frameId
            ...
            class TabApi {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        return logger_1.Logger.groupLoggingAsync((() => __awaiter(this, void 0, void 0, (function*() {
                            switch (request.name) {
                              ...
                              case "GetElementsRequest":
                                return this.getElements(TabApi.validateCssSelectorContentScriptRequest(request));
                              ...
                              case "DidElementsChangeFromObserverRequest":
                                return this.didElementsChangeFromObserver(request);
                ...
                getElements(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        frameSelectors.pop();
                        const response = yield this.defaultHandler(request);
                        if (void 0 !== (null == response ? void 0 : response.result) && null !== (null == response ? void 0 : response.result)) {
                            const elements = response.result.map((c => (c.cssSelectorString = [ ...frameSelectors, c.cssSelectorString ].join(" > "), 
                            c)));
                            return new response_1.Response(request, elements);
                        }
                        return response;
                    }));
                }
                ...
                didElementsChangeFromObserver(request) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        const frames = yield this.getAllFrames(), elementsChanged = (yield Promise.all(frames.map((({id}) => __awaiter(this, void 0, void 0, (function*() {
                            const response = yield this.defaultHandler(Object.assign(Object.assign({}, request), {
                                frameId: id
                            }));
                            return !(!response || response.error) && response.result;
                        })))))).some((result => result));
                        return new response_1.Response(request, elementsChanged);
                    }));
                }
            }
            exports.TabApi = TabApi, TabApi.injectionTimeOut = 500, TabApi.noframeErrorCode = 11;
        ...
        92025: (__unused_webpack_module, exports, __webpack_require__) => {
            ...
            const logger_1 = __webpack_require__(88901);
            exports.setBrowserApi = function() {
                logger_1.Logger.log("Set browser for Firefox usage"), chrome = browser;
            };
        }
