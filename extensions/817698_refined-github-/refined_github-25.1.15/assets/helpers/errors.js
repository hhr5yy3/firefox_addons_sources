...
function parseFeatureNameFromStack(stack = new Error('stack').stack) {
...
export { catchErrors, disableErrorLogging, logError, parseFeatureNameFromStack };
