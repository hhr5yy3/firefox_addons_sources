    ...
    function scrollableFeed($rootScope, $timeout, $stateParams, trackService, localPageSize, serverPageSize, userService, fetchService, sources, searchService) {
        ...
        return {
            ...
            link: function($scope, el, attrs) {
                ...
                var user = $rootScope.currentSource?.user;
                ...
                $scope.jobsCard = {
                    ...
                    goToJobs: (e) => {
                        ...
                        $rootScope.$state.go('feed', { name: 'jobs', sort: 'created' }, { reload: true });
                    },
                    hideJobs: (e) => {
                        e.preventDefault();
                        ...
                        localStorage.disableJobsCard = true;
                ...
                function loadMore() {
                    ...
                    if (past && source && !loadingFromServer && !loadComplete) {
                        ...
                        if (source === 'search') {
                            ...
                            fetcher = fetchService.fetchFromServer(source, serverPageSize, current, filter, user)
                        }
