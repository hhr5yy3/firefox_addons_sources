...
window.document.addEventListener('click', function (_ref) {
  var target = _ref.target;

  /*const parent = target.closest('[data-click][role="button"]');
  if (parent && parent.getAttribute('aria-label') && parent.getAttribute('aria-label').includes('OPEN NIMBLE APP')) {
      sendMessageToExtension('NIMBLE_EXT__GMAIL_ADDON_CLICK');
  }*/
  sendMessageToExtension('NIMBLE_EXT__GMAIL_ADDON_CLICK');
});
})();
