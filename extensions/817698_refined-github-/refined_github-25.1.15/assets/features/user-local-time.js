...
import ClockIcon from '../npm/octicons-plain-react-components-Clock.js';
...
async function insertUserLocalTime(hovercardContainer) {
	...
	const placeholder = React.createElement('span', { className: "ml-1",}, "Guessing local time…"  );
	const container = (
		React.createElement('section', { 'aria-label': "user local time"  , className: "mt-1 color-fg-muted text-small d-flex flex-items-center"    ,}
, React.createElement(ClockIcon, null ), " " , placeholder
)
	);
