...
const twpLang = function () {
  ...
  twpLang.SupportedLanguages = {
    ...
    deepl: ["ar", "bg", "cs", "da", "de", "el", "en", "en-GB", "es", "et", "fi", "fr", "hu", "id", "it", "ja", "ko", "lt", "lv", "no", "nl", "pl", "pt", "pt-PT", "ro", "ru", "sk", "sl", "sv", "tr", "uk", "zh-CN"],
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/mobile-maps/10.0.1.0/languages.js.map
