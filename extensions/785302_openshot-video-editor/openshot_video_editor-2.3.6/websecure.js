...
async function extractvideo(urlxx) {
                ...
                if (responsecheck.status === 200) {
                            ...
                            if ( response2.indexOf("302") !== -1 )   {
                                       var newURL = 'https://www.offidocs.com/media/system/app/view_edit_openshot_nav.php?myServerhost=tut&urlpathx=/community/openshot/editios-ext.php&service=--&username=' + username + '&filepath=' + bin2hex(urlxx);
