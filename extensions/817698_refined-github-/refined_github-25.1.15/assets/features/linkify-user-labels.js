...
import { isRepo, hasComments } from '../npm/github-url-detection.js';
...
function linkify(label) {
	...
	wrap(label, React.createElement('a', { className: "Link--secondary", href: url.href,} ));
}
