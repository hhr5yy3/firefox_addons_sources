...
function appendCertificates(container) {
     ...
     crypto.certificates( request, function (message) {
...
function deleteCertificate(certificate) {
     ...
     let file = new FileInfo(certificateContent(certificate), "");

     crypto.deleteCertificate(file, function (message) {
...
function addCertificate() {
     ...
     let request = {};
     request.certificate = new FileInfo(base64, "");
     request.container = "";

     crypto.addCertificate(request, function (message) {
