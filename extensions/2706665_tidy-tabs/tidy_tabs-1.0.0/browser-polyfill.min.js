      ...
      const d = a => a && "object" == typeof a && "function" == typeof a.then, e = (b, c) => (...d) => {
        ...
        return new Promise(((f, g) => {
          if (b.fallbackToNoCallback) try {
            ...
            c[a](...d), b.fallbackToNoCallback = !1, b.noCallback = !0, f();
        ...
        return new Proxy(e, {
          ...
          get(e, f) {
            ...
            if ("function" == typeof k) {
              if ("function" == typeof b[f]) k = h(a, a[f], b[f]); else if (i(c, f)) {
                let b = g(f, c[f]);
                k = h(a, a[f], b);
              } else k = k.bind(a);
            } else if ("object" == typeof k && null !== k && (i(b, f) || i(c, f))) k = j(k, b[f], c[f]); else if (i(c, "*")) k = j(k, b[f], c["*"]); else return Object.defineProperty(d, f, {
              configurable: !0,
              enumerable: !0,
              get() {
                return a[f];
