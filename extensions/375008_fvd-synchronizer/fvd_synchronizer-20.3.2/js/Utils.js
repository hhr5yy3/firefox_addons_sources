if(typeof _b != "function"){// ff union
    function _b( v ){
      if( typeof v == "boolean" ){
        return v;
      }
...
if(typeof _isb != "function"){// ff union
    function _isb( v ){
      if( typeof v == "boolean" ){
        return true;
      }
...
if(typeof _r != "function"){// ff union
    function _r( v ){
...
if(typeof SimpleBench != "function"){// ff union
...
if(typeof EventEmitter != "function"){// ff union
  ...
  Utils.prototype = {
    ...
    getOptionsPagesOpenedTabsIds: function(cb) {
      ...
      chrome.tabs.query({
        ...
        for(var i = tabs.length-1; i >= 0; i--) if( String(tabs[i].url).indexOf(url) === -1 ) tabs.splice(i, 1); // ff
    ...
    isVersionChanged: function(){
      ...
      if( this._isVersionChanged ){
        ...
        if(chrome.app){// ff replace for chrome.management.version since ff 51
    ...
    isVisibleElem: function( elem ){
      ...
      var currentTopStart = document.body.scrollTop || window.scrollY;
