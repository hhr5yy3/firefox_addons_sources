	...
	(function(){
		...
		Prefs.prototype = {
			...
			_defaults: {
				...
				"bookmarks.enable_autosync": false,//true,
			...
			set: function(name, value){
				...
				if ( _r(oldValue) != _r(value) ) {
                    ...
                    if(name == "last_settings_tab_index" && value == "account"){// Task #845
                        this.refresh();
                    }
				}
            ...
            refresh: function(){// Task #845
                ...
                fvdSynchronizer.Utils.getOptionsPagesOpenedTabsIds(function(err, tabsIds) {
                    //console.info("tabsIds", tabsIds);
                    
                    if(tabsIds && tabsIds.length) {
                        
                        for(var i in tabsIds){
                            browser.tabs.sendMessage(tabsIds[i], {action: "refreshIframe"});
                        }
