...
import { isLoggedIn, hasComments } from '../npm/github-url-detection.js';
...
const isIssueIneditable = memoize(
	...
	async (_signal) => elementExists('.js-pick-reaction:first-child') && !await userIsModerator(),
	{
		cache: new WeakMap(),
	},
);

async function addQuickEditButton(commentDropdown, {signal}) {
