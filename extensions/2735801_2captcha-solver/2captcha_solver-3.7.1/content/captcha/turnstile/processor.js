CaptchaProcessors.register({
    ...
    onSolved: function(widget, answer) {
        ...
        $(`<div class="twocaptcha-turnstile-helper">
                <input type="hidden" name="token">
            </div>
        `).appendTo(helper);

        document.querySelector('.twocaptcha-turnstile-helper input').value = answer;

        let script = document.createElement("script");
        script.src = chrome.runtime.getURL("content/captcha/turnstile/validate.js");
