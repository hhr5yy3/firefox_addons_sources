$(document).ready(function () {
    ...
    function blur() {
        ...
        console.log('blur', position_blur, 'start', start, 'finish', finish, 'duration', duration);
    ...
    $nsc_video_button_open_trim.on('click', function () {
        ...
        if (!localStorage.videoEditorTrim) {
            $('#nsc_popup_video_trim').show().find('img').attr('src', chrome.runtime.getURL('images/help/trim.gif')).end().find('.nsc-button-primary').on('click', function () {
    ...
    $nsc_video_crop.on('click', function () {
        ...
        if (!localStorage.videoEditorCrop) {
            $('#nsc_popup_video_crop').show().find('img').attr('src', chrome.runtime.getURL('images/help/crop.gif')).end().find('.nsc-button-primary').on('click', function () {
    ...
    $nsc_discard.on('click', function () {
        ...
        if (result) {
            ...
            nimbus_screen.info.file.video.patch = nimbus_screen.info.file.video.last_convert_path;
