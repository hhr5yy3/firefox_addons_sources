  ...
  var initWidget = function(params){
    try {
      widget = new Widget({
        prefix: 'xt-openai-',
        id: 'xt-openai-widget',
        src: chrome.runtime.getURL('html/openai.html?darkmode=' + params.darkMode + '&source=' + params.source),
        parent: document.body,
        draggable: true,
        dragHandleTitle: dragHandleHTML(params.source),
        onReady: function(){
        },
        onShow: function(){},
        onHide: function(){},
