...
MFt.dates = { // Compara datas de dois Object Date
    ...
    daydiff : function(first, second) {
        ...
        // preciso criar uma cópia de first e second para não alterar os dados originais passados
...
MFt.xml = function(obj){
    ...
    var getpost = function(){
        if ('get' in obj && Object.prototype.toString.call(obj.get) === '[object Object]') {
            ...
            xml.open('get', url);
            xml.timeout = Number.isInteger(obj?.timeout) && obj.timeout > 0 ? xml.timeout = obj.timeout : 120000;
        }
...
MFt.bt = function(obj){
    ...
    Object.defineProperties(this, {
        ...
        fontFamily : {
            get : function(){return obj.fontFamily ? obj.fontFamily : 'Muli,Helvetica Neue,Arial,sans-serif'}
        },
        fontSize : {
