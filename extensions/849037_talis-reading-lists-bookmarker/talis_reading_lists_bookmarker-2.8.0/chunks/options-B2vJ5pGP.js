...
import { g as getDefaultExportFromCjs, c as commonjsGlobal, w as we$1, f as fetchTenant, a as getTenantList, u as updateTenant, C as Ci$1 } from "./api-service-BsN8WBnU.js";
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f = reactExports, k = Symbol.for("react.element"), l$1 = Symbol.for("react.fragment"), m$1 = Object.prototype.hasOwnProperty, n$1 = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p$1 = { key: true, ref: true, __self: true, __source: true };
function q(c, a, g) {
...
const OptionsQueryClientProvider = ({
  children
...
var invariant = function(condition, format, a, b, c, d, e2, f2) {
  if (!condition) {
    var error;
    if (format === void 0) {
      error = new Error(
...
const TransitionWrapper = /* @__PURE__ */ React.forwardRef(({
  ...
  const attachRef = (r2) => {
    mergedRef(safeFindDOMNode$1(r2));
  };
...
function _objectWithoutProperties(e2, t2) {
  if (null == e2) return {};
  var o2, r2, i = _objectWithoutPropertiesLoose$2(e2, t2);
...
function getOptionLabel(option, labelKey) {
  ...
  !isString(optionLabel) ? invariant$1(false) : void 0;
  return optionLabel;
}
...
function warn(falseToWarn, message) {
  ...
  warning$1.apply(void 0, [falseToWarn, "[react-bootstrap-typeahead] ".concat(message)].concat(args));
}
...
function escapeStringRegexp(str) {
  !(typeof str === "string") ? invariant$1(false) : void 0;
...
function getMatchBounds(subject, str) {
  ...
  var start2 = matches.index;
  var matchLength = matches[0].length;
  if (COMBINING_MARKS.test(subject)) {
    for (var ii2 = 0; ii2 <= start2; ii2++) {
      if (COMBINING_MARKS.test(subject[ii2])) {
        start2 += 1;
      }
    }
    for (var _ii = start2; _ii <= start2 + matchLength; _ii++) {
...
function getMenuItemId() {
  ...
  return "".concat(id2, "-item-").concat(position);
}
...
var getInputProps = function getInputProps2(_ref) {
  var activeIndex = _ref.activeIndex, id2 = _ref.id, isFocused = _ref.isFocused, isMenuShown = _ref.isMenuShown, multiple = _ref.multiple, onClick = _ref.onClick, onFocus = _ref.onFocus, placeholder = _ref.placeholder, props = _objectWithoutProperties(_ref, _excluded$d);
  return function() {
    var _cx;
    ...
    return _objectSpread$a(_objectSpread$a(_objectSpread$a(_objectSpread$a({
      ...
      "aria-activedescendant": activeIndex >= 0 ? getMenuItemId(id2, activeIndex) : void 0,
      "aria-autocomplete": "both",
      "aria-expanded": isMenuShown,
      "aria-haspopup": "listbox",
      "aria-multiselectable": multiple || void 0,
      "aria-owns": isMenuShown ? id2 : void 0,
...
var Typeahead$1 = /* @__PURE__ */ function(_React$Component) {
  ...
  _createClass(Typeahead2, [{
    ...
    value: function render() {
      ...
      var results = [];
      if (this.isMenuShown) {
        var cb2 = isFunction(filterBy) ? filterBy : defaultFilterBy;
        results = options.filter(function(option) {
          return cb2(option, mergedPropsAndState);
        });
...
function getPlacement(props) {
  var x2 = props.align === "right" ? "end" : "start";
  var y2 = props.dropup ? "top" : "bottom";
  return "".concat(y2, "-").concat(x2);
}
...
function useRootClose$1(ref, onRootClose, _temp) {
  ...
  reactExports.useEffect(function() {
    ...
    if ("ontouchstart" in doc.documentElement) {
      mobileSafariHackListeners = [].slice.call(doc.body.children).map(function(el2) {
        return listen(el2, "mousemove", noop);
      });
    }
    return function() {
...
const t = (t2) => "object" == typeof t2 && null != t2 && 1 === t2.nodeType, e$1 = (t2, e2) => (!e2 || "hidden" !== t2) && ("visible" !== t2 && "clip" !== t2), n = (t2, n2) => {
  ...
  const { scrollMode: c, block: f2, inline: u2, boundary: a, skipOverflowHiddenElements: g } = r2, p2 = "function" == typeof a ? a : (t2) => t2 !== a;
  ...
  for (; t(W2) && p2(W2); ) {
    ...
    null != W2 && W2 === document.body && n(W2) && !n(document.documentElement) || null != W2 && n(W2, g) && w2.push(W2);
  }
  ...
  for (let t2 = 0; t2 < w2.length; t2++) {
    const e3 = w2[t2], { height: n2, width: l2, top: r3, right: i2, bottom: s2, left: d2 } = e3.getBoundingClientRect();
    if ("if-needed" === c && x2 >= 0 && R2 >= 0 && I2 <= H2 && C2 <= b && x2 >= r3 && I2 <= s2 && R2 >= d2 && C2 <= i2) return L2;
    const h2 = getComputedStyle(e3), a2 = parseInt(h2.borderLeftWidth, 10), g2 = parseInt(h2.borderTopWidth, 10), p3 = parseInt(h2.borderRightWidth, 10), W3 = parseInt(h2.borderBottomWidth, 10);
    let T3 = 0, B3 = 0;
    const F3 = "offsetWidth" in e3 ? e3.offsetWidth - e3.clientWidth - a2 - p3 : 0, V3 = "offsetHeight" in e3 ? e3.offsetHeight - e3.clientHeight - g2 - W3 : 0, S2 = "offsetWidth" in e3 ? 0 === e3.offsetWidth ? 0 : l2 / e3.offsetWidth : 0, X2 = "offsetHeight" in e3 ? 0 === e3.offsetHeight ? 0 : n2 / e3.offsetHeight : 0;
    if (m2 === e3) T3 = "start" === f2 ? k2 : "end" === f2 ? k2 - H2 : "nearest" === f2 ? o$1(M2, M2 + H2, H2, g2, W3, M2 + k2, M2 + k2 + v2, v2) : k2 - H2 / 2, B3 = "start" === u2 ? D2 : "center" === u2 ? D2 - b / 2 : "end" === u2 ? D2 - b : o$1(y2, y2 + b, b, a2, p3, y2 + D2, y2 + D2 + E2, E2), T3 = Math.max(0, T3 + M2), B3 = Math.max(0, B3 + y2);
    else {
      T3 = "start" === f2 ? k2 - r3 - g2 : "end" === f2 ? k2 - s2 + W3 + V3 : "nearest" === f2 ? o$1(r3, s2, n2, g2, W3 + V3, k2, k2 + v2, v2) : k2 - (r3 + n2 / 2) + V3 / 2, B3 = "start" === u2 ? D2 - d2 - a2 : "center" === u2 ? D2 - (d2 + l2 / 2) + F3 / 2 : "end" === u2 ? D2 - i2 + p3 + F3 : o$1(d2, i2, l2, a2, p3 + F3, D2, D2 + E2, E2);
      const { scrollLeft: t3, scrollTop: h3 } = e3;
      T3 = 0 === X2 ? 0 : Math.max(0, Math.min(h3 + T3 / X2, e3.scrollHeight - n2 / X2 + V3)), B3 = 0 === S2 ? 0 : Math.max(0, Math.min(t3 + B3 / S2, e3.scrollWidth - l2 / S2 + F3)), k2 += h3 - T3, D2 += t3 - B3;
    }
...
function useItem(_ref) {
  ...
  var _useTypeaheadContext = useTypeaheadContext(), activeIndex = _useTypeaheadContext.activeIndex, id2 = _useTypeaheadContext.id, isOnlyResult = _useTypeaheadContext.isOnlyResult, onActiveItemChange = _useTypeaheadContext.onActiveItemChange, onInitialItemChange = _useTypeaheadContext.onInitialItemChange, onMenuItemClick = _useTypeaheadContext.onMenuItemClick, setItem = _useTypeaheadContext.setItem;
...
var Menu = function Menu2(_ref) {
  var _ref$emptyLabel = _ref.emptyLabel, emptyLabel = _ref$emptyLabel === void 0 ? "No matches found." : _ref$emptyLabel, innerRef = _ref.innerRef, _ref$maxHeight = _ref.maxHeight, maxHeight = _ref$maxHeight === void 0 ? "300px" : _ref$maxHeight, style2 = _ref.style, props = _objectWithoutProperties(_ref, _excluded$1);
  ...
  return (
    ...
    /* @__PURE__ */ React.createElement("div", _extends({}, props, {
      ...
      ref: innerRef,
      role: "listbox",
      style: _objectSpread$1(_objectSpread$1({}, style2), {}, {
        display: "block",
        maxHeight,
        overflow: "auto"
      })
...
var TypeaheadComponent = /* @__PURE__ */ function(_React$Component) {
  ...
  function TypeaheadComponent2() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderMenu", function(results, menuProps, props) {
      var _this$props2 = _this.props, emptyLabel = _this$props2.emptyLabel, id2 = _this$props2.id, maxHeight = _this$props2.maxHeight, newSelectionPrefix = _this$props2.newSelectionPrefix, paginationText = _this$props2.paginationText, renderMenu = _this$props2.renderMenu, renderMenuItemChildren = _this$props2.renderMenuItemChildren;
  ...
  _createClass(TypeaheadComponent2, [{
    ...
    value: function render() {
      var _this2 = this;
      var _this$props4 = this.props, children = _this$props4.children, className = _this$props4.className, instanceRef = _this$props4.instanceRef, open = _this$props4.open, options = _this$props4.options, style2 = _this$props4.style;
      return /* @__PURE__ */ React.createElement(Typeahead$1, _extends({}, this.props, {
        options,
        ref: instanceRef
      }), function(props) {
...
const validSelectedOption = (selectedOptions, tenantCode, region) => {
  if (selectedOptions.length === 0) {
    return false;
  }
  const [selectedOption] = selectedOptions;
  const isValidOption = selectedOption !== OTHER_OPTION && Ci$1(selectedOption);
  const isValidOtherOption = selectedOption === OTHER_OPTION && Boolean(tenantCode) && Boolean(region);
  return isValidOption || isValidOtherOption;
};
const OptionsScreen = () => {
  ...
  const [showAdvancedForm, setShowAdvancedForm] = reactExports.useState(false);
  const [region, setRegion] = reactExports.useState(we$1.EUAPAC);
  const [tenantCode, setTenantCode] = reactExports.useState("");
  const [showSuccessAlert, setShowSuccessAlert] = reactExports.useState(false);
  const [showErrorAlert, setShowErrorAlert] = reactExports.useState(false);
  reactExports.useLayoutEffect(() => {
    const retrieveSelectedTenant = async () => {
      const selectedTenant = await fetchTenant();
      if (!selectedTenant) {
        return;
      }
      setSelectedOptions([selectedTenant]);
      if (selectedTenant.name === OTHER_OPTION.name) {
        setRegion(selectedTenant.region);
        setTenantCode(selectedTenant.id);
        setShowAdvancedForm(true);
      }
    };
    void retrieveSelectedTenant();
  }, []);
  const getTenantToSave = (selectedOption) => {
    if (selectedOption.name === OTHER_OPTION.name) {
      return { name: OTHER_OPTION.name, id: tenantCode, region };
    }
  ...
  const onSave = () => {
    const performSave = async () => {
      ...
      if (!validSelectedOption(selectedOptions, tenantCode, region)) {
        setShowErrorAlert(true);
        return;
      }
      const tenantToSave = getTenantToSave(selectedOptions[0]);
      await updateTenant(tenantToSave);
  ...
  const handleTypeaheadChange = (selected) => {
    ...
    setShowAdvancedForm(selected.length > 0 && selected[0] === OTHER_OPTION);
  };
  const optionsWithOther = data ? [...data, OTHER_OPTION] : [];
  if (error) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Alert$1, { variant: "danger", children: "An error occurred." });
  }
  if (isLoading || !data) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading..." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "options-container", children: [
    showErrorAlert && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert$1, { variant: "danger", children: "An institution must be selected." }),
    showSuccessAlert && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert$1, { variant: "success", children: "Institution saved." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", htmlFor: "tenant-list", children: "Type to search for your institution" }),
    ...
    showAdvancedForm && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { controlId: "region", className: "mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { column: true, children: "Region" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Form$1.Control,
          {
            as: "select",
            value: region,
            onChange: (e2) => {
              setRegion(e2.target.value);
            },
            children: Object.values(we$1).map((regionValue) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: regionValue, children: regionValue }, regionValue))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { controlId: "tenantCode", className: "mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { column: true, children: "Tenant code" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Form$1.Control,
          {
            type: "text",
            value: tenantCode,
            onChange: (e2) => {
              setTenantCode(e2.target.value);
            }
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { id: "saveButton", variant: "primary", onClick: onSave, children: "Save" })
  ] });
};
createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(OptionsQueryClientProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "m-5 mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(OptionsScreen, {}) }) }) })
);
