...
import { TCreateListener } from '@common/utils/createListenerFactory';
...
export class TranslationsService extends Translations implements ITranslationsService {
  ...
  public constructor(private storageApi: IStorageApi, private createListener: TCreateListener) {
    const locales = {
