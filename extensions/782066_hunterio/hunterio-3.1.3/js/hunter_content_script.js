...
if (location.pathname === "/firefox/welcome" || location.pathname === "/firefox/welcome" || location.pathname === "/search") {
...
$("#extension-version").val(browser.runtime.getManifest().version);
