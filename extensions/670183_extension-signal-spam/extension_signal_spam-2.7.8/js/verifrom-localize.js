    ...
    verifrom.localize = function(options, thisDocument) {
        ...
        for (let element of elements) {
            try {
                ...
                let value = browser.i18n.getMessage(key.replace(/[\.\-\/]/g,"_"));
                if (value !== null) {
                    void 0;
        ...
        for (let switchElement of switches) {
            switchElement.setAttribute("yes",browser.i18n.getMessage("options_yes"));
            switchElement.setAttribute("no",browser.i18n.getMessage("options_no"));
        }
    };
    verifrom.locales = {
        getMessage : function(token) {
            ...
            let value = browser.i18n.getMessage(token.replace(/[\.\/\-]/g,"_"));
            if (!value)
