...
;// CONCATENATED MODULE: ./source/nimble-agent-frame/index.js


log('NIMBLE AGENT FRAME');
var NimbleIframe = document.querySelector('#nimble-agent-frame');
options_storage.getAll().then(function (storage) {
  return NimbleIframe.src = "".concat(storage.endpoint, "/app/prospector-agent/");
});
})();
