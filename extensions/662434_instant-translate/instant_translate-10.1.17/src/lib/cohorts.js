Cohorts = (function() {
    ...
    var GoogleAnalyticsAdapter = {
        ...
        onEvent: function(testName, cohort, eventName, value) {
            this.trackEvent(this.nameSpace, testName, cohort + ' | ' + eventName, value);
        }
    };
    ...
    var Test = (function() {        
        ...
        constructor.prototype = {
            ...
            event: function(eventName, value) {
                if(this.inTest())
                    this.options.storageAdapter.onEvent(this.options.name, this.getCohort(), eventName, value || '');
            },
            inTest: function() {
