...
var CAMELIZER = new Object({
  ...
  configs: new Object({
    ...
    build_info: "2023-02-24 @ 11:14:11",
...
{
  var settings_code = `var c3_version = "${CAMELIZER.version()}"; `;

  browser.tabs.query({active: true, currentWindow: true})
    .then(tab => browser.tabs.executeScript(tab[0].id, {"code": settings_code})
      .then(_ => browser.tabs.executeScript(tab[0].id, {"file": "set_firstrun_options.js", "runAt": "document_end"}))
...
{
  return("https://camelcamelcamel.com/camelizer/first_run?browser=firefox&version=3.0.15&utm_campaign=camelizer&utm_medium=extension&utm_source=firefox&utm_content=first_run");
}

function last_run_url()
{
  return("https://camelcamelcamel.com/camelizer/last_run?browser=firefox&version=3.0.15&utm_campaign=camelizer&utm_medium=extension&utm_source=firefox&utm_content=last_run");
}
