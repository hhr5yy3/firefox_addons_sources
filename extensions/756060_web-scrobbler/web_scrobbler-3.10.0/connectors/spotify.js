"use strict";
(() => {
  // src/connectors/spotify.ts
  var playerBar = '.Root [data-testid="now-playing-bar"]';
  var artistSelector = `${playerBar} [data-testid="context-item-info-artist"]`;
  var oldPlayingPath = "M2.7 1a.7.7 0 00-.7.7v12.6a.7.7 0 00.7.7h2.6a.7.7 0 00.7-.7V1.7a.7.7 0 00-.7-.7H2.7zm8 0a.7.7 0 00-.7.7v12.6a.7.7 0 00.7.7h2.6a.7.7 0 00.7-.7V1.7a.7.7 0 00-.7-.7h-2.6z";
  var newPlayingPath = "M2.7 1a.7.7 0 0 0-.7.7v12.6a.7.7 0 0 0 .7.7h2.6a.7.7 0 0 0 .7-.7V1.7a.7.7 0 0 0-.7-.7H2.7zm8 0a.7.7 0 0 0-.7.7v12.6a.7.7 0 0 0 .7.7h2.6a.7.7 0 0 0 .7-.7V1.7a.7.7 0 0 0-.7-.7h-2.6z";
  var spotifyConnectSelector = `${playerBar} [aria-live="polite"]`;
  var oldPauseButtonSelector = `${playerBar} [data-testid=control-button-playpause] svg path[d="${oldPlayingPath}"]`;
  var newPauseButtonSelector = `${playerBar} [data-testid=control-button-playpause] svg path[d="${newPlayingPath}"]`;
  ...
  Connector.scrobblingDisallowedReason = () => isMusicPlaying() && isMainTab() ? null : "IsPlayingElsewhere";
