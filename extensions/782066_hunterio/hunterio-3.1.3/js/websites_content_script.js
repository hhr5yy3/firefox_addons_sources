...
PageContent = {
  ...
  addLocationIcon: function() {
    return setTimeout((function() {
      return $(".hunter-email").each(function(index) {
        ...
        $("body").prepend("<img src=\"" + DOMPurify.sanitize(browser.runtime.getURL("/img/location_icon.png")) + "\" alt=\"Here is the email found with Hunter!\" id=\"hunter-email-pointer\"/>");
  ...
  displayMessage: function(message, email, count) {
    var src;
    src = browser.runtime.getURL("/html/source_popup.html") + "?email=" + email + "&count=" + count + "&message=" + message;
