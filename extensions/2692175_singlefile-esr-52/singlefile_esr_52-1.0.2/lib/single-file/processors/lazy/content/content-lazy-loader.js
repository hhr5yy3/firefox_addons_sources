...
this.singlefile.lib.processors.lazy.content.loader = this.singlefile.lib.processors.lazy.content.loader || (() => {
	...
	function resetZoomLevel(options) {
		singlefile.lib.processors.hooks.content.frames.loadDeferredImagesResetZoomLevel(options);
	}
	...
	function triggerLazyLoading(options) {
		return new Promise(async resolve => { // eslint-disable-line  no-async-promise-executor
			...
			addEventListener(singlefile.lib.processors.hooks.content.frames.LOAD_IMAGE_EVENT, onImageLoadEvent);
			addEventListener(singlefile.lib.processors.hooks.content.frames.IMAGE_LOADED_EVENT, onImageLoadedEvent);
			singlefile.lib.processors.hooks.content.frames.loadDeferredImagesStart(options);
			...
			function cleanupAndResolve(value) {
				observer.disconnect();
				removeEventListener(singlefile.lib.processors.hooks.content.frames.LOAD_IMAGE_EVENT, onImageLoadEvent);
				removeEventListener(singlefile.lib.processors.hooks.content.frames.IMAGE_LOADED_EVENT, onImageLoadedEvent);
				resolve(value);
			}
		});
	}
