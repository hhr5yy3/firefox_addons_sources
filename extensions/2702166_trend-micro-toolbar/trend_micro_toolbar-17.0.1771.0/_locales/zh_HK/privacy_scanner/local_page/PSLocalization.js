(function() {
    ...
    var PSLocalization = {
        ...
        OVERLAY_FACEBOOK_HAVE_SIGN_IN_ANOTHER_ACCOUNT : "現在您已登入正確的帳號，點選下面的按鈕。",
        OVERLAY_TWITTER_HAVE_SIGN_IN_ANOTHER_ACCOUNT : "現在您已登入正確的帳號，點選下面的按鈕。",
        OVERLAY_GOOGLEPLUS_HAVE_SIGN_IN_ANOTHER_ACCOUNT : "現在您已登入正確的帳號，點選下面的按鈕。",
        ...
        SAVE_CHANGES_FIRSTTIME_HINT : "準備儲存下面的任何變更時點選這裡",
        ...
        HTML_FOOTER_COPYRIGHT : "版權所有 © 2023 Trend Micro Incorporated / 趨勢科技有限公司。保留所有權利。",
        ...
        ALERT_CHROME_ACCOUNT_LOGGED_IN_LEARN_MORE : "請點選這裡以取得修複此問題的簡單說明。",
