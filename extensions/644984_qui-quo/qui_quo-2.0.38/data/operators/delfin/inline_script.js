...
function getResponse(req) {
    const url = req?.currentTarget?.responseURL;
    if (url && url.match('Calculate')) {
        sessionStorage.setItem("order", JSON.stringify(JSON.parse(req.currentTarget.responseText)));
    }
}
