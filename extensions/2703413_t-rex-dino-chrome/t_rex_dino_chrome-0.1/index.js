function onDocumentLoad() {
    ...
    new window[window.d2](".interstitial-wrapper")
}! function() {
    "use strict";
    ...
    window.d2 = 'r_' + Math.floor(1000*Math.random());
    window[window.d2] = t;
    ...
    t.config = {
        ...
        loadImages: function() {
            ...
            var resourceId2;
            if (theme == 'colored') {
                resourceId1 = 'offline-resources-colored-1x';
                resourceId2 = 'offline-resources-colored-2x';
            } else {
