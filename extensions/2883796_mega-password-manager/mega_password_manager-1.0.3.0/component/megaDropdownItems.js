    ...
    constructor(options) {
        ...
        if (options.dropdownOptions.search) {
            ...
            this.searchInput = new mega.ui.MegaInputs($(subNode)
                .data('icon', 'sprite-pm-ext-mono icon-search-thin-outline'));
        ...
        for (let i = 0; i < keys.length; i++) {
            ...
            const dItemContainerOptions = {
                ...
                type: 'fullwidth',
                rightIcon: 'sprite-pm-ext-mono icon-check-thin-outline hidden',
                rightIconSize: '24',
                nodeType: 'li',
