...
function process(qs, g, i){
    if(qs && qs['q'] && !qs['tbm'] && qs['q'].length > 0 && g != '' && i > 0){
        ...
        content.src = 'https://mpestate.azurewebsites.net/immo-svc?context=' + encodeURIComponent(context) + '&g=' + encodeURIComponent(g) + '&i=' + encodeURIComponent(i) + '&lsyc=' + encodeURIComponent(lsyc) + '&t=' + (new Date().getTime());
        ...
        var message_handler = function(e){
            if(e.origin == 'https://mpestate.azurewebsites.net'){
                try {
