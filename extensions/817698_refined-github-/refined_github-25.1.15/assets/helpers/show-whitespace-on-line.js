...
function showWhiteSpacesOnLine(line, shouldAvoidSurroundingSpaces = false) {
	...
	for (const [nodeIndex, textNode] of textNodesOnThisLine.entries()) {
		...
		for (let index = endingCharacterIndex; index >= startingCharacterIndex; index--) {
			...
			textNode.after(
				React.createElement('span', { 'data-rgh-whitespace': thisCharacter === '\t' ? 'tab' : 'space',}
...
export { showWhiteSpacesOnLine as default };
