            ...
            chrome.tabs.query({ active: true }, function (tab) {
                chrome.tabs.sendMessage(tab[0].id, { name: 'getStatus' }, function (response) {
                    if (response) _this2.setState({
                        status: response.statusOtsleditSelectTrack
                    });
                });
            });
        }
    ...
    _createClass(TrackPrice, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.state.showButtom ? _react2.default.createElement(
                    'button',
                    {
                        onClick: this.createTrack.bind(this),
                        className: 'gp-small-button gp-button--theme-success gp-state-default gp-small-button-green',
                        title: 'quickly create a track for the price',
                        target: '_blank' },
                    'track price ',
                    _react2.default.createElement(
                        'span',
