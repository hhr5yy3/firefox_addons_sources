...
import { hasCode, isPR, isIssue, isDiscussion, isGlobalSearchResults } from '../npm/github-url-detection.js';
import observe from '../helpers/selector-observer.js';
import features from '../feature-manager.js';
import { getRepo } from '../github-helpers/index.js';
import { linkifyIssues, codeElementsSelector, linkifiedURLClass, linkifyURLs } from '../github-helpers/dom-formatters.js';

function initTitle(signal) {
...
function linkifyContent(wrapper) {
	...
	const currentRepo = isGlobalSearchResults()
