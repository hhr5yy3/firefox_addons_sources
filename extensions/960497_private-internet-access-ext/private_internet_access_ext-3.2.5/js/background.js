...
__webpack_require__(6) && $export($export.P + __webpack_require__(28), 'Object', {
...
var $export = __webpack_require__(3);
var flattenIntoArray = __webpack_require__(84);
var toObject = __webpack_require__(10);
var toLength = __webpack_require__(40);
var aFunction = __webpack_require__(13);
...
const config = __webpack_require__(114);
const util = __webpack_require__(116);
const engine = __webpack_require__(161);
...
"use strict";
/* harmony import */ var _helpers_applyListener__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(24);
/*
  *** WARNING ***
...
const config = {
  ...
  // Local network
  'local',
  // .local are often employed in private networks
  'ip',
  // speedport.ip is being used by telekom routers
  'fritz.box',
  ...
  'intra',
  // used by some companies for local intranet
  'intranet',
  // used by some companies for local intranet
  'test',
  ...
  'lvh.me', 'vcap.me', '127.0.0.1.xip.io',
  // http://xip.io/
  'localtest.me',
...
exports.concatUnique = (a, b) => a.concat(b).filter((x, i, c) => c.indexOf(x) === i);
...
"use strict";
/* harmony import */ var _helpers_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16);
...
const pacengine = __webpack_require__(110);
...
"use strict";
/* harmony import */ var _helpers_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16);
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(193);
...
/* harmony import */ var _helpers_isDev__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(109);
...
"use strict";
/* harmony import */ var _helpers_reportError__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(70);
...
/* WEBPACK VAR INJECTION */(function(process) {class BuildInfo {
  constructor() {
    this.name = "public";
    this.version = "3.2.5";
    this.date = new Date("Thu, 02 Feb 2023 13:57:59 GMT");
...
"use strict";
/* harmony import */ var _helpers_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16);
/* harmony import */ var _helpers_messagingFirefox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);


const defaultRegions = __webpack_require__(195);
...
/* harmony import */ var _helpers_messagingFirefox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
...
"use strict";
/* harmony import */ var _helpers_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16);
/* harmony import */ var _helpers_compare__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(102);
...
"use strict";
/* harmony import */ var _helpers_compare__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(102);
...
"use strict";
/* harmony import */ var _helpers_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16);
/* harmony import */ var _helpers_reportError__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(70);
/* harmony import */ var _helpers_timer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(82);
/*
   IMPORTANT
   =========
...
"use strict";
/* harmony import */ var _firefoxsettings_chromesetting__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17);
...
class WebRTC extends _firefoxsettings_chromesetting__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] {
  constructor() {
    ...
    this.clearSetting = this.createClearSetting('webrtc', 'unblock');
...
class HttpReferrer extends _firefoxsettings_chromesetting__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] {
  constructor() {
    ...
    this.clearSetting = this.createClearSetting('httpreferer', 'unblock');
...
class HyperLinkAudit extends _firefoxsettings_chromesetting__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] {
  constructor() {
    ...
    this.clearSetting = this.createClearSetting('hyperlinkaudit', 'unblock');
...
class NetworkPredication extends _firefoxsettings_chromesetting__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] {
  constructor() {
    ...
    this.clearSetting = this.createClearSetting('networkprediction', 'unblock');
...
class TrackingProtection extends _firefoxsettings_chromesetting__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] {
  constructor() {
    ...
    // functions
    this.applySetting = this.createApplySetting('always', 'trackingprotection', 'block');
...
class FingerprintProtection extends _firefoxsettings_chromesetting__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"] {
  constructor() {
    ...
    // functions
    this.applySetting = this.createApplySetting(true, 'fingerprintprotection', 'block');
...
$export($export.S + $export.F, 'Object', { classof: __webpack_require__(118) });
...
var $export = __webpack_require__(3);
var define = __webpack_require__(121);
...
var es7_array_flat_map = __webpack_require__(71);
...
var ipmanager = __webpack_require__(139);

// EXTERNAL MODULE: ./src/js/helpers/messagingFirefox.js
var messagingFirefox = __webpack_require__(5);
...
class mockAppAdapter_MockAppAdapter {
  constructor(app) {
    // properties
    this.app = app;
    this.target = messagingFirefox["Target"].FOREGROUND;
...
var chromesetting = __webpack_require__(25);
...
class thirdpartycookies_ThirdPartyCookies extends chromesetting["a" /* default */] {
  constructor() {
    ...
    this.clearSetting = this.createClearSetting('thirdpartycookies', 'unblock');
...
class safebrowsing_SafeBrowsing extends chromesetting["a" /* default */] {
  constructor() {
    ...
    this.clearSetting = this.createClearSetting('safebrowsing', 'unblock');
  ...
  async enable() {
    ...
    try {
      ...
      if (smartlocation.getSmartLocationRules('smartLocationRules').length > 0 && smartlocation.getSmartLocationRules('checkSmartLocation')) {
        ...
        const pacScript = pacengine.exportPAC(region.id, nodeDict, userRulesSmartLoc, bypasslist.getRulesSmartLoc());
        //get the pac script
        value = {
          mode: 'pac_script',
          pacScript: {
...
class autofill_AutoFill extends chromesetting["a" /* default */] {
  constructor() {
    ...
    this.clearSetting = this.createClearSetting('autofill', 'unblock');
...
class autofillcreditcard_AutoFillCreditCard extends chromesetting["a" /* default */] {
  constructor(storage) {
    ...
    this.clearSetting = this.createClearSetting('autofillcreditcard', 'unblock');
...
class autofilladdress_AutoFillAddress extends chromesetting["a" /* default */] {
  constructor(storage) {
    ...
    this.clearSetting = this.createClearSetting('autofilladdress', 'unblock');
...
var firefoxsettings_chromesetting = __webpack_require__(17);

// CONCATENATED MODULE: ./src/js/firefoxsettings/proxy.js



const proxy_pacengine = __webpack_require__(110);
class proxy_Proxy {
  constructor(app, foreground) {
...
var firefoxsettings_webrtc = __webpack_require__(140);

// EXTERNAL MODULE: ./src/js/firefoxsettings/networkprediction.js
var firefoxsettings_networkprediction = __webpack_require__(143);

// EXTERNAL MODULE: ./src/js/firefoxsettings/httpreferer.js
var firefoxsettings_httpreferer = __webpack_require__(141);

// EXTERNAL MODULE: ./src/js/firefoxsettings/hyperlinkaudit.js
var firefoxsettings_hyperlinkaudit = __webpack_require__(142);

// EXTERNAL MODULE: ./src/js/firefoxsettings/trackingprotection.js
var trackingprotection = __webpack_require__(144);

// EXTERNAL MODULE: ./src/js/firefoxsettings/fingerprintprotection.js
var fingerprintprotection = __webpack_require__(145);

// EXTERNAL MODULE: ./src/js/helpers/applyListener.js
var applyListener = __webpack_require__(24);
...
var onError = __webpack_require__(112);
...
var url_parser = __webpack_require__(146);
...
(async () => {
  ...
  background_self.helpers = Object.create(null);
  ...
  background_self.logger = new logger["a" /* default */](background_self);

  // attach debugging to global scope
  window.debug = background_self.logger.debug;
  ...
  if (typeof browser == "undefined") {
    ...
    background_self.contentsettings.extensionNotification = new extension_notification(background_self);
    ...
    background_self.chromesettings.safebrowsing = new safebrowsing();
    ...
    background_self.chromesettings.autofilladdress = new autofilladdress(background_self.util.storage);
  ...
  background_self.sameApp = new js_sameApp["a" /* default */](background_self);
  ...
  background_self.helpers.UrlParser = new url_parser["a" /* default */]();
