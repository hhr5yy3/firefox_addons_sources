...
if (typeof importScripts !== 'undefined' && !this.is_pwm) {
    importScripts('/webclient-subtree/sjcl.js', '/webclient-subtree/rsaasm.js');
...
lazy(self, 'decWorkerPool', function decWorkerPool() {
    ...
    return new class extends Array {
        get url() {
            ...
            return `/webclient-subtree/nodedec.js?v=${WORKER_VERSION}`;
        }
