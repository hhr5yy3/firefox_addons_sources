define(function () {
    var parameter = Backbone.View.extend({
        ...
        render: function () {
            ...
            if (!Google.get('active')) html.find('.param').attr('disabled', 'disabled');
        ...
        returnLocale: function (name) {
            /*if (name === 'TYC') {
                return AppLocale.get('options.google.' + name);
            }*/
        ...
        activeChanged: function (model, value) {
            ...
            if (['Seo'].indexOf(model.get('name')) > -1 && value) {
                ...
                if (activeMarkets.length === 0) {
                    ...
                    GoParameters.get('Seo').set({extra: extra});
    ...
    return Backbone.View.extend({
        ...
        template: function () {
            ...
            GoParameters.each(function (value, key, list) {
            ...
            $('.google-parameters').html(this.buildTableView(elements));
