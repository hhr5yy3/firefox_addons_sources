...
(function ($) {
    if (!window.captureFragmentScroll) {
        window.captureFragmentScroll = {
            ...
            savePosition() {
                chrome.runtime.sendMessage({operation: 'save_fragment_scroll_position', value: window.captureFragmentScroll.position});
            },
            event: {
                stop: function (e) {
                    e.preventDefault();
            ...
            view: {
                ...
                border: function (elem) {
                    ...
                    window.captureFragmentScroll.data.elem = e.target;
            ...
            init: function () {
                ...
                $('*').on('contextmenu', window.captureFragmentScroll.event.contextmenu);
            }
        };
