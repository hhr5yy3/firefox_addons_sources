...
//                                                                             }
//       Copyright (C) 2016-2024 Lamantine Software a.s.                       }
//                                                                             }
//*****************************************************************************}
...
TspChromiumPageEventsMonitor.prototype.ConnectToPageEvents = function()
{
  ...
  spAutofillCore.HTMLTools.AddUnloadEventListener(window, this._onPageUnloadHandler);
...
TspChromiumPageEventsMonitor.prototype.PageOnDOMContentLoaded = function(AWindow)
{
  ...
  {
    spLog.logError('TspChromiumPageEventsMonitor.PageOnDOMContentLoaded() Error: ' + ErrorMessage);
  }
};
...
TspChromiumPageEventsMonitor.prototype.FixChromiumIFrameFormsOnSubmit = function (ADocument)
{
  ...
  {
    spLog.logError('TspChromiumPageEventsMonitor.FixChromiumIFrameFormsOnSubmit() Error: ' + ErrorMessage);
  }
};
...
TspChromiumPageEventsMonitor.prototype.FixChromiumFramesetOnSubmit = function (AWindow)
{
  ...
  {
    spLog.logError('TspChromiumPageEventsMonitor.FixChromiumFramesetOnSubmit() Error: ' + ErrorMessage);
  }
}
...
TspChromiumPageEventsMonitor.prototype.PageOnLoadIfDocumentAlreadyComplete = function(AWindow)
{
  ...
  try
  {
    ...
    if (this.Log.Info)
      spLog.logMessage('TspChromiumPageEventsMonitor.PageOnLoadIfDocumentAlreadyComplete() Document state complete with ' + 
  ...
  {
    spLog.logError('TspChromiumPageEventsMonitor.PageOnLoadIfDocumentAlreadyComplete() Error: ' + ErrorMessage);
  }
};
...
TspChromiumPageEventsMonitor.prototype.StartDOMChangesMonitoring = function(AWindow)
{
  ...
  {
    spLog.logError('TspChromiumPageEventsMonitor.StartDOMChangesMonitoring() Error: ' + ErrorMessage);
  }
};
...
TspChromiumPageEventsMonitor.prototype.StopDOMChangesMonitoring = function(AWindow)
{
  ...
  {
    spLog.logError('TspChromiumPageEventsMonitor.StopDOMChangesMonitoring() Error: ' + ErrorMessage);
  }
};
...
TspChromiumPageEventsMonitor.prototype.TryProcessPageLoaded = function(AWindow)
{
  ...
  {
    spLog.logError('TspChromiumPageEventsMonitor.TryProcessPageLoaded() Error: ' + ErrorMessage);
  }
};
...
TspChromiumPageEventsMonitor.prototype.AllowProcessPageLoaded = function (AWindow)
{
  ...
  {
    spLog.logError('TspChromiumPageEventsMonitor.AllowProcessPageLoaded() Error: ' + ErrorMessage);
  }
