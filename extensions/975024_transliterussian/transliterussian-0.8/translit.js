...
element.style.border = "2px dotted #00ff00";
...
function translate(e){
	...
	switch(latinchar) {
		...
		case "h":
			if(vorlastchar == String.fromCharCode(1094)){			// "c"
				translatechar = String.fromCharCode(1095);			// "ч"
				is2char = true;
			} 
			else if(vorlastchar == String.fromCharCode(1062)){		// "C"
			...
			else if(vorlastchar == String.fromCharCode(1079)){		// "z"
				translatechar = String.fromCharCode(1078);			// "ж"
				is2char = true;
			} 
			else if(vorlastchar == String.fromCharCode(1047)){		// "Z"
