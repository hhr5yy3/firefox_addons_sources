...
L64Jq.prototype =
{
    ...
    get: function (id){
        ...
        if (id.charAt(0) == ".") {
            id = id.substr(1);
            var aElements = this.doc.getElementsByClassName(id);
            return aElements.lenght ? aElements : false;
        }
        id = id.substr(1);
    ...
    getAllItems: function (id, func, funcfin) {
        ...
        id = id.substr(1);
        if (type == 1) {
            var curobj = this.doc.getElementById(id);
            if (curobj) {
                func(curobj);
            }
        }
            ...
            for (var idx = 0; idx < ao.length; idx++) {
                func(ao[idx]);
            }
        }
        ...
        this.getAllItems(id, function (element) {
            if (element) {
                if (element.oldEvent) {
                    ...
                    element.oldEvent = {};
                var func2 = function (ev) { ev.stopPropagation(); func(this, param); };
                element.oldEvent[event] = func2;
