import { j as jsx } from "./index-3699c331.js";
import { R as React, a as getAugmentedNamespace } from "./index-3da6bb4f.js";
...
var ImSpinner3_1 = function ImSpinner3(props) {
...
const loaderWrapper = "_loaderWrapper_a1uqj_1";
const spinner = "_spinner_a1uqj_1";
const styles$1 = {
  loaderWrapper,
  spinner
};
const Loader = () => /* @__PURE__ */ jsx("div", { className: styles$1.loaderWrapper, children: /* @__PURE__ */ jsx(ImSpinner3_1, {}) });
const button = "_button_15zm0_1";
const buttonRadius = "_buttonRadius_15zm0_15";
const buttonLoading = "_buttonLoading_15zm0_18";
const buttonNormal = "_buttonNormal_15zm0_21";
const buttonHot = "_buttonHot_15zm0_31";
const buttonCold = "_buttonCold_15zm0_41";
const buttonPrimary = "_buttonPrimary_15zm0_51";
const buttonSecondary = "_buttonSecondary_15zm0_67";
const buttonFullWidth = "_buttonFullWidth_15zm0_83";
const buttonM = "_buttonM_15zm0_86";
const buttonL = "_buttonL_15zm0_18";
const buttonS = "_buttonS_15zm0_67";
const styles = {
  button,
  buttonRadius,
  buttonLoading,
      ...
      children: /* @__PURE__ */ jsx(
        "button",
        {
          className: classNames(styles.button, {
            [styles.buttonNormal]: buttonStyle === "normal",
            [styles.buttonHot]: buttonStyle === "hot",
            [styles.buttonCold]: buttonStyle === "cold",
          ...
          type,
          disabled,
          children: loading ? /* @__PURE__ */ jsx("span", { className: styles.buttonLoading, children: /* @__PURE__ */ jsx(Loader, {}) }) : text
        }
      )
    }
  );
