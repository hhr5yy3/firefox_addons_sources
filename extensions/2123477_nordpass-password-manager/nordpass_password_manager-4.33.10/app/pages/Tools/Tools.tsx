...
const Tools: FC = () => {
  ...
  const [isEmergencyAccessEnabled, setIsEmergencyAccessEnabled] = useState(false);

  useEffect(() => {
    getIsFeatureEnabled(FeatureFlag.EmergencyAccess).then(setIsEmergencyAccessEnabled);
  }, []);
