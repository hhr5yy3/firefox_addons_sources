let toggleFlag = 0;
let xpath1 = document.getElementById('xpath_1');
let xpath2 = document.getElementById('xpath_2');
let rel_xpath = document.getElementById('rel_xpath');
let final_res = document.getElementById('final_xpath_result');
let handleRequest = function(request, sender, cb) {
