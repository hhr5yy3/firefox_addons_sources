import { l as logger, b as browser, g as getExtensionPage, p as privatePolicyData } from "../../urlAccess-93f11c64.js";
import { j as jsx, a as jsxs, F as Fragment, R as ReactDOM } from "../../index-3699c331.js";
import { r as require$$0, c as classNames, L as Loader, B as Button } from "../../Button-e5b90d65.js";
import { P as PriceTrackConfigView$1, a as PriceTrackNotificationsView$1, E as ErrorBoundary, b as ErrorDisplay, u as useAPIResource, c as useAppSelector, d as useDispatch, s as styles$3, D as Disclaimer, O as OptionSelect, S as SvgLogo, e as SvgConfusedinline, f as Provider, g as store, h as useAPI, L as LoginPlaceHolderView } from "../../PriceTrackNotifications.view-71344528.js";
import { c as configAPIHandler, l as logOut, s as setLoginStatus, a as settingsAPIHandler, b as createTab } from "../../metricsAlerts.api-6ae7940f.js";
import { r as reactExports } from "../../index-3da6bb4f.js";
import { s as sendMessage } from "../../messageEngine-ccf4a39f.js";
const SvgCheckboxOffinline = (props) => /* @__PURE__ */ reactExports.createElement("svg", { width: 12, height: 12, viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props }, /* @__PURE__ */ reactExports.createElement("rect", { x: 0.5, y: 0.5, width: 11, height: 11, rx: 5.5, stroke: "currentColor" }));
const SvgCheckboxOninline = (props) => /* @__PURE__ */ reactExports.createElement("svg", { width: 12, height: 12, viewBox: "0 0 12 12", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props }, /* @__PURE__ */ reactExports.createElement("rect", { x: 0.5, y: 0.5, width: 11, height: 11, rx: 5.5, stroke: "currentColor" }), /* @__PURE__ */ reactExports.createElement("rect", { x: 2, y: 2, width: 8, height: 8, rx: 4, fill: "currentColor" }));
var GenIcon = require$$0.GenIcon;
var SiZapier_1 = function SiZapier(props) {
...
const radioWrapper = "_radioWrapper_1mm5c_1";
const radioLayout = "_radioLayout_1mm5c_14";
const h = "_h_1mm5c_20";
const styles$2 = {
  radioWrapper,
  radioLayout,
...
function RadioBox({
  ...
  return /* @__PURE__ */ jsx("div", { className: classNames(styles$2.radioLayout, layout === "row" ? styles$2.h : ""), children: options.map((elm, i) => {
    return /* @__PURE__ */ jsxs("div", { className: styles$2.radioWrapper, children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "radio",
...
const ProfileView$1 = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$3.container, children: [
    /* @__PURE__ */ jsxs("div", { className: styles$3.sidebar, children: [
      /* @__PURE__ */ jsxs("div", { className: styles$3.logoWrapper, children: [
        /* @__PURE__ */ jsx("div", { className: styles$3.userAvatar, children: avatarUrl ? /* @__PURE__ */ jsx("img", { src: avatarUrl, alt: "" }) : /* @__PURE__ */ jsx(SiZapier_1, {}) }),
        /* @__PURE__ */ jsx("div", { className: styles$3.userName, children: loggedIn && username || "user not loged in" })
      ] }),
      /* @__PURE__ */ jsx("nav", { children: menuOptions.map((el, i) => {
        return /* @__PURE__ */ jsx(
          "a",
          {
            className: classNames({
              [styles$3.clicked]: el === subViewProfile
            }),
      ...
      /* @__PURE__ */ jsxs("div", { className: styles$3.links, children: [
        /* @__PURE__ */ jsx("a", { href: getExtensionPage("privacyConsent.html"), target: "_blank", children: "política de privacidad" }),
        /* @__PURE__ */ jsx("a", { target: "_blank", href: "https://www.chollometro.com/aviso-legal", children: "condiciones de uso" })
      ] }),
      /* @__PURE__ */ jsx("div", { onClick: logOutHandler, className: styles$3.logOut, children: "Cerrar sesión" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: styles$3.profileScreen, children: /* @__PURE__ */ jsx(ProfileviewPicker, { view: subViewProfile }) })
  ] });
};
const ProfileviewPicker = ({
  view = "configuración"
}) => {
  switch (view) {
    case "configuración":
      return /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(LookAndFeelProfileSubView, {}),
        /* @__PURE__ */ jsx(SERPProfileSubView, {}),
        /* @__PURE__ */ jsx(WarningsProfileSubView, {}),
        /* @__PURE__ */ jsx("div", { className: styles$3.advice, children: /* @__PURE__ */ jsx(Disclaimer, { text: 'Al interactuar con nuestra extensión, en ocasiones podemos abrir enlaces monetizados en segundo plano, así es cómo se financia Chollometro.<a href="https://www.chollometro.com/faqs#di" target="blank"> Más info</a>.' }) })
      ] });
    case "mis alertas":
      return /* @__PURE__ */ jsx(PriceTrackConfigView, {});
    case "notificaciones":
      return /* @__PURE__ */ jsx(PriceTrackNotificationsView, {});
    case "cashback":
      return /* @__PURE__ */ jsx("div", { children: "casshback" });
  }
};
const LookAndFeelProfileSubView = () => {
  const [settings, settingsAPI] = useAPIResource(settingsAPIHandler);
  const ScaleFactorUIOptions = [
    {
      value: "small",
      label: "Pequeño"
    },
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$3.profileSetting, children: [
    /* @__PURE__ */ jsxs("div", { className: styles$3.screenTitle, children: [
      /* @__PURE__ */ jsx(SvgSettingsinline, {}),
      " ",
      /* @__PURE__ */ jsx("h1", { children: "Apariencia" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: styles$3.size, children: /* @__PURE__ */ jsx(
      OptionSelect,
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: styles$3.theme, children: [
      /* @__PURE__ */ jsx("span", { className: styles$3.label, children: "Tema de la interfaz" }),
      /* @__PURE__ */ jsx(
        RadioBox,
        {
...
const SERPProfileSubView = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$3.profileConfig, children: [
    /* @__PURE__ */ jsxs("div", { className: styles$3.screenTitle, children: [
      /* @__PURE__ */ jsx(SvgSerpinline, {}),
      " ",
      /* @__PURE__ */ jsx("h1", { children: "Mostrar en resultados de búsqueda" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: styles$3.size, children: /* @__PURE__ */ jsx(
      OptionSelect,
      {
...
const WarningsProfileSubView = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$3.profileConfig, children: [
    /* @__PURE__ */ jsxs("div", { className: styles$3.screenTitle, children: [
      /* @__PURE__ */ jsx(SvgMessageinline, { className: styles$3.warning }),
      " ",
      /* @__PURE__ */ jsx("h1", { children: "Recibir avisos de tus alertas" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: styles$3.warningSelect, children: /* @__PURE__ */ jsx(
      OptionSelect,
      {
        onChange: async (value, selectedOption, option) => {
...
const root = "_root_1tg1h_1";
const lightTheme = "_lightTheme_1tg1h_96";
const darkTheme = "_darkTheme_1tg1h_123";
const popUp = "_popUp_1tg1h_158";
const scaleDefault = "_scaleDefault_1tg1h_166";
const scaleSmall = "_scaleSmall_1tg1h_170";
const scaleBig = "_scaleBig_1tg1h_174";
const maxWidth = "_maxWidth_1tg1h_178";
const privacy = "_privacy_1tg1h_182";
const styles$1 = {
  root,
  lightTheme,
  darkTheme,
...
const wrapper = "_wrapper_38m7e_1";
const face = "_face_38m7e_24";
const faceExpression = "_faceExpression_38m7e_32";
const faceText = "_faceText_38m7e_37";
const buttonWrapper = "_buttonWrapper_38m7e_41";
const styles = {
  wrapper,
  face,
  faceExpression,
...
const CallToPP = () => {
  const callPP = async () => {
    ...
    try {
      ...
      sendMessage(void 0, createTab("privatePolicy.html"));
    }
  };
  return /* @__PURE__ */ jsxs("div", { className: styles.wrapper, children: [
    /* @__PURE__ */ jsxs("header", { children: [
      /* @__PURE__ */ jsx(SvgLogo, {}),
      " ",
      /* @__PURE__ */ jsx("h3", { children: "Chollometro" })
    ] }),
    /* @__PURE__ */ jsxs("section", { className: styles.face, children: [
      /* @__PURE__ */ jsx(SvgConfusedinline, {}),
      /* @__PURE__ */ jsx("p", { className: styles.faceExpression, children: "¡Vaya!" }),
      /* @__PURE__ */ jsx("p", { className: styles.faceText, children: "Parece que aún no has aceptado nuestra política de privacidad" })
    ] }),
    /* @__PURE__ */ jsx("section", { className: styles.buttonWrapper, children: /* @__PURE__ */ jsx(Button, { radius: true, text: "Ir a privacidad", onClick: callPP }) })
  ] });
};
function PopupWindow() {
  return /* @__PURE__ */ jsx(Provider, { store, children: /* @__PURE__ */ jsx(PopUPView, {}) });
}
async function renderPopup() {
  ...
  if ((await privatePolicyData.get()).isPolicyAuth) {
    ReactDOM.render(/* @__PURE__ */ jsx(PopupWindow, {}), root2);
  } else {
    root2.classList.add(styles$1.privacy);
    ReactDOM.render(
      /* @__PURE__ */ jsx("div", { className: styles$1.root, children: /* @__PURE__ */ jsx(CallToPP, {}) }),
      root2
    );
  }
}
