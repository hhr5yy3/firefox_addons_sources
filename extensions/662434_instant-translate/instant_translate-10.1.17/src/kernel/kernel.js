...
(function (win, doc, undefined) {
    ...
    const getProtocol = () => {
        ...
        if (window.navigator.userAgent.toLowerCase().indexOf('edg/') > -1) {
            ...
            return PROTOCOLS[ke.PLATFORM_CODE];
        }
    }; 
    ...
    pl.extend(ke.data.kernel.info, {
        get section() {
            return ke.data.kernel.info.url.match(getProtocol())
    ...
    pl.extend(ke, {
        ...
        getExtensionProtocol: getProtocol,
        ...
        IS_FIREFOX: true,     // Is Firefox
        IS_SAMSUNG: false,     // Is Samsung Internet

        PLATFORM_CODE: 'firefox',
