(function () {
	...
	*/
	 ...
	 * @return {HTMLElement}
	 */
	function constructRedirectBadge( options ) {
	 ...
	 * @return {HTMLElement}
	 */
	function constructReplacementMarker( wikiInfo ) {
	    return createDomElement( 'span', {
	 ...
	 * @abstract
	 */
	class GenericSearchModule extends SearchModule {
	...
	function prepareWikisInfo( wikis, options ) {
	 ...
	 * @return {HTMLElement?}
	 */
	function crawlUntilParentFound( element, selector, maxDepth = -1 ) {
	...
	function awaitElement( knownParent, selector, callback ) {
