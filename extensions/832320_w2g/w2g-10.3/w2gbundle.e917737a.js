...
parcelRegister("kizeT", function(module, exports) {

$parcel$export(module.exports, "W2gDataObject", function () { return $ec70d2dfeb46c5c9$export$9cb1e67042ada; });
let $ec70d2dfeb46c5c9$export$9cb1e67042ada = function(obj, name, parentHandler) {
    "use strict";
    ...
    for(p in obj)if (obj.hasOwnProperty(p) && obj[p] && obj[p].constructor.name !== "Promise" && typeof obj[p] === "object") {
        if (typeof obj[p]._addParentHander === "undefined") obj[p] = new $ec70d2dfeb46c5c9$export$9cb1e67042ada(obj[p], p, runHandlers);
    ...
    function setHandler(target, prop, value, receiver) {
        if (prop.indexOf("__") === 0) {
            ...
            if (isArray(target[prop]) && isArray(value)) {
                ...
                if (typeof value._addHandler === "undefined") target[prop] = new $ec70d2dfeb46c5c9$export$9cb1e67042ada(value, prop, runHandlers);
                else {
            ...
            if (typeof value._addParentHander === "undefined") target[prop] = new $ec70d2dfeb46c5c9$export$9cb1e67042ada(value, prop, runHandlers);
            else {
                value._addParentHander(prop, runHandlers);
                target[prop] = value;
            }
...
parcelRegister("2Zlaa", function(module, exports) {

$parcel$export(module.exports, "W2gBind", function () { return $22d1b1d00600846d$export$ba9ec5408f77933a; });
let $22d1b1d00600846d$export$ba9ec5408f77933a = function(obj, cont) {
    "use strict";
