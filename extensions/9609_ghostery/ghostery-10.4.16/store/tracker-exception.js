...
function toggleExceptionBlocked(exception, blockedByDefault) {
...
function toggleExceptionDomain(
  exception,
  domain,
  blockedByDefault,
  forceValue,
...
export { TrackerException as default, toggleExceptionBlocked, toggleExceptionDomain };
