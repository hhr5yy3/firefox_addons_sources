...
function CONSTRUCTOR(){
  ...
  GEBI('SL_twsc12').appendChild(document.createTextNode(tws));
...
function INIT(){
  ...
  var tempHK12 = FExtension.GET_localStorage("SL_tr_hk_btn");
  if(tempHK12=="true"){
  ...
  GEBI("SRV12").value=FExtension.GET_localStorage("SL_tr_hk");


  var tempHK10 = FExtension.GET_localStorage("SL_change_lang_HKbox_it");
  if(tempHK10=="true"){
  ...
  GEBI("SRV10").value = FExtension.GET_localStorage("SL_change_lang_HK_it");


  var tempHK11 = FExtension.GET_localStorage("SL_HK_bb2box");
  if(tempHK11=="true"){
  ...
  GEBI("SRV11").value=FExtension.GET_localStorage("SL_HK_bb2").replace("Escape","Esc");
...
function save_options(){
 ...
 if(UNBLOCK == 0) {
	  GEBI("HK_conflicts_msg").inerText="";
		...
		chrome.storage.local.set({'SL_change_lang_HKbox_it': GEBI("IMT_HK10").checked});
		FExtension.store.set("SL_change_lang_HK_it",GEBI("SRV10").value);
		chrome.storage.local.set({'SL_change_lang_HK_it': GEBI("SRV10").value});
		...
		chrome.storage.local.set({'SL_HK_bb2box': GEBI("IMT_HK11").checked});
		FExtension.store.set("SL_HK_bb2",GEBI("SRV11").value);
		chrome.storage.local.set({'SL_HK_bb2': GEBI("SRV11").value});


	        // TR
		FExtension.store.set("SL_tr_hk_btn", GEBI("IMT_HK12").checked);
		chrome.storage.local.set({'SL_tr_hk_btn': GEBI("IMT_HK12").checked});
		FExtension.store.set("SL_tr_hk",GEBI("SRV12").value);
		chrome.storage.local.set({'SL_tr_hk': GEBI("SRV12").value});
