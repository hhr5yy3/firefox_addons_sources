...
function injectScript(scriptName) {
  return new Promise(function (resolve) {
    ...
    script.src = browser_polyfill_default().runtime.getURL(scriptName);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return injectScript("injected.bundle.js");

          case 3:
            _context.next = 5;
            return waitForMessage("SEASON_PASS_INJECTED_LOADED");

          case 5:
            _context.next = 7;
            return browser_polyfill_default().storage.local.get();
