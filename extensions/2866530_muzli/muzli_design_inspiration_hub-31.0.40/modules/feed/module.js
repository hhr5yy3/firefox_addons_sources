(function () {
    ...
    feedController.$inject = ['$scope', '$rootScope', '$stateParams', '$timeout', 'sources', 'serverPageSize', 'fetchService'];

    function feedController($scope, $rootScope, $stateParams, $timeout, sources, serverPageSize, fetchService) {
        ...
        let feedPromises = [
            fetchService.fetch(sourceName, sort, serverPageSize, filter, user)
        ]
