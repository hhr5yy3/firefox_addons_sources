...
;// CONCATENATED MODULE: ./src/injected.ts
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return waitForMessage("SEASON_PASS_LOCAL_STORAGE");
          ...
          case 8:
            ...
            browser_default().register({
              ...
              response: function response(_response) {
                if (_response.url.includes("bungie.net/Platform/Settings/")) {
                  return _response.json().then( /*#__PURE__*/function () {
                    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(settingsJson) {
                      var altResponse;
                          ...
                          switch (_context.prev = _context.next) {
                            case 0:
                              ...
                              if (storage.seasonHash && storage.seasonHash > 0) {
                                console.log("[INJECTED] Overriding season hash to", storage.seasonHash);
                                settingsJson.Response.destiny2CoreSettings.pastSeasonHashes.push(storage.seasonHash);
                              }

                              altResponse = new Response(JSON.stringify(settingsJson), _response);
                              altResponse.request = _response.request;
                              return _context.abrupt("return", altResponse);
