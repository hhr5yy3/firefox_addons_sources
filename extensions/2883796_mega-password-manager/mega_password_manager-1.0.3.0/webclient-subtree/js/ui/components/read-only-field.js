...
class MegaReadOnlyField extends MegaComponent {
    ...
    constructor(options) {
        ...
        if (options.helpText) {
            ...
            icon.className = 'sprite-pm-ext-mono icon-help-circle-thin-outline';
        ...
        if (this.isPassword) {
            ...
            this.strenghtIcon.className = 'sprite-pm-ext-mono';
     ...
     */
    passwordStrength() {
        const strength = classifyPassword(this._originalValue);
