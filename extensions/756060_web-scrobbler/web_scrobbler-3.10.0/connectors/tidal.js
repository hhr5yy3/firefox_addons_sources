...
(() => {
  ...
  Connector.scrobblingDisallowedReason = () => Util.queryElements(Connector.playButtonSelector) ? null : "ElementMissing";
  ...
  var artistSelector = `${Connector.playerSelector} span.artist-link a`;
  Connector.getArtist = () => {
