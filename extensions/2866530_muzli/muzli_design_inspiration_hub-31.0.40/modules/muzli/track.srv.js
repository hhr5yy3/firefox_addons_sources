(function () {
    ...
    const experimentFlags = {
        ...
        'useDefaultBing': {newOnly: true, dimension: 'use_default_bing'},
        'useDefaultWebSearch': {newOnly: true, dimension: 'use_default_web_search'},
        'useSkipFtx': {newOnly: true, dimension: 'use_skip_ftx'},
        'useAltShortcuts': {newOnly: true, dimension: 'use_alt_shortcuts'},
        'useAnonymousSources': 'use_anonymous_sources',
        'useBalancedFeed': 'use_balanced_feed',
        'usePersistentHero': 'use_persistent_hero',
    }
