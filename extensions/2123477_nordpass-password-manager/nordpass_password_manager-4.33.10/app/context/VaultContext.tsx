...
import { ItemType, ShareStatus, SortingDirection, SortingType } from '@common/constants';
...
const VaultContext = createContext<IVaultContext>({
  vaultItems: [],
  vaultFolders: [],
...
export const VaultProvider: FC = ({ children }) => {
  ...
  }), [vaultItems, vaultFolders, vaultGroups, isLoading, error]);
