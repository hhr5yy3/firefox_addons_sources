var headernavcolor = ()=>document.getElementsByClassName('top-nav')?.[0] ? window.getComputedStyle(document.getElementsByClassName('top-nav')?.[0]?.firstChild).backgroundColor : '#1c1c1c';
var head_color = headernavcolor();
