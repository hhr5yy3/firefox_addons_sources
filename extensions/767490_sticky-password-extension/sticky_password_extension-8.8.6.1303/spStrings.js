...
var spStrings = (function() {
  ...
  return {
    ...
    // SearchTextPos()
    SearchTextPos: function(ASearchingText, AText)
    {
      try
      {
        ...
        if (SearchingText.length)
          return Text.indexOf(SearchingText);
        else
          return -1;
      }
      catch (ErrorMessage)
      {
        _logFailure('SearchTextPos', ErrorMessage);
        return false;
      }
    },
    ...
    {
      return this.SearchTextPos(ASearchingText, AText) >= 0;
    },
