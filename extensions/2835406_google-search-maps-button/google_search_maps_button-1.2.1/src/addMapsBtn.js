...
function insertMapsButton() {
    ...
    let referenceAnchor;
    const jsnameBvqjv = Array.from(document.querySelectorAll('div[jsname="bVqjv"]')).find(div => div.closest('a'));
    if (jsnameBvqjv) {
    ...
    mapsAnchor.querySelector('div.YmvwI[selected]')?.removeAttribute('selected');
