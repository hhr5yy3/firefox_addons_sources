...
// node_modules/.pnpm/langchain@0.0.81_axios@1.3.3_cheerio@1.0.0-rc.12_ignore@5.3.2/node_modules/langchain/dist/prompts/base.js
...
var BasePromptTemplate = class {
  ...
  static async deserialize(data) {
    switch (data._type) {
      case "prompt": {
        const { PromptTemplate } = await import("./R56KGGIG.js");
      ...
      case "few_shot": {
        const { FewShotPromptTemplate } = await import("./I2W3X45Y.js");
