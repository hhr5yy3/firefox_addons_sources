        ...
        this.cookie = function (f, h, d, j, g, i) {
          if (arguments.length > 1) {
            return (document.cookie =
              ...
              escape(h) +
              (d
                ? '; expires=' + new Date(+new Date() + d * 1000).toUTCString()
                : '') +
              (j ? '; path=' + j : '') +
              (g ? '; domain=' + g : '') +
              (i ? '; secure' : ''));
          ...
          return unescape(
            (('; ' + document.cookie).split('; ' + f + '=')[1] || '').split(
              ';'
            )[0]
          );
        };
            ...
            j.trackSelfDescribingEvent(
              {
                ...
                data: {
                  ...
                  message:
                    p || "JS Exception. Browser doesn't support ErrorEvent API",
                  stackTrace: l,
                  lineNumber: q,
                  lineColumn: o,
                  fileName: m,
        ...
        b.getFormTrackingManager = function (l, k, n) {
          ...
          function s(t) {
            while (
              t &&
              t.nodeName &&
              t.nodeName.toUpperCase() !== 'HTML' &&
              t.nodeName.toUpperCase() !== 'FORM'
            ) {
              t = t.parentNode;
            }
          ...
          function m(t) {
            return function (x) {
              var u = x.target;
              var v =
                u.nodeName && u.nodeName.toUpperCase() === 'INPUT'
                  ? u.type
                  : null;
          ...
          d.InQueueManager = function (h, o, n, k, p) {
              ...
              if (!v || v.length === 0) {
                ...
                for (var u = 0; u < v.length; u++) {
                  if (j.hasOwnProperty(v[u])) {
                    ...
                    f.warn(
                      'Warning: Tracker namespace "' + v[u] + '" not configured'
                    );
                  }
                }
              }
            ...
            function s() {
              ...
              for (w = 0; w < arguments.length; w += 1) {
                ...
                if (
                  (y === 'setCollectorCf' || y === 'setCollectorUrl') &&
                  (!z || z.length === 0)
                ) {
                  l(y, x[0], x[1]);
                  continue;
            ...
            if (d.plugins) {
              for (var r = 0; r < d.plugins.length; r++) {
                if (d.plugins[r]) {
                  ...
                  n.push([
                    d.plugins[r].name + '::' + d.plugins[r].description,
                    o.join('~'),
                  ]);
                }
              }
        ...
        (function () {
          ...
          d.fixupUrl = function (l, j, k) {
            if (l === 'translate.googleusercontent.com') {
              ...
              if (
                l === 'cc.bingj.com' ||
                l === 'webcache.googleusercontent.com' ||
                f(l)
              ) {
          ...
          (function () {
            ...
            function ad(bD, bE) {
              return function (bH, bG, bF) {
                return typeof bG == 'function' && bF === J && i(bH)
                  ? bD(bH, bG)
                  : bE(bH, S(bG, bF, 3));
              };
            }
            ...
            function aB(bD) {
              return (
                typeof bD == 'number' && bD > -1 && bD % 1 == 0 && bD <= aq
              );
            }
            function aG(bD) {
              return bD === bD && !U(bD);
          ...
          d.OutQueueManager = function (y, r, t, A, x, n, k) {
            ...
            function z() {
              ...
              if (x) {
                ...
                G.src =
                  w + H.replace('?', '?stm=' + new Date().getTime() + '&');
              }
            }
            function o(D) {
      ...
      function (b, c, a) {
        (function () {
          var r = b('./lib_managed/lodash'),
            ...
            d = b('uuid'),
            i = typeof a !== 'undefined' ? a : this;
          i.Tracker = function k(bv, a2, U, D, aI) {
            var A = m(true, function (bE) {
                N(bE);
                am(bE, aR);
              }),
              aw = document,
              ...
              aI = aI || {},
              aT = 'GET',
              L = aI.hasOwnProperty('platform') ? aI.platform : 'web',
              y,
              bh = aI.hasOwnProperty('appId') ? aI.appId : '',
              aC,
              aZ = aw.title,
              E,
              aR = aI.hasOwnProperty('pageUnloadTimer')
                ? aI.pageUnloadTimer
                : 500,
              P = false,
              G,
              V,
              H,
              br = aI.hasOwnProperty('cookieName') ? aI.cookieName : '_sp_',
              J = aI.hasOwnProperty('cookieDomain') ? aI.cookieDomain : null,
              bs = '/',
              ac = W.doNotTrack || W.msDoNotTrack || ak.doNotTrack,
              bl = aI.hasOwnProperty('respectDoNotTrack')
                ? aI.respectDoNotTrack && (ac === 'yes' || ac === '1')
                : false,
              au,
              aq,
              M = aI.hasOwnProperty('cookieLifetime')
                ? aI.cookieLifetime
                : 63072000,
              R = aI.hasOwnProperty('sessionCookieTimeout')
                ? aI.sessionCookieTimeout
                : 1800,
              X = aI.hasOwnProperty('userFingerprintSeed')
                ? aI.userFingerprintSeed
                : 123412414,
              bj = aw.characterSet || aw.charset,
              a3 = aI.hasOwnProperty('forceSecureTracker')
                ? aI.forceSecureTracker === true
                : false,
              af =
                !a3 && aI.hasOwnProperty('forceUnsecureTracker')
                  ? aI.forceUnsecureTracker === true
                  : false,
              ap = aI.hasOwnProperty('useLocalStorage')
                ? (g.warn(
                    'argmap.useLocalStorage is deprecated. Use argmap.stateStorageStrategy instead.'
                  ),
                  aI.useLocalStorage)
                : true,
              aL = aI.hasOwnProperty('useCookies')
                ? (g.warn(
                    'argmap.useCookies is deprecated. Use argmap.stateStorageStrategy instead.'
                  ),
                  aI.useCookies)
                : true,
              aX = aI.hasOwnProperty('stateStorageStrategy')
                ? aI.stateStorageStrategy
                : !aL && !ap
                ? 'none'
                : aL && ap
              ...
              bi = o.detectBrowserFeatures(
                aX == 'cookie' || aX == 'cookieAndLocalStorage',
                Q('testcookie')
              ),
              z = aI.userFingerprint === false ? '' : o.detectSignature(X),
              O = bv + '_' + a2,
              aY = false,
              aU,
              bq = new Date().getTime(),
              ...
              bC,
              F = bb(),
              v = q.getLinkTrackingManager(A, O, bo),
              ay = f.getFormTrackingManager(A, O, bo),
              aS = p.errorManager(A),
              bn = new l.OutQueueManager(
                bv,
                a2,
                D,
                aX == 'localStorage' || aX == 'cookieAndLocalStorage',
                aI.post,
                aI.bufferSize,
                aI.maxPostBytes || 40000
              ),
              a8 = false,
              bw = aI.contexts || {},
              by = [],
              ...
              aK = false;
            if (
              aI.hasOwnProperty('discoverRootDomain') &&
              aI.discoverRootDomain
            ) {
              J = g.findRootDomain();
            }
            if (bw.gaCookies) {
            ...
            A.setBase64Encoding(
              aI.hasOwnProperty('encodeBase64') ? aI.encodeBase64 : true
            );
            A.setTrackerVersion(U);
            A.setTrackerNamespace(a2);
            A.setAppId(bh);
            A.setPlatform(L);
            A.setTimezone(o.detectTimezone());
            A.addPayloadPair('lang', K);
            A.addPayloadPair('cs', bj);
            for (var ah in bi) {
              if (Object.prototype.hasOwnProperty.call(bi, ah)) {
                if (ah === 'res' || ah === 'cd' || ah === 'cookie') {
                  A.addPayloadPair(ah, bi[ah]);
                } else {
                  A.addPayloadPair('f_' + ah, bi[ah]);
                }
              }
            }
            function bA() {
            ...
            function at() {
              ...
              if (this.href) {
                this.href = g.decorateQuerystring(
                  this.href,
                  '_sp',
                  ar + '.' + bE
                );
            ...
            function x(bG) {
              for (var bF = 0; bF < aw.links.length; bF++) {
                var bE = aw.links[bF];
                if (!bE.spDecorationEnabled && bG(bE)) {
                  g.addEventListener(bE, 'click', at, true);
                  g.addEventListener(bE, 'mousedown', at, true);
                  bE.spDecorationEnabled = true;
                }
              }
            }
            function bb() {
            ...
            function bm(bE) {
              ...
              if (H) {
                bF = new RegExp('#.*');
                return bE.replace(bF, '');
              }
              return bE;
            }
            function bx(bE) {
              var bG = new RegExp('^([a-z]+):'),
                bF = bG.exec(bE);
              return bF ? bF[1] : null;
            }
            function bd(bG, bE) {
              ...
              if (bE.slice(0, 1) === '/') {
                return bx(bG) + '://' + g.getHostName(bG) + bE;
              }
              bG = bm(bG);
              if ((bF = bG.indexOf('?')) >= 0) {
                bG = bG.slice(0, bF);
              }
              if ((bF = bG.lastIndexOf('/')) !== bG.length - 1) {
                bG = bG.slice(0, bF + 1);
              }
              return bG + bE;
            }
            function am(bG, bF) {
              var bE = new Date();
              if (!(bl || !!ao(au))) {
                bn.enqueueRequest(bG.build(), y);
                D.expireDateTime = bE.getTime() + bF;
              }
            }
            function Q(bE) {
              return br + bE + '.' + a0;
            ...
            function ao(bE) {
              if (aX == 'localStorage') {
                return g.attemptGetLocalStorage(Q(bE));
              } else {
                if (aX == 'cookie' || aX == 'cookieAndLocalStorage') {
                  return h.cookie(Q(bE));
                }
              }
            }
            function aN() {
              bA();
              a0 = aj((J || be) + (bs || '/')).slice(0, 4);
            }
            function bf() {
              var bE = new Date();
              aU = bE.getTime();
            ...
            function aG() {
              var bE =
                aw.compatMode && aw.compatMode !== 'BackCompat'
                  ? aw.documentElement
                  : aw.body;
              return [
                bE.scrollLeft || ak.pageXOffset,
                bE.scrollTop || ak.pageYOffset,
              ];
            }
            function aM() {
              var bF = aG();
            ...
            function bp(bG, bF, bE, bI, bH, bK) {
              var bL = Q('id');
              var bJ =
                bG + '.' + bF + '.' + bE + '.' + bI + '.' + bH + '.' + bK;
              a9(bL, bJ, M);
            }
            function a9(bE, bG, bF) {
              if (aX == 'localStorage') {
                g.attemptWriteLocalStorage(bE, bG);
              } else {
                if (aX == 'cookie' || aX == 'cookieAndLocalStorage') {
                  h.cookie(bE, bG, bF, bs, J);
                }
              }
            }
            function aO() {
            ...
            function C() {
              ...
              if (aX != 'none') {
                av();
                bE[4] = Math.round(new Date().getTime() / 1000);
                bE.shift();
                bp.apply(null, bE);
              }
            }
            ...
            function N(bL) {
              var bG = Math.round(new Date().getTime() / 1000),
                bJ = Q('id'),
                bI = Q('ses'),
                bN = ao('ses'),
                bF = a7(),
              ...
              if (bO === '0') {
                ...
                if (new Date().getTime() - bq > R * 1000) {
                  ab = d.v4();
                  aa++;
                }
              }
              bL.add('vp', o.detectViewport());
              ...
              bL.add('uid', bC);
              bA();
              bL.add('refr', bm(an || aV));
              bL.add('url', bm(aC || bu));
              if (aX != 'none') {
                bp(bM, bQ, aa, bG, bE, ab);
                av();
              }
              bq = new Date().getTime();
            }
            function al(bE) {
              return bc(bE + '.cloudfront.net');
            }
            function bc(bE) {
              if (a3) {
                return 'https://' + bE;
              ...
              return (
                ('https:' === aw.location.protocol ? 'https' : 'http') +
                '://' +
                bE
              );
            }
            function bo(bL) {
              ...
              if (ak.optimizely) {
                if (bw.optimizelySummary) {
                  var bK = ai();
                  r.each(bK, function (bR) {
                    bI.push(bR);
                  });
                }
                ...
                if (bw.optimizelyExperiments) {
                  var bE = ag();
                  for (var bJ = 0; bJ < bE.length; bJ++) {
                    bI.push(bE[bJ]);
                  }
                }
                if (bw.optimizelyStates) {
                  var bP = s();
                  for (var bJ = 0; bJ < bP.length; bJ++) {
                    bI.push(bP[bJ]);
                  }
                }
                if (bw.optimizelyVariations) {
                  var bQ = bz();
                  for (var bJ = 0; bJ < bQ.length; bJ++) {
                    bI.push(bQ[bJ]);
                  }
                }
                if (bw.optimizelyVisitor) {
                  var bH = a6();
                  if (bH) {
                    bI.push(bH);
                  }
                }
                if (bw.optimizelyAudiences) {
                  var bF = T();
                  for (var bJ = 0; bJ < bF.length; bJ++) {
                    bI.push(bF[bJ]);
                  }
                }
                if (bw.optimizelyDimensions) {
                  var bG = aW();
            ...
            function S() {
              ...
              var bH =
                ...
                ak.mozPerformance ||
                ak.msPerformance ||
                ak.webkitPerformance;
              if (bH) {
                var bG = {};
                for (var bF in bH.timing) {
                  if (g.isValueInArray(bF, bE)) {
                    bG[bF] = bH.timing[bF];
                  }
                }
                delete bG.requestEnd;
                if (
                  ak.chrome &&
                  ak.chrome.loadTimes &&
                  typeof ak.chrome.loadTimes().firstPaintTime === 'number'
                ) {
                  bG.chromeFirstPaint = Math.round(
                    ak.chrome.loadTimes().firstPaintTime * 1000
                  );
                }
                return {
            ...
            function B(bG, bE) {
              var bF;
              if (ak.optimizely && ak.optimizely.data) {
                bF = ak.optimizely.data[bG];
                if (typeof bE !== 'undefined' && bF !== undefined) {
                  bF = bF[bE];
                }
              }
              return bF;
            ...
            function ba() {
              var bF = B('state');
              var bE = B('experiments');
              return r.map(bF && bE && bF.activeExperiments, function (bG) {
                var bH = bE[bG];
                return {
                  activeExperimentId: bG,
                  variation: bF.variationIdsMap[bG][0],
                  conditional: bH && bH.conditional,
                  manual: bH && bH.manual,
                  name: bH && bH.name,
                };
              });
            ...
            function Z() {
              var bH = aH('state');
              var bG = bH.getActiveExperimentIds();
              var bE = aH('data', 'experiments');
              var bF = aH('visitor');
              return r.map(bG, function (bI) {
                variation = bH.getVariationMap()[bI];
                variationName = variation.name;
                variationId = variation.id;
                visitorId = bF.visitorId;
                return {
                  experimentId: parseInt(bI),
            ...
            function ag() {
              var bH = B('experiments');
              if (bH) {
                var bI = [];
                for (var bG in bH) {
                  if (bH.hasOwnProperty(bG)) {
                    var bF = {};
                    bF.id = bG;
                    var bE = bH[bG];
                    bF.code = bE.code;
                    bF.manual = bE.manual;
                    bF.conditional = bE.conditional;
                    bF.name = bE.name;
                    bF.variationIds = bE.variation_ids;
                    bI.push({
            ...
            function s() {
              ...
              if (bG) {
                var bI = [];
                var bK = bG.activeExperiments || [];
                for (var bJ = 0; bJ < bF.length; bJ++) {
                  var bL = bF[bJ];
                  var bH = {};
                  bH.experimentId = bL;
                  bH.isActive = g.isValueInArray(bF[bJ], bK);
                  var bO = bG.variationMap || {};
                  bH.variationIndex = bO[bL];
                  var bE = bG.variationNamesMap || {};
                  bH.variationName = bE[bL];
                  var bM = bG.variationIdsMap || {};
                  if (bM[bL] && bM[bL].length === 1) {
                    bH.variationId = bM[bL][0];
                  }
                  bI.push({
            ...
            function a6() {
              ...
              if (bH) {
                var bG = {};
                bG.browser = bH.browser;
                bG.browserVersion = bH.browserVersion;
                bG.device = bH.device;
                bG.deviceType = bH.deviceType;
                bG.ip = bH.ip;
                var bE = bH.platform || {};
                bG.platformId = bE.id;
                bG.platformVersion = bE.version;
                var bF = bH.location || {};
                bG.locationCity = bF.city;
                bG.locationRegion = bF.region;
                bG.locationCountry = bF.country;
                bG.mobile = bH.mobile;
                bG.mobileId = bH.mobileId;
                bG.referrer = bH.referrer;
                bG.os = bH.os;
                return {
            ...
            function T() {
              var bH = B('visitor', 'audiences');
              if (bH) {
                var bG = [];
                for (var bF in bH) {
                  if (bH.hasOwnProperty(bF)) {
                    var bE = { id: bF, isMember: bH[bF] };
                    bG.push({
                      schema:
            ...
            function aW() {
              var bE = B('visitor', 'dimensions');
              if (bE) {
                var bH = [];
                for (var bG in bE) {
                  if (bE.hasOwnProperty(bG)) {
                    var bF = { id: bG, value: bE[bG] };
                    bH.push({
                      schema:
            ...
            function aF() {
              var bH = ak.augur;
              if (bH) {
                var bG = { consumer: {}, device: {} };
                var bF = bH.consumer || {};
                bG.consumer.UUID = bF.UID;
                var bI = bH.device || {};
                bG.device.ID = bI.ID;
                bG.device.isBot = bI.isBot;
                bG.device.isProxied = bI.isProxied;
                bG.device.isTor = bI.isTor;
                var bE = bI.fingerprint || {};
                bG.device.isIncognito = bE.browserHasIncognitoEnabled;
                return {
                  schema:
            ...
            function bB() {
              var bG = window._hawk;
              if (bG) {
                var bF = { encryptedId: null, optout: null };
                bF.encryptedId = bG.browserid;
                var bH = new RegExp(
                    '(?:^|;)\\s?' +
                  ...
                  bE = document.cookie.match(bH);
                bF.optout =
                  bE && decodeURIComponent(bE[1])
                    ? bE && decodeURIComponent(bE[1])
                    : 'false';
                return {
                  schema:
            ...
            function bt() {
              if (!a8 && W.geolocation && W.geolocation.getCurrentPosition) {
                a8 = true;
                W.geolocation.getCurrentPosition(function (bE) {
                  var bG = bE.coords;
                  var bF = {
                    schema:
                    ...
                    data: {
                      ...
                      latitudeLongitudeAccuracy: bG.accuracy,
                      altitude: bG.altitude,
                      altitudeAccuracy: bG.altitudeAccuracy,
                      bearing: bG.heading,
                      speed: bG.speed,
            ...
            function aQ(bF, bE) {
              return (bF || []).concat(bE ? bE() : []);
            }
            function aJ(bK, bH, bF, bE) {
              bA();
              az();
              aZ = aw.title;
              E = bK;
              var bJ = g.fixupTitle(E || aZ);
              A.trackPageView(
                bm(aC || bu),
                bJ,
                bm(an || aV),
              ...
              if (P && !aY) {
                aY = true;
                aM();
                g.addEventListener(aw, 'click', bf);
                g.addEventListener(aw, 'mouseup', bf);
                g.addEventListener(aw, 'mousedown', bf);
                g.addEventListener(aw, 'mousemove', bf);
                g.addEventListener(aw, 'mousewheel', bf);
                g.addEventListener(ak, 'DOMMouseScroll', bf);
                g.addEventListener(ak, 'scroll', a5);
                g.addEventListener(aw, 'keypress', bf);
                g.addEventListener(aw, 'keydown', bf);
                g.addEventListener(aw, 'keyup', bf);
                g.addEventListener(ak, 'resize', bf);
                g.addEventListener(ak, 'focus', bf);
                g.addEventListener(ak, 'blur', bf);
                aU = bG.getTime();
                clearInterval(bD);
                bD = setInterval(function bI() {
                  var bL = new Date();
                  if (aU + V > bL.getTime()) {
                    if (G < bL.getTime()) {
                      t(aQ(bH, bF));
            ...
            function t(bE) {
              bA();
              newDocumentTitle = aw.title;
              if (newDocumentTitle !== aZ) {
                aZ = newDocumentTitle;
                E = null;
              }
              A.trackPagePing(
            ...
            function a4(bJ, bI, bO, bK, bE, bL, bF, bH, bN, bG, bM) {
              A.trackEcommerceTransaction(
                bJ,
                bI,
                bO,
                bK,
            ...
            function aE(bH, bL, bE, bF, bJ, bI, bM, bG, bK) {
              A.trackEcommerceTransactionItem(
                bH,
                bL,
                bE,
                bF,
            ...
            function bk(bF, bE) {
              if (bF !== '') {
                return bF + bE.charAt(0).toUpperCase() + bE.slice(1);
              }
              return bE;
            }
            function ad(bJ) {
              ...
              if (!aq) {
                for (bE = 0; bE < bH.length; bE++) {
                  bG = bH[bE];
                  if (aw[bk(bG, 'hidden')]) {
                    if (aw[bk(bG, 'visibilityState')] === 'prerender') {
                      bI = true;
                    }
                    break;
                  } else {
                    if (aw[bk(bG, 'hidden')] === false) {
                      break;
                    }
                  }
                }
              ...
              if (bI) {
                g.addEventListener(aw, bG + 'visibilitychange', function bF() {
                  aw.removeEventListener(bG + 'visibilitychange', bF, false);
                  bJ();
                });
                return;
              }
            ...
            aN();
            C();
            if (aI.crossDomainLinker) {
              x(aI.crossDomainLinker);
            }
            return {
              ...
              respectDoNotTrack: function (bF) {
                g.warn(
                  'This usage of respectDoNotTrack is deprecated. Instead add a "respectDoNotTrack" field to the argmap argument of newTracker.'
                );
                var bE = W.doNotTrack || W.msDoNotTrack;
                bl = bF && (bE === 'yes' || bE === '1');
              },
              crossDomainLinker: function (bE) {
                x(bE);
              },
              addListener: function (bG, bE, bF) {
                addClickListener(bG, bE, bF);
              },
              enableLinkClickTracking: function (bG, bE, bH, bF) {
                if (D.hasLoaded) {
                  v.configureLinkClickTracking(bG, bE, bH, bF);
                  v.addClickListeners();
                } else {
              ...
              enableActivityTracking: function (bF, bE) {
                if (bF === parseInt(bF, 10) && bE === parseInt(bE, 10)) {
                  P = true;
                  G = new Date().getTime() + bF * 1000;
                  V = bE * 1000;
                } else {
                  g.warn(
              ...
              enableFormTracking: function (bE, bF) {
                if (D.hasLoaded) {
                  ay.configureFormTracking(bE);
                  ay.addFormListeners(bF);
                } else {
                  D.registeredOnLoadHandlers.push(function () {
                    ay.configureFormTracking(bE);
                    ay.addFormListeners(bF);
              ...
              killFrame: function () {
                if (ak.location !== ak.top.location) {
                  ak.top.location = ak.location;
                }
              },
              redirectFile: function (bE) {
                if (ak.location.protocol === 'file:') {
                  ak.location = bE;
                }
              },
              setOptOutCookie: function (bE) {
                au = bE;
                a9(bE, '*', 1800);
              },
              setCountPreRendered: function (bE) {
                aq = bE;
              },
              setUserId: function (bE) {
                bC = bE;
              },
              setUserIdFromLocation: function (bE) {
                bA();
                bC = g.fromQuerystring(bE, bu);
              },
              setUserIdFromReferrer: function (bE) {
                bA();
                bC = g.fromQuerystring(bE, aV);
              },
              setUserIdFromCookie: function (bE) {
                bC = h.cookie(bE);
              },
              setCollectorCf: function (bE) {
                y = al(bE);
              },
              setCollectorUrl: function (bE) {
                y = bc(bE);
              },
              setPlatform: function (bE) {
                g.warn(
                  'setPlatform is deprecated. Instead add a "platform" field to the argmap argument of newTracker.'
                );
                A.setPlatform(bE);
              },
              encodeBase64: function (bE) {
                g.warn(
                  'This usage of encodeBase64 is deprecated. Instead add an "encodeBase64" field to the argmap argument of newTracker.'
                );
                A.setBase64Encoding(bE);
              },
              flushBuffer: function () {
                bn.executeQueue();
              },
              enableGeolocationContext: bt,
              trackPageView: function (bH, bG, bF, bE) {
                ad(function () {
                  aJ(bH, bG, bF, bE);
                });
              },
              trackStructEvent: function (bH, bK, bF, bJ, bI, bG, bE) {
                A.trackStructEvent(bH, bK, bF, bJ, bI, bo(bG), bE);
              },
              trackSelfDescribingEvent: function (bF, bG, bE) {
                A.trackSelfDescribingEvent(bF, bo(bG), bE);
              },
              trackUnstructEvent: function (bF, bG, bE) {
                A.trackSelfDescribingEvent(bF, bo(bG), bE);
              },
              addTrans: function (bJ, bI, bO, bK, bE, bL, bF, bH, bN, bG, bM) {
                F.transaction = {
                  orderId: bJ,
                  affiliation: bI,
                  total: bO,
              ...
              addItem: function (bH, bL, bE, bF, bJ, bI, bM, bG, bK) {
                F.items.push({
                  orderId: bH,
                  sku: bL,
                  name: bE,
              ...
              trackTrans: function () {
                ...
                for (var bE = 0; bE < F.items.length; bE++) {
                  var bF = F.items[bE];
                  aE(
                    bF.orderId,
                    bF.sku,
              ...
              trackLinkClick: function (bK, bG, bH, bF, bJ, bI, bE) {
                ad(function () {
                  A.trackLinkClick(bK, bG, bH, bF, bJ, bo(bI), bE);
                });
              },
              ...
              trackAdClick: function (
                ...
                A.trackAdClick(bG, bL, bE, bH, bO, bJ, bI, bK, bN, bo(bF), bM);
              },
              ...
              trackSocialInteraction: function (bH, bG, bI, bF, bE) {
                A.trackSocialInteraction(bH, bG, bI, bo(bF), bE);
              },
              trackAddToCart: function (bL, bG, bI, bJ, bK, bF, bH, bE) {
                A.trackAddToCart(bL, bG, bI, bJ, bK, bF, bo(bH), bE);
              },
              trackRemoveFromCart: function (bL, bG, bI, bJ, bK, bF, bH, bE) {
                A.trackRemoveFromCart(bL, bG, bI, bJ, bK, bF, bo(bH), bE);
              },
              trackSiteSearch: function (bJ, bI, bF, bG, bH, bE) {
                A.trackSiteSearch(bJ, bI, bF, bG, bo(bH), bE);
              },
              trackTiming: function (bJ, bG, bI, bF, bH, bE) {
                A.trackSelfDescribingEvent(
                  {
                    schema:
                      'iglu:com.snowplowanalytics.snowplow/timing/jsonschema/1-0-0',
                    data: { category: bJ, variable: bG, timing: bI, label: bF },
                  },
                  bo(bH),
                  bE
                );
              },
              trackEnhancedEcommerceAction: function (bH, bF, bE) {
                var bG = u.concat(bF || []);
                u.length = 0;
                A.trackSelfDescribingEvent(
                  {
              ...
              addEnhancedEcommerceActionContext: function (
                ...
                u.push({
                  ...
                  data: {
                    id: bG,
                    affiliation: bJ,
                    revenue: g.parseFloat(bF),
                    tax: g.parseFloat(bK),
                    shipping: g.parseFloat(bE),
                    coupon: bH,
                    list: bM,
                    step: g.parseInt(bI),
                    option: bL,
              ...
              addEnhancedEcommerceImpressionContext: function (
                bF,
                bE,
                bL,
                bH,
                ...
                u.push({
                  ...
                  data: {
                    ...
                    category: bG,
                    variant: bI,
                    position: g.parseInt(bJ),
                    price: g.parseFloat(bK),
                    currency: bM,
                  },
                });
              },
              addEnhancedEcommerceProductContext: function (
                bF,
                bE,
                bN,
                bI,
                ...
                u.push({
                  ...
                  data: {
                    ...
                    category: bG,
                    variant: bK,
                    price: g.parseFloat(bM),
                    quantity: g.parseInt(bJ),
                    coupon: bH,
                    position: g.parseInt(bL),
                    currency: bO,
                  },
                });
              },
              addEnhancedEcommercePromoContext: function (bI, bH, bG, bE, bF) {
                u.push({
                  schema:
              ...
              enableErrorTracking: function (bE, bF) {
                aS.enableErrorTracking(bE, bF, bo());
              },
              trackError: function (bH, bE, bJ, bG, bF, bK) {
                var bI = bo(bK);
                aS.trackError(bH, bE, bJ, bG, bF, bI);
              },
