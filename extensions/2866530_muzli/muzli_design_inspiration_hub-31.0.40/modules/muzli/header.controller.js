angular.module('muzli').controller('headerController', ['$scope', '$state', '$rootScope', '$timeout', 'userService', 'storage', 'trackService',
    function ($scope, $state, $rootScope, $timeout, userService, storage, trackService) {
        ...
        $scope.toggleCreateModal = function(event) {
            ...
            $rootScope.vm.showCreateDialog = !$rootScope.vm.showCreateDialog;

            trackService.track({
                category: 'UGC',
                action: $rootScope.vm.showCreateDialog ? 'Form Open' : 'Form Close',
            });
        }
